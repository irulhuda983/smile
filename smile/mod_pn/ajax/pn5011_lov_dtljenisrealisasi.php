...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 20;
    $url = 'pn5011_lov_dtljenisrealisasi.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode, keterangan from sijstk.ms_lookup a where tipe='PROPJNSBJ' and nvl(aktif,'T')='Y' ".
    			 $filtersearch.
           "order by seq ";
    //echo $sql;
