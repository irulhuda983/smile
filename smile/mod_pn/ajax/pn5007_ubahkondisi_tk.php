<?
$pagetype = "report";
$gs_pagetitle = "PN5007 - UBAH KONDISI TERAKHIR TK";
...
if($_POST['tombol']=="simpan")
{
		if ($ls_jkk2_kode_kondisi_terakhir!="" && $ld_jkk2_tgl_kondisi_terakhir!="")
		{
  		...
  		//cek kelayakan ----------------------------------------------------------
      $qry = "BEGIN SIJSTK.P_PN_PN5001.X_TAPULANG_UPDATE_KONDISITK('$ls_kode_klaim', '$ls_jkk2_kode_kondisi_terakhir', to_date('$ld_jkk2_tgl_kondisi_terakhir','dd/mm/yyyy'), '$username',:p_sukses,:p_mess);END;";											 	
      $proc = $DB->parse($qry);				
