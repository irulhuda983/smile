  ...
  {		 					
		...
		NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5036_lov_kpj.php?p=pn5036.php&a=formreg&b=kode_tk&c=kpj&d=nama_tk&e=kode_perusahaan&f=nama_perusahaan&g=kode_divisi&h=nama_divisi&j='+c_kode_segmen+'&k=npp&l=nomor_identitas&m=jenis_identitas&n=kode_kantor_tk&q='+c_kode_tipe_klaim+'&r='+c_tgl_kejadian+'','',1000,500,1);		 
  }
  ...
  {		 			
		var c_kode_segmen = window.document.getElementById('kode_segmen').value;
		var c_kpj 				= window.document.getElementById('kpj').value;
		NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5036_lov_kpj2care.php?p=pn5036.php&a=formreg&b=kode_tk&c=kpj&d=nama_tk&e=kode_perusahaan&f=nama_perusahaan&g=kode_divisi&h=nama_divisi&j='+c_kode_segmen+'&k=npp&l=nomor_identitas&m=jenis_identitas&n=kode_kantor_tk&q='+c_kpj+'','',1000,500,1);		 
  }
  ...
  function f_ajax_val_kode_tipe_klaim()
  {
    ...
    if (c_kode_tipe_klaim != curr_kode_tipe_klaim) {
      ajax.requestFile = '../ajax/pn5036_validasi.php?getClientId=f_ajax_val_kode_tipe_klaim&c_kode_tipe_klaim='+c_kode_tipe_klaim+'&c_kode_segmen='+c_kode_segmen+'&c_kode_sebab_klaim='+c_kode_sebab_klaim+'&c_kode_tk='+c_kode_tk+'&c_kode_klaim='+c_kode_klaim+'&c_tgl_kejadian='+c_tgl_kejadian;
      ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
      ajax.runAJAX();	// Execute AJAX function
  ...
  {		 			
		NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5036_lov_tipeklaim.php?p=pn5036.php&a=formreg&b=kode_tipe_klaim&c=nama_tipe_klaim','',800,500,1);		 
  }
  ...
  function f_ajax_val_kode_sebab_klaim()
  {
    ...
    if (c_kode_sebab_klaim != curr_kode_sebab_klaim) {
      ajax.requestFile = '../ajax/pn5036_validasi.php?getClientId=f_ajax_val_kode_sebab_klaim&c_kode_tipe_klaim='+c_kode_tipe_klaim+'&c_kode_segmen='+c_kode_segmen+'&c_tgl_kejadian='+c_tgl_kejadian+'&c_kode_sebab_klaim='+c_kode_sebab_klaim+'&c_kode_tk='+c_kode_tk+'&c_kode_klaim='+c_kode_klaim;
      ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
      ajax.runAJAX();	// Execute AJAX function
  ...
  {		 			
    ...
    var c_kode_segmen = window.document.getElementById('kode_segmen').value;
		...
		NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5036_lov_sebabklaim.php?p=pn5036.php&a=formreg&b=kode_sebab_klaim&c=nama_sebab_klaim&d='+c_kode_tipe_klaim+'&e='+c_kode_segmen+'','',800,500,1);		 
  }
  ...
  function f_ajax_val_tgl_lapor()
  {
    ...
    if ((c_tgl_lapor != curr_tgl_lapor) && (c_tgl_lapor!='')) {
      ajax.requestFile = '../ajax/pn5036_validasi.php?getClientId=f_ajax_val_tgl_lapor&c_tgl_lapor='+c_tgl_lapor+'&c_tgl_kejadian='+c_tgl_kejadian+'&c_tgl_klaim='+c_tgl_klaim+'&c_kode_tk='+c_kode_tk+'&c_kode_tipe_klaim='+c_kode_tipe_klaim;
      ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
      ajax.runAJAX();	// Execute AJAX function
  ...
  function f_ajax_val_tglkejadian()
  {
    ...
    ajax.requestFile = '../ajax/pn5036_validasi.php?getClientId=f_ajax_val_tgl_kejadian&c_kode_perusahaan='+c_kode_perusahaan+'&c_kode_segmen='+c_kode_segmen+'&c_kode_divisi='+c_kode_divisi+'&c_kode_tk='+c_kode_tk+'&c_tgl_kejadian='+c_tgl_kejadian+'&c_jenis_klaim='+c_jenis_klaim+'&c_tgl_lapor='+c_tgl_lapor+'&c_tgl_klaim='+c_tgl_klaim;
    ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
    ajax.runAJAX();	// Execute AJAX function
    curr_tgl_kejadian = c_tgl_kejadian;
  }
    ...
    if ((c_jhtinput_kode_tipe_penerima == "AW") && (c_jhtinput_kode_hubungan != curr_jhtinput_kode_hubungan)) {
      ajax.requestFile = '../ajax/pn5036_validasi.php?getClientId=f_ajax_jhtinput_val_kode_hubungan&c_kode_tk='+c_kode_tk+'&c_jhtinput_kode_hubungan='+c_jhtinput_kode_hubungan;
      ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
      ajax.runAJAX();	// Execute AJAX function
