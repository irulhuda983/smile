...
<form action="<?=$PHP_SELF;?>" method="post" id="lov_inv_porto" name="lov_inv_porto">
    ...
    <table class="caption">
      ...
      }else
      {
  		...
  		// query with paging								
      $rows_per_page = 8;
      $url = 'pn5058_lov_kpj.php'; // url sama dengan nama file				
      //The unfiltered SELECT
			if (substr($q,0,3)=="JHT")
			{
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir,tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
               "     kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
               "     to_char(tgl_aktif,'dd/mm/yyyy') tgl_efektif, to_char(tgl_na,'dd/mm/yyyy') tgl_expired, 'Y' st_layak ".
               "from ".
               "( ".
               "    select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir, to_char(tgl_lahir,'dd/mm/yyyy') tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, kode_kantor, kode_divisi, ". 
               ...
               "  			status_tk, tgl_aktif, nvl(tgl_na,to_date('31/12/3000','dd/mm/yyyy')) tgl_na, ".
      ...
      }elseif (substr($q,0,3)=="JKK" || substr($q,0,3)=="JKM")
			{
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir,tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
               "     kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
               ...
               "    select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir,to_char(tgl_lahir,'dd/mm/yyyy')  tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, kode_kantor, kode_divisi, ". 
               "        (select nama_divisi from kn.kn_divisi where kode_perusahaan = a.kode_perusahaan and kode_divisi = a.kode_divisi) nama_divisi,kode_na, ".
               "        status_valid_identitas, decode(nvl(a.status_valid_identitas,'T'),'Y','VALID','TIDAK VALID') ket_valid_identitas, status_tk, ".
               ...
               ") x ".
               "where rank = 1 ";		
      }elseif (substr($q,0,3)=="JPN")
			{
        $sql =  "select ". 
                "    kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir,tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
                "    kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
                "    to_char(tgl_aktif,'dd/mm/yyyy') tgl_efektif, to_char(tgl_na,'dd/mm/yyyy') tgl_expired, st_layak ".   
                "from ". 
                "( ". 
                "    select ".
                "        kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir, to_char(tgl_lahir,'dd/mm/yyyy')  tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
                "        kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, tgl_aktif, nvl(tgl_na,to_date('31/12/3000','dd/mm/yyyy')) tgl_na,'Y' st_layak, ".
                "        rank() over (partition by kode_kepesertaan,kode_tk,tgl_aktif,tgl_na order by kode_kepesertaan,kode_tk, no_mutasi desc) rank ". 
                "    from ".
                "    ( ".
                "        select ". 
                "            kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, kode_kantor, kode_divisi, ". 
                "            (select nama_divisi from kn.kn_divisi where kode_perusahaan = a.kode_perusahaan and kode_divisi = a.kode_divisi) nama_divisi,kode_na, status_valid_identitas, ". 
                "            decode(nvl(a.status_valid_identitas,'T'),'Y','VALID','TIDAK VALID') ket_valid_identitas, status_tk, tgl_aktif, tgl_na, ".
                "            (   select count(*) from kn.kn_kepesertaan_tk_prg where kode_kepesertaan = a.kode_kepesertaan and kode_tk = a.kode_tk and no_mutasi=a.no_mutasi ".
                "                and kd_prg = 4 ".
                "            ) cnt_jpn ".
                "        from sijstk.vw_kn_tk a  ".
                "        where a.kode_segmen = '$j'  ".
                				 $filtersearch.
                "    ) where nvl(cnt_jpn,0)>0  ".
                ") x where rank = 1  ";						 	
      }else
			{
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas,tempat_lahir,tgl_lahir, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
      ...
      while ($row = $DB->nextrow())
      {
                  ...
                  "window.opener.document.".$formname.".".$fieldnamet.".value='".ExtendedFunction::ereg_replace("'","\'",$row["TEMPAT_LAHIR"])."'; ".
                  "window.opener.document.".$formname.".".$fieldnameu.".value='".ExtendedFunction::ereg_replace("'","\'",$row["TGL_LAHIR"])."'; ".
      ...
      <tr>	
        <td>Total Rows <b><?=$total_rows; ?></b> | Total Pages <b><?=$total_pages; ?></b></td>
				...
				<td>
					...
					{
					?>
					<i>Note: Masa Kepesertaan <font color="#ff0000">(*)</font> menandakan tgl kejadian JKK/JKM <?=$r;?> diluar masa perlindungan</i>
					<?
					}
					?>
				</td>	
        ...
        <?$othervar = $othervar."&p=".$p."&a=".$a."&b=".$b."&c=".$c."&d=".$d."&e=".$e."&f=".$f."&g=".$g."&h=".$h."&j=".$j."&k=".$k."&l=".$l."&m=".$m."&n=".$n."&q=".$q."&r=".$r."";?>
