...
?>
	...
	<body>
         ...
         /* $sql = 	"select ".
		  ...
		  $sql = "select 
                      a.kode_pembayaran, a.kode_klaim, a.kode_tipe_penerima, d.nama_tipe_penerima, a.kd_prg, a.flag_sentralisasi, a.no_pointer2,   
                      b.nama_rekening_penerima, b.bank_penerima, b.no_rekening_penerima, 
                      c.no_penetapan, a.no_pointer, nvl(a.flag_pph_progresif,'T') flag_pph_progresif   
                  from sijstk.pn_klaim_pembayaran a, sijstk.pn_klaim_penerima_manfaat b, sijstk.pn_klaim c, sijstk.pn_kode_tipe_penerima d 
                  where a.kode_klaim = b.kode_klaim and a.kode_tipe_penerima = b.kode_tipe_penerima  
                  ...
                  union
                  select 
                      a.kode_pembayaran, a.kode_klaim, decode(kode_penerima_berkala,'TK','TK','AW') kode_tipe_penerima, d.nama_tipe_penerima, a.kd_prg, a.flag_sentralisasi,  a.no_pointer2,
                      b.nama_rekening_penerima, b.bank_penerima, b.no_rekening_penerima, 
                      c.no_penetapan, a.no_pointer, 'T' flag_pph_progresif   
                  from sijstk.pn_klaim_pembayaran_berkala a, sijstk.pn_klaim_penerima_berkala b, sijstk.pn_klaim c, sijstk.pn_kode_tipe_penerima d 
                  where a.kode_klaim = b.kode_klaim  
                  and a.kode_klaim = c.kode_klaim and decode(kode_penerima_berkala,'TK','TK','AW') = d.kode_tipe_penerima 
          ...
          $ls_no_rek_penerima			= $row["NO_REKENING_PENERIMA"];
					...
					$ls_flag_sentralisasi = $row["FLAG_SENTRALISASI"];
					$ls_no_pointer					=	$ls_flag_sentralisasi == "T" ? $row["NO_POINTER"] :  $row["NO_POINTER2"] ; 
          ...
          {	
						...
						$sql = "select 
										...
										union
										select 
												c.kode_tipe_klaim, a.kode_pembayaran, a.kode_klaim, decode(kode_penerima_berkala,'TK','TK','AW') kode_tipe_penerima, d.nama_tipe_penerima, a.kd_prg, 
												b.nama_rekening_penerima, b.bank_penerima, b.no_rekening_penerima, 
												c.no_penetapan, a.no_pointer, 'T' flag_pph_progresif   
										from sijstk.pn_klaim_pembayaran_berkala a, sijstk.pn_klaim_penerima_berkala b, sijstk.pn_klaim c, sijstk.pn_kode_tipe_penerima d 
										where a.kode_klaim = b.kode_klaim  
						...
						if ($ls_kanal_pelayanan == "27" || $ls_kanal_pelayanan == "28"|| $ls_kanal_pelayanan == "41") {
							$ls_user_param .= " qkode_pembayaran='$ls_kode_pembayaran'";
							$ls_user_param .= " qkode_klaim='$ls_kode_klaim'";
  					...
  					<div id="formKiri">
    					...
    					<fieldset style="width:500px;"><legend>&nbsp;</legend>
    						<!--<input type="submit" class="btn green" id="butcetak" name="butcetak" value="          CETAK       " />-->
								...
								<?php if ($ls_jml_dokumen_digital > 0) 	 { ?>
							...
							<?php if(isset($_POST["butcetak_all_arsipkan"])){ ?>
								<fieldset style="width:500px;">
									<?= $ln_error_arsip > 0 ? "<legend><font color=#ff0000>Error</font></legend>" : "<legend><font color=#007bb7>Message</font></legend>";?>
