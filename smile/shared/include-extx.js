...
(function() {
	...
	var path = '/sijstk/shared/'; 
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/resources/css/ext-all' + suffix + '.css"/>');
    }
	
	document.write('<script type="text/javascript" src="' + path + '/ext-all' + (rtl ? '-rtl' : '') + '.js?v42.2016"></script>');
	
   	/*
    document.write('<script type="text/javascript" src="http://cdn.sencha.io/ext-4.1.1-gpl/ext-all.js"></script>');
*/
    if (neptune) {
