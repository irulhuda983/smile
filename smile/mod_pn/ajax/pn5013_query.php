...
//if($TYPE!=''){
	...
	$sql .= " rownum <= 500 and a.kode_kantor = '".$ls_kode_kantor."' and a.status = 'PERENCANAAN' and a.sub_status = 'PERSETUJUAN_PERENCANAAN' and a.status_verif_permintaan = 'DISETUJUI' ";
