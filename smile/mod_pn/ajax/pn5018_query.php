...
//if($TYPE!=''){
	...
	//$sql .= " rownum <= 500 and a.kode_kantor = '".$ls_kode_kantor."' and a.status = 'PENGAJUAN' and a.sub_status = 'PENETAPAN_KEGIATAN' and a.status_penetapan_kegiatan = 'DISETUJUI' ";
	$sql .= " rownum <= 500 and a.kode_kantor = '".$ls_kode_kantor."' and a.status = 'PENGAJUAN' 
			  and a.sub_status = 'PENETAPAN_PELAKSANA' and a.jenis_pelaksana_kegiatan = 'TG' and a.PETUGAS_SUBMIT_PELAKSANAKETIGA IS NULL ";
