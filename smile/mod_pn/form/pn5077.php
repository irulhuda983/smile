...
$gs_pagetitle = "PN5077 - Verifikasi Potensi Klaim Fiktif"; # untuk judul form
$formAjax = "../ajax/pn5077_action.php?"; # inisialisasikan lokasi file ajax
$formDetail = "/mod_pn/form/pn5077_form_detail.php"; # inisialisasikan lokasi file detail
...
function checkParam_form_pn5077($key)
{
    return (isset($_GET[$key]) && !empty($_GET[$key]) ? $_GET[$key] : (isset($_POST[$key]) && !empty($_POST[$key]) ? $_POST[$key] : NULL));
}

# parameter filter
$former_search_by   		= htmlspecialchars(checkParam_form_pn5077('former_search_by'));
$former_search_txt   		= htmlspecialchars(checkParam_form_pn5077('former_search_txt'));
$former_status_proses   	= htmlspecialchars(checkParam_form_pn5077('former_status_proses'));
        ...
        if (jdata.ret == 0) {
            ...
            for (var i = 0; i < jdata.data.length; i++) {
                ...
                if (status_proses == 'belum') {
                    html_data += '<td style="text-align: center;">' + getValue(row.KODE_FIKTIF_KLAIM) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.ID_POINTER_ASAL) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_REKAM_PENGAJUAN) + '</td>';
                    html_data += '<td style="text-align: left;">' + getValue(row.PETUGAS) + '</td>';
                    html_data += '<td style="text-align: left;">' + getValue(row.KANTOR) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_SLA1_VERIFIKASI_KASUS) + '</td>';
                    html_data += '<td style="text-align: left;">' + getValue(row.NAMA_STATUS_PENGAJUAN) + '</td>';
                } else {                  
                    html_data += '<td style="text-align: center;">' + getValue(row.KODE_FIKTIF_KLAIM) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.ID_POINTER_ASAL) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_REKAM_PENGAJUAN) + '</td>';
                    ...
                    html_data += '<td style="text-align: left;">' + getValue(row.KANTOR) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_SLA1_VERIFIKASI_KASUS) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_VERIFIKASI_KASUS) + '</td>';
                    html_data += '<td style="text-align: center;">' + getValue(row.TGL_APPROVAL) + '</td>';
                    html_data += '<td style="text-align: left;">' + getValue(row.NAMA_STATUS_PENGAJUAN) + '</td>';
                }
