...
$pagetitle = "SIJSTK";
$gs_pagetitle = "Daftar Fasilitas Kesehatan";
...
<![endif]-->
    <table class="caption">
      <tr> 
        ...
        <td align="right">Search By &nbsp
          <select name="pilihsearch">
            ...
            switch($pilihsearch)
            {
          		case 'sc_nama_jenis_ppk' : $sel1="selected"; break;
							case 'sc_nama_ppk' : $sel2="selected"; break; 	
							case 'sc_nama_kabupaten' : $sel3="selected"; break; 		
            }
            ?>
        		<option value="sc_all">--ALL--</option>
        		<option value="sc_nama_jenis_ppk" <?=$sel1;?>>Jenis PPK</option>
						<option value="sc_nama_ppk" <?=$sel2;?>>Nama PPK</option>  
						<option value="sc_nama_kabupaten" <?=$sel3;?>>Kabupaten</option>     
          </select>
      ...
      if ($pilihsearch=="sc_nama_jenis_ppk")
      {
       $filtersearch = "and upper(c.nama_tipe) like '%".$searchtxt."%' ";
      }
      elseif ($pilihsearch=="sc_nama_ppk")
      {
       $filtersearch = "and upper(a.nama_faskes) like '%".$searchtxt."%' ";
      }
      elseif ($pilihsearch=="sc_nama_kabupaten")
      {
       $filtersearch = "and upper(b.nama_kabupaten) like '%".$searchtxt."%' ";
      }									                		 
      else
      {
       $filtersearch = "and (upper(c.nama_tipe) like '%".$searchtxt."%' or upper(a.nama_faskes) like '%".$searchtxt."%' or upper(b.nama_kabupaten) like '%".$searchtxt."%') ";
      }
		}		
    // query with paging								
    $rows_per_page = 10;
    $url = 'pn5041_lovtapjkk1_faskes.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select a.kode_faskes kode_ppk, a.kode_tipe kode_jenis_ppk, c.nama_tipe nama_jenis_ppk, ".
           "     a.nama_faskes nama_ppk, a.alamat alamat_ppk, a.kode_kabupaten, b.nama_kabupaten, a.kode_kantor ".
           "from sijstk.tc_faskes a, sijstk.ms_kabupaten b, sijstk.tc_kode_tipe c ".
           "where a.kode_tipe = c.kode_tipe ".
           "and a.kode_kabupaten = b.kode_kabupaten(+) ".
           "and a.kode_status = 'ST3' ".
    			 $filtersearch.
           "order by a.kode_faskes ";
    //echo $sql;
    ...
    echo "<tr>";
    echo "<th class=awal>&nbsp;<a href=\"$PHP_SELF?f=a.kode_ppk&o=$o\"><b>Kode</b></a></th>";    
    echo "<th><a href=\"$PHP_SELF?f=a.nama_ppk&o=$o\"><b>Nama PPK</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=c.nama_jenis_ppk&o=$o\"><b>Jenis PPK</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=a.alamat_ppk&o=$o\"><b>Alamat</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=b.nama_kabupaten&o=$o\"><b>Kabupaten</b></a></th>";
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PPK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PPK"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["KODE_PPK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PPK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PPK"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_PPK"]."</a>";?></td>  
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PPK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PPK"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_JENIS_PPK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PPK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PPK"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["ALAMAT_PPK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PPK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PPK"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
