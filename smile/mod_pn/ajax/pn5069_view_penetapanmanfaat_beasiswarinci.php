<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat beasiswa
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset style="width:97%;"><legend>Rincian Manfaat</legend>
            ...
            <label  style = "text-align:right;">Nama Penerima *</label>
              <input type="text" id="beasiswa_penerima" name="beasiswa_penerima" readonly class="disabled" style="width:270px;">				
            </div>																		
            <div class="clear"></div>		
  					          
            <div class="form-row_kiri">
            <label  style = "text-align:right;">Jenis Beasiswa</label>
              <input type="text" id="beasiswa_jenis_nama" name="beasiswa_jenis_nama" readonly class="disabled" style="width:270px;">
            ...
            <div class="clear"></div>
              ...
              <label  style = "text-align:right;">Jenjang Pendidikan </label>
                <input type="text" id="beasiswa_jenjang_pendidikan_nm" name="beasiswa_jenjang_pendidikan_nm" readonly class="disabled" style="width:170px;">
