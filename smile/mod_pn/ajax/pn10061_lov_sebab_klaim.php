	  ...
	  <tr> 
		...
		<td align="right">Search By &nbsp
		  ...
		  ?>
			...
			<option value="sc_kode_klaim" <?=$sel1;?>>Kode Klaim</option>
			<option value="sc_nama_klaim" <?=$sel2;?>>Nama Klaim</option>
			<option value="sc_jenis_klaim" <?=$sel3;?>>Jenis Klaim</option>      
		  </select>
	  ...
	  //------------------------------------------- start list data --------------------------------
				...
				if(isset($searchtxt))
				{
					...
					if ($pilihsearch=="sc_kode_klaim")
					{
						...
						elseif($pilihsearch=="sc_nama_klaim")
					{
						   $filtersearch = "and nama_sebab_klaim like '%".$searchtxt."%' ";
					}
						elseif($pilihsearch=="sc_jenis_klaim")
					{
						   $filtersearch = "and kode_tipe_klaim like '%".$searchtxt."%' ";
					}					 
					else
					{
				...
				$rows_per_page = 10;
				$url = 'pn10061_lov_sebab_klaim.php'; // url sama dengan nama file				
					//The unfiltered SELECT
				$sql = "select kode_sebab_klaim, nama_sebab_klaim, kode_tipe_klaim, status_nonaktif from sijstk.pn_kode_sebab_klaim 
						where kode_sebab_klaim is not null ".$filtersearch." ";
				//echo $sql;
