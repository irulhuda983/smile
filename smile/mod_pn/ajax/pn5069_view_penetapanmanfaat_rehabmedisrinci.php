		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset ><legend>Rincian Manfaat</legend>
            ...
            <label  style = "text-align:right;">Jenis Pelayanan </label>
              <input type="text" id="mnf_rehab_jenis_pelayanan" name="mnf_rehab_jenis_pelayanan" readonly class="disabled" style="width:240px;">				
            </div>																		
            <div class="clear"></div>	
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#mnf_rehab_jenis_pelayanan').val(getValue(jdata.data.DATA['REHAB_JENIS_PELAYANAN']));
