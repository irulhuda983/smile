...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    function f_ajax_val_hitung_manfaat()
    {
			...
			{
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_tkipemulangantdksesuaipk&c_biaya_darat='+c_biaya_darat+'&c_biaya_laut='+c_biaya_laut+'&c_biaya_udara='+c_biaya_udara+'&c_biaya_udara='+c_biaya_udara+'&c_kode_klaim='+c_kode_klaim+'&c_no_urut='+c_no_urut;
    ...
    <table class="captionfoxrm" aria-describedby="captionfoxrmdesc">
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
          ...
          <label style = "text-align:right;">Tipe Penerima *</label>
            <select size="1" id="kode_tipe_penerima" name="kode_tipe_penerima" value="<?=$ls_kode_tipe_penerima;?>" tabindex="1" class="select_format" style="width:300px;background-color: #F2F2F2;" onChange="" readonly class="disabled">
