...
<![endif]-->
    <table class="caption">
      ...
      {
       $filtersearch = "and upper(a.nama_bank) like '%".$searchtxt."%' ";
      }
      else
      {
       $filtersearch = "and (upper(a.nama_bank) like '%".$searchtxt."%' ) ";
    ...
    // query with paging								
    $rows_per_page = 10;
    $url = 'pn5002_lov_bankpenerima.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select nama_bank, kode_bank from sijstk.spo_tx_kode_bank a where opg_bank = 'BNI' and status = 'Y' and tipe_trf = 'ATB' ".
    			 $filtersearch;
           //"order by nama_bank ";
    //echo $sql;
