(function ($, window, document, undefined) {
        ...
        // demo form
        $("#accountAddressCountry").select2();
        $("#accountAddressState").select2();
        ...
        $('#accountDob, #articleCreated, #articleCreatedDate, #articlePublishingStart, #articlePublishingFinish, #datePickerVia').datepicker();
