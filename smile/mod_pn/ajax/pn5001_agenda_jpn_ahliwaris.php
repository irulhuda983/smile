...
if($btn_task=="get_ahliwaris_jp")
{
    ...
    $qry = "BEGIN SIJSTK.P_PN_PN5001.X_GET_AHLIWARISJP('$ls_kode_klaim','$username',:p_sukses,:p_mess);END;";											 	
    $proc = $DB->parse($qry);				
...
<div id="formKiri" style="width:955px;">
    ...
    <table id="mydata1" width="90%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff">
      <tbody>
        ...
        <?echo "<tr bgcolor=#".($i%2 ? "ffffff" : "f3f3f3").">";?>								
          ...
          <td style="text-align:center;">
            <a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5001_agenda_jpn_ahliwarisentry.php?task=edit&kode_tk=<?=$ls_kode_tk;?>&kode_klaim=<?=$ls_kode_klaim;?>&no_urut_keluarga=<?=$row["NO_URUT_KELUARGA"];?>&root_sender=pn5001.php&sender=pn5001.php&sender_activetab=2&sender_mid=<?=$mid;?>','Ubah Data Keluarga',880,620,'no');"><img src="../../images/app_form_edit.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Ubah/Hapus</a>
          </td>
        </tr>
        <?
        //hitung total									    							
      ...
      <tr>
        ...
        <td style="text-align:center">	
        	<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5001_agenda_jpn_ahliwarisentry.php?task=new&kode_tk=<?=$ls_kode_tk;?>&kode_klaim=<?=$ls_kode_klaim;?>&root_sender=pn5001.php&sender=pn5001.php&sender_activetab=2&sender_mid=<?=$mid;?>','Entry Data Ahli Waris',880,620,'no');"><img src="../../images/plus.png" border="0" alt="Tambah" align="absmiddle" />&nbsp;Tambah Data</a>
        </td>											
      </tr>
    </table>					
	</fieldset>	 
