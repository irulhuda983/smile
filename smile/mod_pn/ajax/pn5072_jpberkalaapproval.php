  ...
  <div id="div_body" class="div-body">
      ...
      <div class="div-row" style="padding-top: 1px;">
        <div class="div-col" style="padding: 2px;">
          ...
          <select name="page_item" id="page_item" style="width: 46px;height:20px;" onchange="fl_js_jpbklapv_filter();">
        ...
        <div class="div-col-right" style="padding: 2px;">
          <a class="a-icon-text" href="#" onclick="fl_js_jpbklapv_filter();" title="Klik Untuk Menampilkan Data">
            <img src="../../images/zoom.png" border="0" alt="tampilkan_data" align="absmiddle">
            <span>Tampilkan</span>
          </a>
        </div>
        <div class="div-col-right" style="padding: 2px;">
          <select id="search_by2" name="search_by2" style="border:0;width: 110px;height:18px;" onchange="fl_js_jpbklapv_search_by2_changed();">
        ...
        <div class="div-col-right" style="padding: 2px;">
          <select name="search_by" id="search_by" style="border:0;width: 110px;height:18px;" onchange="fl_js_jpbklapv_search_by_changed()">
          ...
          <thead>
            <tr class="hr-single-double">
              <th style="text-align: center; width: 20px;!important;">
              	<input type="checkbox" name="toggle" value="" onclick="fl_js_jpbklapv_checkRecordAll(this);">
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="KODE_KLAIM" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Kode Klaim
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="BLTH_PROSES" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Bulan
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="KODE_KANTOR" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Ktr
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="KODE_KANTOR_KONFIRMASI" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Ktr Konf
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="KPJ" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">No. Referensi
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="NAMA_TK" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Nama Peserta
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="NAMA_PENERIMA_BERKALA" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Nama Penerima
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="NO_REKENING_PENERIMA" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Rekening
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
			  <th style="text-align: left;">
                <a href="#" order_by="NAMA_REKENING_PENERIMA" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Nama Rekening Penerima
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="BANK_PENERIMA" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Bank
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: left;">
                <a href="#" order_by="STATUS_VALID_REKENING_PENERIMA" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Rek. Valid
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
              <th style="text-align: right;">
                <a href="#" order_by="NOM_MANFAAT_NETTO" order_type="DESC" onclick="fl_js_jpbklapv_orderby(this)">Jml Bayar
                	<img class="order-icon" src="../../images/sort_both.png">
                </a>
              </th>
            </tr>
      ...
      <div class="div-row" style="padding-top: 8px;">
        <div class="div-col">
          ...
          <a href="javascript:void(0)" title="First Page" class="pagefirst" onclick="fl_js_jpbklapv_filter('-02')"><<</a>
          <a href="javascript:void(0)" title="Previous Page" class="pagenext" onclick="fl_js_jpbklapv_filter('-01')">Prev</a>
          <input type="text" value="1" id="page" name="page" class="pageinput" onkeypress="return isNumber(event)" onblur="fl_js_jpbklapv_filter(this.value);"/>
          <a href="javascript:void(0)" title="Next Page" class="pagenext" onclick="fl_js_jpbklapv_filter('01')">Next</a>
          <a href="javascript:void(0)" title="Last Page" class="pagelast" onclick="fl_js_jpbklapv_filter('02')">>></a>
        ...
        <div class="div-col-right">
          <input type="hidden" id="hdn_total_records_jpbklapv" name="hdn_total_records_jpbklapv">
	...
	<div id="div_footer" class="div-footer">
			...
			<div class="div-row">
				<div class="div-col">
					<div class="div-action-footer">
						<div class="icon">
							<a id="btn_doApprovalSiapByr" href="#" onClick="if(confirm('Apakah anda yakin akan melakukan Approval Data Siap Bayar..?')) fjq_ajax_val_jpbklapv_doApprovalSiapBayar();">
								<img src="../../images/ico_submit.jpg" border="0" alt="Tambah" align="absmiddle" style="height:25px;"/>
								<span>APPROVAL DATA JP BERKALA SIAP BAYAR&nbsp;&nbsp;&nbsp;</span>
							</a>
						</div>
					</div>
				</div>
				<div class="div-col">
					<div class="div-action-footer">
						<div class="icon">
							<a id="btn_doKembalikanData" href="#" onClick="if(confirm('Apakah anda yakin akan melakukan Edit Data Siap Bayar..?')) fjq_ajax_val_jpbklapv_doTolakSiapBayar();">
		...
		<div class="div-footer-content">
			...
			Tickmark kemudian klik <font color="#ff0000"> APPROVAL DATA JP BERKALA SIAP BAYAR</font> untuk persetujuan pembayaran manfaat JP Berkala. Apabila masih ada koreksi terhadap data maka klik <font color="#ff0000"> KEMBALIKAN DATA JP BERKALA KE TAHAP SEBELUMNYA</font>.
		</div>
	</div>
	<?
...
<script language="javascript">
    ...
    $(window).bind("resize", function(){
		...
		{
			fl_js_jpbklapv_filter();
		}
	});

	function fl_js_jpbklapv_resize_grid(){
	...
	function fl_js_jpbklapv_search_by_changed(){
		$("#search_txt").val("");
	}

	function fl_js_jpbklapv_search_by2_changed(){
		$('#'+$('#search_by2').val()).show();
	}

	function fl_js_jpbklapv_orderby(e) {
	...
	function fl_js_jpbklapv_filter(val = 0){
    ...
    var order_type 	 = $("#order_type").val();
		...
		$.ajax({
			...
			data: {
				tipe 				 		 : 'MainDataGridJPBerkalaApproval',
				page				 		 : page,
				page_item    		 : page_item,
				search_by    		 : search_by,
					...
					if (jdata.ret == 1) {
						...
						for(var i = 0; i < jdata.data.length; i++){
							...
							html_data += '<td style="text-align: center;">'
									...
									+ 'onchange="fl_js_jpbklapv_checkRecord(this)" '
									+ (checkedBox ? 'checked' : '') + ' '
							...
							html_data += '<input type="hidden" id="jpbklapv_kode_klaim'+i+'" name="jpbklapv_kode_klaim'+i+'" value='+getValue(jdata.data[i].KODE_KLAIM)+'>';
							html_data += '<input type="hidden" id="jpbklapv_no_konfirmasi'+i+'" name="jpbklapv_no_konfirmasi'+i+'" value='+getValue(jdata.data[i].NO_KONFIRMASI)+'>';
							html_data += '<input type="hidden" id="jpbklapv_no_proses'+i+'" name="jpbklapv_no_proses'+i+'" value='+getValue(jdata.data[i].NO_PROSES)+'>';
							html_data += '<input type="hidden" id="jpbklapv_kd_prg'+i+'" name="jpbklapv_kd_prg'+i+'" value='+getValue(jdata.data[i].KD_PRG)+'></td>';
						...
						$("#hdn_total_records_jpbklapv").val(jdata.recordsTotal);
	...
	function fl_js_jpbklapv_reloadFormUtama()
  {
	...
	function fl_js_jpbklapv_reloadFormEntry(task, editid)
  {
		document.formreg.task.value = task;
		document.formreg.editid.value = editid;
		document.formreg.kode_klaim.value = editid;
		fl_js_jpbklapv_reloadFormUtama();
  }

	function fl_js_jpbklapv_checkRecordAll(el) {
	...
	function fl_js_jpbklapv_checkRecord(el) {
		let kode_klaim = $(this).attr('kode_klaim');
			let no_konfirmasi = $(this).attr('no_konfirmasi');
			let no_proses = $(this).attr('no_proses');
			let kd_prg = $(this).attr('kd_prg');
  ...
  //do approval data siap bayar ------------------------------------------------
	function fjq_ajax_val_jpbklapv_doApprovalSiapBayar()
  {
		$('#tipe').val('DoApvSiapByrJPBerkala');
    preload(true);
    $.ajax(
    {
      type: 'POST',
 ...
 //do tolak data siap bayar ----------------------------------------------------
	function fjq_ajax_val_jpbklapv_doTolakSiapBayar()
  {
		$('#tipe').val('DoTolakSiapByrJPBerkala');
    preload(true);
    $.ajax(
    {
      type: 'POST',
