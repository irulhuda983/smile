...
//if($TYPE!=''){
	...
	$sql .= " rownum <= 500 and a.kode_kantor = '".$ls_kode_kantor."' and a.status = 'PENGAJUAN' 
			  and ((a.sub_status = 'PENETAPAN_PELAKSANA' and a.jenis_pelaksana_kegiatan = 'PR' and a.PETUGAS_SUBMIT_PELAKSANA_KEG IS NOT NULL) 
			  or (a.sub_status = 'PERSETUJUAN_PENGAJUAN' and a.jenis_pelaksana_kegiatan = 'TG' and a.PETUGAS_SUBMIT_PELAKSANAKETIGA IS NOT NULL))
			  and a.status_approval_pengajuan is null ";
