...
$ls_root_form = "pn500403.php";
$ls_current_form = "pn5004_pembayaran.php";
...
include "../ajax/pn5004_js.php";
include "../ajax/pn5004_actionbutton.php";
...
<div id="formframe">
    ...
    if ($ls_jenis_klaim=="JHT")
    {
     	include "../ajax/pn5004_pembayaran_jht.php";	  	 
    }else if ($ls_jenis_klaim=="JHM")
    {
     	include "../ajax/pn5004_pembayaran_jhm.php";  	  	 
    }else if ($ls_jenis_klaim=="JKK")
    {
     	include "../ajax/pn5004_pembayaran_jkk.php";		  	 
    }else if ($ls_jenis_klaim=="JKM")
    {
     	include "../ajax/pn5004_pembayaran_jkm.php";  	  	 
    }else if ($ls_jenis_klaim=="JPN")
    {
     	include "../ajax/pn5004_pembayaran_jpn.php";  	 
    }
		?>
