...
-----------------------------------------------------------------------------*/
$ld_jkk_tgl_gagal_ditempatkan	= $_POST["TGL_KEJADIAN"]  =="null" ? "" : $_POST["TGL_KEJADIAN"];
...
//end get list penyebab gagal --------------------------------------------------						
?>

<fieldset><legend>Informasi Gagal Ditempatkan</legend>
  </br>				
  ...
  <div class="form-row_kiri">
  <label style = "text-align:right;">Tgl Gagal Ditempatkan</label>
  	<input type="text" id="jkk_tgl_gagal_ditempatkan" name="jkk_tgl_gagal_ditempatkan" value="<?=$ld_jkk_tgl_gagal_ditempatkan;?>" style="width:320px;" readonly class="disabled">     	   							
  </div>	
  <div class="clear"></div>
