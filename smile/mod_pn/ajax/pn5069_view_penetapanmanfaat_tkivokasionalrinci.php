<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat pmi vokasional
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset style="width:97%;"><legend>Rincian Manfaat</legend>
            ...
            <label style = "text-align:right;">Jenis Pelatihan *</label>
              <input type="text" id="vokasional_jenis_nama" name="vokasional_jenis_nama" readonly class="disabled" style="width:270px;">
          		<input type="hidden" id="vokasional_jenis" name="vokasional_jenis">																 								
            </div>
            <div class="clear"></div>
              ...
              <label  style = "text-align:right;">Detil Jenis Lainnya </label>
                <input type="text" id="vokasional_jenis_lainnya" name="vokasional_jenis_lainnya" readonly class="disabled" style="width:270px;">			
              </div>																		
              <div class="clear"></div>
  					</span>
            ...
            <label  style = "text-align:right;">Nama PLKB/BLK </label>
              <input type="text" id="vokasional_plkb" name="vokasional_plkb" readonly class="disabled" style="width:270px;">			
            </div>																		
            <div class="clear"></div>
  										
            <div class="form-row_kiri">
            <label style = "text-align:right;">Tgl Pelatihan *</label>
              <input type="text" id="vokasional_tgl_awal" name="vokasional_tgl_awal" readonly class="disabled" style="width:121px;">	
              s/d
  						<input type="text" id="vokasional_tgl_akhir" name="vokasional_tgl_akhir" readonly class="disabled" style="width:121px;">	
            </div>																																															
            <div class="clear"></div>	
            ...
            <label  style = "text-align:right;">Total Diajukan </label>
              <input type="text" id="nom_biaya_diajukan" name="nom_biaya_diajukan" readonly class="disabled" style="width:270px;">			
            </div>																		
            <div class="clear"></div>
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#vokasional_jenis_nama').val(getValue(jdata.data.DATA['VOKASIONAL_JENIS_NAMA']));
						$('#vokasional_jenis').val(getValue(jdata.data.DATA['VOKASIONAL_JENIS']));
						$('#vokasional_jenis_lainnya').val(getValue(jdata.data.DATA['VOKASIONAL_JENIS_LAINNYA']));
						$('#vokasional_plkb').val(getValue(jdata.data.DATA['VOKASIONAL_PLKB']));
						$('#vokasional_tgl_awal').val(getValue(jdata.data.DATA['VOKASIONAL_TGL_AWAL']));
						$('#vokasional_tgl_akhir').val(getValue(jdata.data.DATA['VOKASIONAL_TGL_AKHIR']));
						
						$('#nom_biaya_diajukan').val(format_uang(getValueNumber(jdata.data.DATA['NOM_BIAYA_DIAJUKAN'])));
