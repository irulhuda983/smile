<?
$pagetype = "report";
$gs_pagetitle = "PN900215 - SM4090 - DAFTAR KLAIM JKK TAHAP I PESERTA PENERIMA UPAH (PNR2016)";
...
if (isset($iscetak) || isset($iscetak_excel)) {	
	...
	$ls_lap_kacab = $ls_kacab;
	$ls_lap_kepala_pelayanan = $ls_kepala_pelayanan;
	...
	$ls_user_param .= " P_KACAB='$ls_lap_kacab'";
	$ls_user_param .= " P_KEPALA_PELAYANAN='$ls_lap_kepala_pelayanan'";
	...
	<div id="formKiri">
		<fieldset><legend><?=$gs_pagetitle?></legend>
			...
			<div class="form-row_kiri">
				...
				<input type="text" id="kacab" name="kacab" value="<?=$ls_kacab;?>" size="10" style="width: 220px;" required>
			</div>
			<div class="clear"></div>
			<div class="form-row_kiri">
				<label>Kepala Pelayanan *</label>
				<input type="text" id="kepala_pelayanan" name="kepala_pelayanan" value="<?=$ls_kepala_pelayanan;?>" size="10" style="width: 220px;" required>
			</div>
			<div class="clear"></div>
			<div class="form-row_kiri">	
      			<label>Periode *</label>
