...
<form action="<?=$PHP_SELF;?>" method="post" id="lov_inv_porto" name="lov_inv_porto">
    ...
    <table class="caption">
      <tr> 
        ...
        <td align="right">Search By &nbsp
          <select name="pilihsearch">
            ...
            switch($pilihsearch)
            {
          		case 'sc_kode_proyek' : $sel4="selected"; break;
							case 'sc_no_proyek' : $sel1="selected"; break;
							case 'sc_nama_proyek' : $sel2="selected"; break; 
							case 'sc_nama_perusahaan' : $sel3="selected"; break; 		
            }
            ?>
        		<option value="sc_all">--ALL--</option>
        		<option value="sc_kode_proyek" <?=$sel4;?>>Kode Proyek</option>
						<option value="sc_no_proyek" <?=$sel1;?>>No Proyek</option>
						<option value="sc_nama_proyek" <?=$sel2;?>>Nama Proyek</option> 
						<option value="sc_nama_perusahaan" <?=$sel3;?>>Nama Perusahaan</option>     
          </select>
      ...
      if ($pilihsearch=="sc_no_proyek")
      {
       $filtersearch = "and upper(a.no_proyek) like '%".$searchtxt."%' ";
      }
      elseif ($pilihsearch=="sc_nama_proyek")
      {
       $filtersearch = "and upper(a.nama_proyek) like '%".$searchtxt."%' ";
      }	
      elseif ($pilihsearch=="sc_kode_proyek")
      {
       $filtersearch = "and a.kode_proyek = '".$searchtxt."' ";
      }				
      elseif ($pilihsearch=="sc_nama_perusahaan")
      {
       $filtersearch = "and upper(b.nama_perusahaan) like '%".$searchtxt."%' ";
      }								                		 
      else
      {
       $filtersearch = "and (a.kode_proyek = '".$searchtxt."' or upper(a.no_proyek) like '%".$searchtxt."%' or upper(a.nama_proyek) like '%".$searchtxt."%' or upper(b.nama_perusahaan) like '%".$searchtxt."%') ";
      }
		}		
    // query with paging								
    $rows_per_page = 10;
    $url = 'pn5040_lov_proyek.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select a.kode_proyek, a.nama_proyek, a.no_proyek, a.alamat_proyek, ".
           "     a.kode_perusahaan, b.npp, b.nama_perusahaan, a.tgl_na tgl_nonaktif,a.kode_na kode_nonaktif ".
           "from sijstk.jn_proyek a, sijstk.kn_perusahaan b ".
    ...
    echo "<tr>";
    echo "<th class=awal>&nbsp;<a href=\"$PHP_SELF?f=a.kode_proyek&o=$o\"><b>Kode Proyek</b></a></th>";    
    echo "<th><a href=\"$PHP_SELF?f=a.no_proyek&o=$o\"><b>No Proyek</b></a></th>";
    echo "<th><a href=\"$PHP_SELF?f=a.nama_proyek&o=$o\"><b>Nama Proyek</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=a.alamat_proyek&o=$o\"><b>Alamat Proyek</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=b.nama_perusahaan&o=$o\"><b>Perusahaan</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=b.npp&o=$o\"><b>NPP</b></a></th>";
    echo "</tr>";
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROYEK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NO_PROYEK"])."'; ".  
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PROYEK"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnameg.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NPP"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnamec."').focus(); ".
        "window.close();\" >".$row["KODE_PROYEK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROYEK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NO_PROYEK"])."'; ".  
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PROYEK"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnameg.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NPP"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnamec."').focus(); ".
        "window.close();\" >".$row["NO_PROYEK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROYEK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NO_PROYEK"])."'; ".  
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PROYEK"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnameg.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NPP"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnamec."').focus(); ".
        "window.close();\" >".$row["NAMA_PROYEK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROYEK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NO_PROYEK"])."'; ".  
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PROYEK"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnameg.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NPP"])."'; ".      											
        "window.opener.document.getElementById('".$fieldnamec."').focus(); ".
        "window.close();\" >".$row["ALAMAT_PROYEK"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROYEK"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NO_PROYEK"])."'; ".  
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PROYEK"])."'; ".
