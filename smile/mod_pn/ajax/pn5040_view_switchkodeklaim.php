...
{	
	if($_POST['kode_klaim']!="")
	{
		...
		function refreshParent() 
		{
			...
			<?php	
			if($ls_sender!=''){		
				echo "window.opener.location.replace('../form/$ls_sender?task=View&dataid=$ls_kode_klaim&kode_klaim=$ls_kode_klaim');";		
			}
			?>	
			}            
			window.close();
	...
	else
	{
		...
		<a href="../ajax/pn5040_view_switchkodeklaim.php">Ulangi lagi</a>
		<?
	}
}
else
