...
$pagetitle = "SIJSTK";
$gs_pagetitle = "Daftar Sumber Cedera";
...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 12;
    $url = 'pn5002_lovtapjkk1_sumbercedera.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode, keterangan from sijstk.ms_lookup a where tipe='KLMSMBRCDR' and nvl(aktif,'T')='Y' ".
    			 $filtersearch.
           "order by seq ";
    //echo $sql;
