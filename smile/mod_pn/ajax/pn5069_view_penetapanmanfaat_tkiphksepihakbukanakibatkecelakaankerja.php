          ...
          <div class="div-row">
            <div class="div-col" style="width:100%; max-height: 100%;">
              <fieldset><legend>Penetapan Manfaat</legend>
                <table id="tblMnf" width="100%" class="table-data2" aria-describedby="tblMnfdesc">
                  <thead>								
                    <tr>
                      <th scope="col" style="text-align:center;" colspan="2">&nbsp;</th>
                      <th scope="col" style="text-align:center;" colspan="1" class="hr-single-bottom">PENETAPAN NILAI MANFAAT</th>
                      <th scope="col" style="text-align:center;" colspan="2"></th>
                    </tr>					
                    <tr class="hr-double-bottom">
                      <th scope="col" style="text-align:center;">No</th>
                      <th scope="col" style="text-align:center;">Tipe Penerima</th>
            					<th scope="col" style="text-align:right;">Biaya Disetujui</th>
                    ...
                    <tr class="nohover-color">
                    	<td colspan="5" style="text-align: center;">-- data tidak ditemukan --</td>
									...
									<tfoot>
                    <tr>
                      <td style="text-align:right;" colspan="2"><em>Total Manfaat:</em>
		...
		$.ajax({
			...
			success: function(data){
				try {
					...
					if (jdata.ret == 0) 
					{ 
						$("#span_page_title").html('PN5030 - RINCIAN MANFAAT - BANTUAN PHK');
...
<script language="javascript">
	...
	{		
		var c_mid = '<?=$mid;?>';
		showForm('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5069_view_penetapanmanfaat_tkiphksepihakbukanakibatkecelakaankerjarinci.php?kode_klaim='+p_kode_klaim+'&kode_manfaat='+p_kode_manfaat+'&no_urut='+p_no_urut+'&mid='+c_mid+'','',980,550,'yes');
	}
</script>
