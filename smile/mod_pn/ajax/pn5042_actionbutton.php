<?
//-- ACTION BUTTON -------------------------------------------------------------
if($btn_task=="submit_approval_tanpa_otentikasi")
{
  //submit data persetujuan klaim, panggil new window utk proses ---------------
  ...
  echo "<script language=\"JavaScript\" type=\"text/javascript\">";
	echo "window.location.replace('../form/$ls_root_sender?mid=$ls_sender_mid&rg_kategori=$ls_rg_kategori');";
  echo "</script>";												
}
