...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 20;
    $url = 'pn5011_lov_kodepromotif.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode_promotif, kode_perusahaan, nama_perusahaan, npp, alamat_perusahaan,kode_kantor,kode_kegiatan ". 
    ...
    echo "<th><a href=\"$PHP_SELF?f=a.kode_kegiatan&o=$o\"><b>Kegiatan</b></a></th>";
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_PROMOTIF"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_PERUSAHAAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NPP"])."'; ". 
				"window.opener.document.".$formname.".".$fieldnamee.".value='".ExtendedFunction::ereg_replace("'","\'",$row["ALAMAT_PERUSAHAAN"])."'; ".       											
