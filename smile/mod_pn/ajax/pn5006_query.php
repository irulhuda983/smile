...
if($TYPE!=''){
  ...
  if($DB->execute())
    ...
    {				
				...
				$data['ACTION'] = '<input type="hidden" name="KODE['.$i.']" id="KODE_'.$i.'" value="'.$data['KODE_KLAIM'].'"><a href="#" onClick="NewWindow(\'http://'.$HTTP_HOST.'/mod_pn/ajax/pn5006_konfirmasi.php?task=new&root_sender=pn5006.php&sender=pn5006.php&activetab=1&sender_mid='.$mid.'&dataid='.$data['KODE_KLAIM'].'&kode_klaim='.$data['KODE_KLAIM'].'&no_konfirmasi_induk='.$data['NO_KONFIRMASI'].'\',\'PN5006 - KONFIRMASI BERKALA\')"><img src="../../images/user_go.png" border="0" alt="Konfirmasi Berkala" align="absmiddle" /> <u><font color="#009999">Konfirmasi</font></u> </a>';
