<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat homecare
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset ><legend>Rincian Manfaat</legend>
            ...
            <label style = "text-align:right;">Periode</label>
              <input type="text" id="homecare_tgl_awal" name="homecare_tgl_awal" readonly class="disabled" style="width:118px;">
              &nbsp;s/d&nbsp;
  						<input type="text" id="homecare_tgl_akhir" name="homecare_tgl_akhir" readonly class="disabled" style="width:118px;">
            </div>																																															
            <div class="clear"></div>
            ...
            <label  style = "text-align:right;">Total Diajukan </label>
              <input type="text" id="nom_biaya_diajukan" name="nom_biaya_diajukan" readonly class="disabled" style="width:250px;">			
            </div>																		
            <div class="clear"></div>
  					
  					<div class="form-row_kiri">
            <label  style = "text-align:right;">Total Diverifikasi </label>
              <input type="text" id="nom_biaya_diverifikasi" name="nom_biaya_diverifikasi" readonly class="disabled" style="width:250px;">		
            </div>																		
            <div class="clear"></div>
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#homecare_tgl_awal').val(getValue(jdata.data.DATA['HOMECARE_TGL_AWAL']));
						$('#homecare_tgl_akhir').val(getValue(jdata.data.DATA['HOMECARE_TGL_AKHIR']));
						
						$('#nom_biaya_diajukan').val(format_uang(getValue(jdata.data.DATA['NOM_BIAYA_DIAJUKAN'])));
						$('#nom_biaya_diverifikasi').val(format_uang(getValue(jdata.data.DATA['NOM_BIAYA_DIVERIFIKASI'])));
