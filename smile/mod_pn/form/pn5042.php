...
Hist: - 02/08/2017 : Pembuatan Form (Tim SIJSTK)		
      -16/11/2020 : penambahan kondisi kantor rekening sentral (source prod per 16/11/2020)						 						 
-----------------------------------------------------------------------------*/
//update 16/11/2020, jika kantor sudah sentralisasi rekening maka diarahkan ke pn5062.php
...
if ($ls_is_sentralrek > "0")
{
	echo "<script language=\"JavaScript\" type=\"text/javascript\">";
  	echo "window.location.replace('../form/pn5062.php?mid=$mid');";
  	echo "</script>";
}
  ...
  ?>	
    ...
    <table aria-describedby="captionfoxrm"   class="captionfoxrm">
      ...
      <tr>
            ...
            ?>
						<input type="radio" name="rg_kategori" value="1" onclick="this.form.submit()"  <?=$sel1;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JHT</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="2" onclick="this.form.submit()"  <?=$sel2;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JHT/JKM</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="3" onclick="this.form.submit()"  <?=$sel3;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JKK</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="4" onclick="this.form.submit()"  <?=$sel4;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JKM</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="5" onclick="this.form.submit()"  <?=$sel5;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JP</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="7" onclick="this.form.submit()"  <?=$sel7;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">JKP</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="rg_kategori" value="6" onclick="this.form.submit()"  <?=$sel6;?>>&nbsp;<span style="color:#ffffff; size:2; font-style:Sans-Serif">SEMUA DATA</strong>
    			</h3>    
    		</td>
      </tr>
    </table>
      ...
      <div id="formKiri" style="width:1000px">	 
        <fieldset><legend><strong>DATA KLAIM SIAP UNTUK DILAKUKAN PERSETUJUAN</strong></legend>  																 									 
      ...
      $("#btncari").click(function() {
  		...
  		function loadData()
  		{
  			 window.table = $('#mydata_grid').DataTable({
    			...
    			"destroy"		: true,
    	        "ajax"				: {
    	        	"url"	: "http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5042_query.php",
    	        	"type": "POST",							
    	        	"data" : function(e) { 
    	        		e.TYPE = $('#type').val();
