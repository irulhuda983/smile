...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_tkigagalberangkat&c_kode_klaim='+c_kode_klaim+'&c_kode_manfaat='+c_kode_manfaat+'&c_kd_prg='+c_kd_prg+'&c_no_urut='+c_no_urut;
