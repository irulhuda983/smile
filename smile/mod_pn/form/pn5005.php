...
if($trigersubmit=='2')
{
    ...
    {
  			//pembatalan klaim --------------------------------------------------
    		$qry = "BEGIN SIJSTK.P_PN_PN5005.X_BATAL_KLAIM('".${"kode_klaim".$cebox[$i]}."','$username',:p_sukses,:p_mess);END;";											 	
        $proc = $DB->parse($qry);				
...
echo "<th>&nbsp;<a href=\"$PHP_SELF?f=a.tgl_klaim&o=$o$sortvar\"><b>Tgl Klaim</b></a></th>";
