...
$ls_sender_mid 						= 'pn5041_penetapanmanfaat_tkipemulanganentry.php';
...
<head>
  ...
  {																						
    var tes=	<?php		
                echo "window.location.replace('pn5041_penetapanmanfaat_tkipemulangan.php?task=edit&kode_klaim=$ls_kode_klaim&kode_manfaat=$ls_kode_manfaat&form_penetapan=$ls_form_penetapan&sender_activetab=2&sender_mid=$ls_sender_mid ');";
              ?>;		
  }					
  </script>	
...
<body>
  ...
  <![endif]-->	
	...
	{    
		$ln_cek_transport_udara_diajukan 	= (float) str_replace(',','',$ln_transport_udara_diajukan);  
		$ln_cek_transport_udara_verifikasi 	= (float) str_replace(',','',$ln_transport_udara_verifikasi);  
		if($ln_cek_transport_udara_verifikasi > $ln_cek_transport_udara_diajukan){
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    function f_ajax_val_hitung_manfaat()
    {
			...
			if (c_kode_tipe_penerima!='')
			{
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_tkipemulangan&c_biaya_darat='+c_biaya_darat+'&c_biaya_laut='+c_biaya_laut+'&c_biaya_udara='+c_biaya_udara+'&c_biaya_udara='+c_biaya_udara+'&c_kode_klaim='+c_kode_klaim+'&c_no_urut='+c_no_urut;
        ...
        curr_transport_darat_verifikasi = c_biaya_darat;
			...
			{
			 	window.document.getElementById('transport_darat_diajukan').value = 0;
  			window.document.getElementById('transport_laut_diajukan').value = 0;
  			window.document.getElementById('transport_udara_diajukan').value = 0;
  			
  		 	window.document.getElementById('transport_darat_verifikasi').value = 0;
  			window.document.getElementById('transport_laut_verifikasi').value = 0;
  			window.document.getElementById('transport_udara_verifikasi').value = 0;
  			
  		 	window.document.getElementById('transport_darat_disetujui').value = 0;
  			window.document.getElementById('transport_laut_disetujui').value = 0;
  			window.document.getElementById('transport_udara_disetujui').value = 0;	 		 
			}
    ...
    <table class="captionfoxrm" aria-describedby="captionfoxrmdesc">
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
          ...
          <label style = "text-align:right;">&nbsp;</label>
						...
						<table id="tblrincian1" width="80%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff" aria-describedby="tblrincian1desc">
							<tbody>
								<tr>
                  ...
                  <th align="center">Biaya Disetujui</th>
								...
								<tr>
									...
									<td><input type="text" autocomplete="off" id="transport_udara_diajukan" name="transport_udara_diajukan" value="<?=number_format((float)$ln_transport_udara_diajukan,2,".",",");?>" tabindex="6" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_transport_udara_diajukan();"></td>
									<td><input type="text" autocomplete="off" id="transport_udara_verifikasi" name="transport_udara_verifikasi" value="<?=number_format((float)$ln_transport_udara_verifikasi,2,".",",");?>" tabindex="7" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_hitung_manfaat();"></td>
									<td><input type="text" id="transport_udara_disetujui" name="transport_udara_disetujui" value="<?=number_format((float)$ln_transport_udara_disetujui,2,".",",");?>" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value);" readonly class="disabled">
    									<input type="hidden" autocomplete="off" id="transport_darat_diajukan" name="transport_darat_diajukan" value="<?=number_format((float)$ln_transport_darat_diajukan,2,".",",");?>" tabindex="2" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_transport_darat_diajukan();">
    									<input type="hidden" autocomplete="off" id="transport_darat_verifikasi" name="transport_darat_verifikasi" value="<?=number_format((float)$ln_transport_darat_verifikasi,2,".",",");?>" tabindex="3" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_hitung_manfaat();">
    									<input type="hidden" id="transport_darat_disetujui" name="transport_darat_disetujui" value="<?=number_format((float)$ln_transport_darat_disetujui,2,".",",");?>" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value);" readonly class="disabled">
    									<input type="hidden" autocomplete="off" id="transport_laut_diajukan" name="transport_laut_diajukan" value="<?=number_format((float)$ln_transport_laut_diajukan,2,".",",");?>" tabindex="4" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_transport_laut_diajukan();">
    									<input type="hidden" autocomplete="off" id="transport_laut_verifikasi" name="transport_laut_verifikasi" value="<?=number_format((float)$ln_transport_laut_verifikasi,2,".",",");?>" tabindex="5" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value); f_ajax_val_hitung_manfaat();">
    									<input type="hidden" id="transport_laut_disetujui" name="transport_laut_disetujui" value="<?=number_format((float)$ln_transport_laut_disetujui,2,".",",");?>" size="20" maxlength="20" style="text-align:right;" onblur="this.value=format_uang(this.value);" readonly class="disabled">
									</td>	
								</tr>
								<tr>
									<td colspan="4">	
