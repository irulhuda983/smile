...
<script language="javascript">
  ...
  function addRowInnerHTML2(tblId)
  {
    ...
    newCell1.innerHTML = '<input type="text" id='+'d_realdtl_nama_perusahaan'+iteration+' name='+'d_realdtl_nama_perusahaan'+iteration+' readonly class=\'disabled\' size="10"><input type="hidden" id='+'d_realdtl_kode_promotif'+iteration+' name='+'d_realdtl_kode_promotif'+iteration+'><input type="hidden" id='+'d_realdtl_kode_perusahaan'+iteration+' name='+'d_realdtl_kode_perusahaan'+iteration+'>&nbsp;<a href="#" onclick="fl_js_lov_d_realdtl_promotif('+iteration+');"><img src="../../images/help.png" alt="Cari Data Perusahaan" border="0" align="absmiddle"></a><input type="hidden" readonly id='+'d_realdtl_bentuk_kegiatan'+iteration+' name='+'d_realdtl_bentuk_kegiatan'+iteration+' size="7" style="border-width: 1;text-align:left;" maxlength="30" ><input type="hidden" id='+'d_realdtl_nama_tk'+iteration+' name='+'d_realdtl_nama_tk'+iteration+' readonly class=\'disabled\' size="12"><input type="hidden" id='+'d_realdtl_kode_tk'+iteration+' name='+'d_realdtl_kode_tk'+iteration+'><input type="hidden" id='+'d_realdtl_kpj'+iteration+' name='+'d_realdtl_kpj'+iteration+'>';	
		...
		newCell5.innerHTML = '<input type="text" id='+'d_realdtl_harga_perpaket_barang'+iteration+' name='+'d_realdtl_harga_perpaket_barang'+iteration+' size="10" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_lov_d_realdtl_hitbrg_nom_diajukan('+iteration+');">';
		newCell6.innerHTML = '<input type="text" id='+'d_realdtl_nom_pokok'+iteration+' name='+'d_realdtl_nom_pokok'+iteration+' readonly class=disabled size="12" maxlength="20" style="border-width: 1;text-align:right">';		
		newCell7.innerHTML = '<input type="text" id='+'d_realdtl_nom_ppn'+iteration+' name='+'d_realdtl_nom_ppn'+iteration+' size="10" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_lov_d_realdtl_hitbrg_nom_diajukan('+iteration+');">';
		newCell8.innerHTML = '<input type="text" id='+'d_realdtl_nom_diajukan'+iteration+' name='+'d_realdtl_nom_diajukan'+iteration+' readonly class=disabled size="12" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);">';
    newCell9.innerHTML = '<input type="text" id='+'d_realdtl_keterangan'+iteration+' name='+'d_realdtl_keterangan'+iteration+' size="5" maxlength="300" style="border-width: 1;text-align:left">'; 
    newCell10.innerHTML = '<a href="#" onclick="removeperbrs2(this.parentNode.parentNode.rowIndex)" id="link_delete"><img src="../../images/file_cancel.gif" border="0" align="absmiddle"> Delete</a>';		
  }
  ...
  <table id="tblrincian2" width="90%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff">
    <tbody>
      ...
      <tr>
        ...
        <th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;" colspan="6">Barang</th>
      ...
      {									
        ...
        while ($row = $DB->nextrow())
        {
          ?>									
            ...
            <td>
            	<input type="text" id="d_realdtl_harga_perpaket_barang<?=$i;?>" name="d_realdtl_harga_perpaket_barang<?=$i;?>" size="10" maxlength="20" value="<?=number_format((float)$row['HARGA_PERPAKET_BARANG'],2,".",",");?>" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_lov_d_realdtl_hitbrg_nom_diajukan(<?=$i;?>);">
            </td>
						<td>
							<input type="text" id="d_realdtl_nom_pokok<?=$i;?>" name="d_realdtl_nom_pokok<?=$i;?>" size="12" maxlength="20" value="<?=number_format((float)$row['NOM_POKOK'],2,".",",");?>" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);" readonly class="disabled">
						</td>
            <td>
            	<input type="text" id="d_realdtl_nom_ppn<?=$i;?>" name="d_realdtl_nom_ppn<?=$i;?>" size="10" maxlength="20" value="<?=number_format((float)$row['NOM_PPN'],2,".",",");?>" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_lov_d_realdtl_hitbrg_nom_diajukan(<?=$i;?>);">
            </td>																			
            <td>
            	<input type="text" id="d_realdtl_nom_diajukan<?=$i;?>" name="d_realdtl_nom_diajukan<?=$i;?>" size="12" maxlength="20" value="<?=number_format((float)$row['NOM_DIAJUKAN'],2,".",",");?>" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);" readonly class="disabled">
            </td>																																																
            <td>
