 ...
 * Javascript code in this page
 */
// CUSTOM CODE UNTUK SMILE
var URL_DOWNLOAD_PDF = 'reportpdf.php';
var URL_VIEWER_PDF = 'reportviewer.php';
...
function webViewerInitialized() {
  ...
  // CUSTOM FOR SMILE REPORTING
  file = window.location.href.split('?')[0];
  file = file.replace(URL_VIEWER_PDF, URL_DOWNLOAD_PDF);
...
var defaultOptions = {
  ...
  workerSrc: {
    value: 'javascript/pdfjs/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
