...
<script language="javascript">
	...
	function fjq_ajax_val_onloadform()
	{
		...
		html_input += '    	 	 <input type="radio" name="rg_status_sekolah" id="rg_status_sekolah_t" value="T" onClick="fl_js_set_fieldset_stsekolah_t();">&nbsp;&nbsp;<b><font color="#009999">Tidak</font>';
    	html_input += '    	 	 <input type="radio" name="rg_status_sekolah" id="rg_status_sekolah_y" value="Y" onClick="fl_js_set_fieldset_stsekolah_y();">&nbsp;&nbsp;<font color="#009999">Ya</font></b>';																																	
		...
		html_input += '    	 	 <input type="radio" name="rg_flag_dok_lengkap" value="T" onClick="fl_js_set_ket_dok_tidaklengkap();">&nbsp;&nbsp;<b><font color="#009999">Tidak</font>';
    	html_input += '    	 	 <input type="radio" name="rg_flag_dok_lengkap" value="Y" onClick="fl_js_set_dok_lengkap();">&nbsp;&nbsp;<font color="#009999">Ya</font></b>';																																	
		html_input += '	   	 </legend>';
		html_input += '	   	 	 </br>';		
		...
		}else
		{
			...
			{
				$('#span_ket_dok_tidaklengkap').html('<i>Manfaat untuk tahun '+v_tahun+'<font color="#ff0000"> ditunda</font>.<br />Lakukan penetapan ulang apabila dokumen untuk tahun tersebut sudah lengkap..</i>'); 			 
    ...
    var v_flag_terima = $('#tmp_flag_terima').val() == '' ? 'T' : $('#tmp_flag_terima').val();
		...
		html_input += '	   <fieldset><legend>';
    html_input += '    	 	 <b><i><font color="#009999">Apakah di tahun '+v_tahun+' anak sedang menempuh pendidikan/pelatihan?</font></i></b>';
		html_input += '    	 	 <input disabled type="radio" name="rg_status_sekolah" id="rg_status_sekolah_t" value="T" onClick="fl_js_set_fieldset_stsekolah();">&nbsp;&nbsp;<b><font color="#009999">Tidak</font>';
    html_input += '    	 	 <input disabled type="radio" name="rg_status_sekolah" id="rg_status_sekolah_y" value="Y" onClick="fl_js_set_fieldset_stsekolah();">&nbsp;&nbsp;<font color="#009999">Ya</font></b>';																																	
		html_input += '	     	 <input type="hidden" id="status_sekolah" name="status_sekolah" value="'+v_flag_terima+'">';
		html_input += '	   </legend>';
		html_input += '	   	 </br>';
    ...
    html_input += '	   	   <div class="clear"></div>';				
		...
		html_input += '	     <fieldset><legend>';
    html_input += '    	 	 <b><i><font color="#009999">Apakah dokumen kelengkapan administrasi untuk tahun '+v_tahun+' lengkap?</font></i></b>';
		html_input += '    	 	 <input disabled type="radio" name="rg_flag_dok_lengkap" value="T" onClick="fl_js_set_ket_dok_tidaklengkap();">&nbsp;&nbsp;<b><font color="#009999">Tidak</font>';
    html_input += '    	 	 <input disabled type="radio" name="rg_flag_dok_lengkap" value="Y" onClick="fl_js_set_dok_lengkap();">&nbsp;&nbsp;<font color="#009999">Ya</font></b>';																																	
		html_input += '	   	 </legend>';
		html_input += '	   	 	 </br>';
		html_input += '			 	 <span id="span_dok_tidaklengkap" style="display:none">';
	...
	function fl_js_set_perubahan_nama_dokumen() 
  {
	...
	function fjq_ajax_val_doButtonOK()
	{
	 	var v_i 								= $('#vi').val();
		var v_tahun 						= $('#tahun').val();
		//var v_status_sekolah 		= $("input[name='rg_status_sekolah']:checked").val();
