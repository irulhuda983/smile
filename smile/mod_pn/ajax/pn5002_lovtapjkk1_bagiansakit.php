...
$pagetitle = "SIJSTK";
$gs_pagetitle = "Daftar Bagian yang Sakit";
...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 20;
    $url = 'pn5002_lovtapjkk1_bagiansakit.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode, keterangan from sijstk.ms_lookup a where tipe='KLMBGSAKIT' and nvl(aktif,'T')='Y' ".
    			 $filtersearch.
           "order by seq ";
    //echo $sql;
