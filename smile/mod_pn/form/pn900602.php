<?
$pagetype 		= "report";
$gs_pagetitle 	= "PN900602 - REKAPITULASI JAMINAN SIAP BAYAR CABANG (PNRBPU0008)";
	...
	<div id="formKiri">
		<fieldset><legend><?=$gs_pagetitle?></legend>
			<div class="form-row_kiri">
				...
				<a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn9002_lov_kantor.php?p=pn900201.php&a=adminForm&b=kode_kantor&c=nama_kantor','',800,500,1)" style="display: none;">   
