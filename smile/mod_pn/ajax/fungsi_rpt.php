...
function exec_rpt($paramform="no",$ls_namepdf,$ls_nama_rpt,$ls_user_param, $DB=null)
{
  ...
  */ 
	...
	$ls_link 	= "http://smile.bpjsketenagakerjaan.go.id/smile/includes/rptBPJS.php?url=";
	$report["link"] 	= $ls_link;
	...
	$rwservlet = 'http://rptserver.bpjsketenagakerjaan.go.id/reports/rwservlet/setauth?button=Submit&username=smile&password=smilekanharimu&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	//$rwservlet = 'http://172.28.200.21/reports/rwservlet/setauth?button=Submit&username=sijstk&password=jmo1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	// $rwservlet = 'http://rptserverdc.bpjsketenagakerjaan.go.id/reports/rwservlet/setauth?button=Submit&username=sijstk&password=jmo1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
...
function exec_rpt_drc($paramform="no",$ls_namepdf,$ls_nama_rpt,$ls_user_param, $DB=null)
{
  ...
  */ 
	...
	//edited by zimmy/opa/dewa @kartika candra @22jun2015 - ubah pola report dari rwrun menjadi rwservlet
	// $rwservlet = 'http://172.28.201.157:7779/reports/rwservlet/setauth?button=Submit&username=sijstk&password=welcome1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=sijstkoltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	//$ipdrc = 'http://172.28.201.154';
	//$ipdrc = 'http://172.28.200.153';
	$ipdrc = 'https://rptserver2.bpjsketenagakerjaan.go.id';
	$userdrc = 'smile';
	$passdrc = 'smilekanharimu';
	$siddrc = 'dboltpdrc';
...
function exec_rpt_xls($paramform="no",$ls_namepdf,$ls_nama_rpt,$ls_user_param, $DB=null)
{
  ...
  */ 
	...
	//$rwservlet = 'http://reptest.bpjsketenagakerjaan.go.id/reports/rwservlet/setauth?button=Submit&username=sijstk&password=jmo1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	$rwservlet = 'http://rptserver.bpjsketenagakerjaan.go.id/reports/rwservlet/setauth?button=Submit&username=smile&password=smilekanharimu&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desname%3D'.$ls_nama_rpt.'.xls%26desformat%3Denhancedspreadsheet%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	//$rwservlet = 'http://172.28.200.21/reports/rwservlet/setauth?button=Submit&username=sijstk&password=jmo1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desname%3D'.$ls_nama_rpt.'.xls%26desformat%3Denhancedspreadsheet%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	 $rwservlet = str_replace("'","",$rwservlet);
	 $rwservlet = str_replace("'","",$rwservlet);
...
function exec_rpt_sijstk($paramform="no",$ls_namepdf,$ls_nama_rpt,$ls_user_param, $DB=null)
{
  ...
  */ 
	...
	$rwservlet = 'http://rptserver.bpjsketenagakerjaan.go.id/reports/rwservlet/setauth?button=Submit&username=smile&password=smilekanharimu&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dboltp&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	//$rwservlet = 'http://172.28.200.21/reports/rwservlet/setauth?button=Submit&username=sijstk&password=jmo1&authtype=D&mask=GQ%253D%253D&isjsp=no&database=dbdevelop&nextpage=destype%3Dcache%26desformat%3DPDF%26report%3D'.$ls_nama_rpt.'%26userid%3D%2Fdata%2Fjms%2FSIAK%2FGL%2FREPORT%26'.$ls_user_param;
	$rwservlet = str_replace("'","",$rwservlet);
