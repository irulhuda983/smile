<?php
$pagetype = "form";
$gs_pagetitle = "PN5001 - ENTRY AGENDA KLAIM";
...
<form name="formreg" id="formreg" role="form" method="post">
  ...
  include "../ajax/pn5001_css.php";
	include "../ajax/pn5001_actionbutton.php";
	include "../ajax/pn5001_js.php";
          	...
          	// -------- end informasi klaim ------------------------------------				 	  	 
					}else
					{
					 	if(!empty($_GET['dataid']))
						{
							...
							{
							 	include "../ajax/pn5001_agenda_jht.php"; 
							}elseif ($ls_jenis_klaim=="JHM")
							{
								include "../ajax/pn5001_agenda_jhm.php";									 
							}elseif ($ls_jenis_klaim=="JKK")
							{
							 	include "../ajax/pn5001_agenda_jkk.php";
							}elseif ($ls_jenis_klaim=="JKM")
							{
							 	include "../ajax/pn5001_agenda_jkm.php";			
							}elseif ($ls_jenis_klaim=="JPN")
							{
                include "../ajax/pn5001_agenda_jpn.php";						 				
							}																			  													 
						}
					}
					?>
  ...
  ?>
	...
	<script type="text/javascript">
              	...
              	$.ajax(
              		...
              		success: function(data)
                		...
                		if(jdata.ret == '0')
                			...
                			window.location='pn5001.php?task=Edit&dataid='+jdata.DATAID+'&kode_klaim='+jdata.DATAID+'&mid=<?=$mid;?>';
                		}else 
        						{
                		 	alert(jdata.msg);
                		}
      ...
      $('#btn_view').click(function() {
        if(window.dataid != ''){
        window.location='pn5001.php?task=View&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
      ...
      $('#btn_edit').click(function() {													
        if(window.dataid != ''){
        	window.location='pn5001.php?task=Edit&kode_klaim='+window.dataid+'&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
        	alert('Silahkan pilih terlebih dahulu data yang akan di proses!');
        } 								
      });
      ...
      $('#btn_new').click(function() {
      	window.location='pn5001.php?task=New&dataid=&mid=<?=$mid;?>';
      });
  		...
  		function loadData()
  		{
    	    ...
    	    scrollX				: true,
    	  	"processing"		: true,
    			...
    			"destroy"		: true,
    	        "ajax"				: {
    	        	"url"	: "http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5001_query.php",
    	        	"type": "POST",							
    	        	"data" : function(e) { 
    	        		e.TYPE = $('#type').val();
