...
<![endif]-->
    <table class="caption">
      <tr> 
        ...
        <td align="right">Search By &nbsp
          <select name="pilihsearch">
            ...
            switch($pilihsearch)
            {
          		case 'sc_kode_tk' : $sel1="selected"; break;
							case 'sc_nama_tk' : $sel2="selected"; break;
							case 'sc_kpj' : $sel2="selected"; break; 
							case 'sc_nomor_identitas' : $sel2="selected"; break;  		
            }
            ?>
        		<option value="sc_all">--ALL--</option>
        		<option value="sc_kode_tk" <?=$sel1;?>>Kode TK</option>
						<option value="sc_nama_tk" <?=$sel2;?>>Nama TK</option>
						<option value="sc_kpj" <?=$sel2;?>>KPJ</option> 
						<option value="sc_nomor_identitas" <?=$sel2;?>>No Identitas</option>      
          </select>
      ...
      {
       $filtersearch = "and (upper(a.kode_tk) like '%".$searchtxt."%' or upper(a.nama_tk) like '%".$searchtxt."%' or upper(a.kpj) like '%".$searchtxt."%' or upper(a.nomor_identitas) like '%".$searchtxt."%') ";
      }
		}				
    // query with paging								
    $rows_per_page = 20;
    $url = 'pn5011_lov_dtlkodetk.php'; // url sama dengan nama file				
    ...
    echo "<th><a href=\"$PHP_SELF?f=a.kode_tk&o=$o\"><b>Kode TK</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=a.nama_tk&o=$o\"><b>Nama TK</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=a.kpj&o=$o\"><b>No.Ref</b></a></th>";		
		echo "<th><a href=\"$PHP_SELF?f=a.nomor_identitas&o=$o\"><b>No Identitas</b></a></th>";
		echo "<th><a href=\"$PHP_SELF?f=a.kode_tk&o=$o\"><b>Tgl Lahir</b></a></th>";
    echo "</tr>";
    ...
    ?>
      ...
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_TK"])."';".
				...
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_TK"])."'; ".        											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["TGL_LAHIR"]."</a>";?></td>															     																																																								
      </tr>
    <? 
    $i++; $nx++;
    }
