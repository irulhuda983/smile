  ...
  <fieldset><legend>Input Data Klaim Manfaat Pensiun</legend>
        ...
        <tr>
          ...
          <th style="text-align:center;font: 12px Verdana, Arial, Helvetica, sans-serif;width:110px;">Tgl Kejadian</th>					
				...
				<tr>
					...
					<td><input type="text" id="jpn_tk_nama" name="jpn_tk_nama" value="<?=$ls_nama_tk;?>" size="36" maxlength="100" readonly class="disabled">
							<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5001_agenda_jpn_ahliwaristkentry.php?task=view&kode_tk=<?=$ls_kode_tk;?>&kode_klaim=<?=$ls_kode_klaim;?>&kode_penerima_berkala=TK&root_sender=pn5001.php&sender=pn5001.php&sender_activetab=3&sender_mid=<?=$mid;?>&va=formreg&vb=jpn_tk_nama&vc=jpn_tk_kode_kondisi_terakhir&vd=jpn_tk_tgl_kondisi_terakhir','Ubah Data Keluarga',850,590,'no');"><img src="../../images/user_go.png" border="0" alt="Ubah Divisi" align="absmiddle" /></a>		 
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
            <select size="1" id="jpn_tk_kode_jenis_kasus" name="jpn_tk_kode_jenis_kasus" value="<?=$ls_jpn_tk_kode_jenis_kasus;?>" tabindex="2" class="select_format" onchange="fl_js_jpn_val_input();" <?=($ls_status_submit_agenda =="Y")? " style=\"text-align:center;width:130px;background-color:#F5F5F5\"" : " style=\"text-align:center;width:130px;background-color:#ffff99\"";?>>
            <option value="">-- Pilih --</option>
              ...
              ?>
					...
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
            <input type="text" id="jpn_tk_tgl_jenis_kasus" name="jpn_tk_tgl_jenis_kasus" value="<?=$ld_jpn_tk_tgl_jenis_kasus;?>" tabindex="3" size="10" maxlength="10" onblur="convert_date(jpn_tk_tgl_jenis_kasus);fl_js_jpn_val_input();" <?=($ls_status_submit_agenda =="Y")? " style=\"background-color:#F5F5F5\"" : " style=\"background-color:#ffff99\"";?>>
        		<?
      				if ($ls_status_submit_agenda !="Y")  	
        			{
      				 	?> 
      			...
      			?>					
					...
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
            <select size="1" id="jpn_tk_kode_kondisi_terakhir" name="jpn_tk_kode_kondisi_terakhir" value="<?=$ls_jpn_tk_kode_kondisi_terakhir;?>" tabindex="4" class="select_format" onchange="fl_js_jpn_val_input();" <?=($ls_status_submit_agenda =="Y")? " style=\"text-align:center;width:130px;background-color:#F5F5F5\"" : " style=\"text-align:center;width:130px;background-color:#ffffff\"";?>>
            <option value="">-- Pilih --</option>
              <?
              if ($ls_status_submit_agenda =="Y")
              {
              ...
              ?>
					...
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
            <input type="text" id="jpn_tk_tgl_kondisi_terakhir" name="jpn_tk_tgl_kondisi_terakhir" value="<?=$ld_jpn_tk_tgl_kondisi_terakhir;?>" tabindex="5" size="10" maxlength="10" onblur="convert_date(jpn_tk_tgl_kondisi_terakhir);"  <?=($ls_status_submit_agenda =="Y")? " style=\"background-color:#F5F5F5\"" : " style=\"background-color:#ffffff\"";?>>
        		<?
      				if ($ls_status_submit_agenda !="Y")  	
        			{
      				 	?> 
				...
				<tr>
					...
					<td><input type="text" id="jpn_pasangan_nama" name="jpn_pasangan_nama" value="<?=$ls_jpn_pasangan_nama;?>" size="40" maxlength="100" tabindex="6" readonly class="disabled">
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" style="text-align:center;" id="jpn_pasangan_nama_kondisi_terakhir" name="jpn_pasangan_nama_kondisi_terakhir" value="<?=$ls_jpn_pasangan_nama_kondisi_terakhir;?>" size="20" readonly class="disabled">
						<input type="hidden" id="jpn_pasangan_kode_kondisi_terakhir" name="jpn_pasangan_kode_kondisi_terakhir" value="<?=$ls_jpn_pasangan_kode_kondisi_terakhir;?>" size="20" readonly class="disabled">	
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" id="jpn_pasangan_tgl_kondisi_terakhir" name="jpn_pasangan_tgl_kondisi_terakhir" value="<?=$ld_jpn_pasangan_tgl_kondisi_terakhir;?>" size="14" readonly class="disabled">				
					</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td><input type="text" id="jpn_anak1_nama" name="jpn_anak1_nama" value="<?=$ls_jpn_anak1_nama;?>" size="40" maxlength="100" tabindex="9" readonly class="disabled">
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" style="text-align:center;" id="jpn_anak1_nama_kondisi_terakhir" name="jpn_anak1_nama_kondisi_terakhir" value="<?=$ls_jpn_anak1_nama_kondisi_terakhir;?>" size="20" readonly class="disabled">
						<input type="hidden" id="jpn_anak1_kode_kondisi_terakhir" name="jpn_anak1_kode_kondisi_terakhir" value="<?=$ls_jpn_anak1_kode_kondisi_terakhir;?>" size="20" readonly class="disabled">	
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" id="jpn_anak1_tgl_kondisi_terakhir" name="jpn_anak1_tgl_kondisi_terakhir" value="<?=$ld_jpn_anak1_tgl_kondisi_terakhir;?>" size="14" readonly class="disabled">				
					</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td><input type="text" id="jpn_anak2_nama" name="jpn_anak2_nama" value="<?=$ls_jpn_anak2_nama;?>" size="40" maxlength="100" tabindex="12" readonly class="disabled">
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" style="text-align:center;" id="jpn_anak2_nama_kondisi_terakhir" name="jpn_anak2_nama_kondisi_terakhir" value="<?=$ls_jpn_anak2_nama_kondisi_terakhir;?>" size="20" readonly class="disabled">
						<input type="hidden" id="jpn_anak2_kode_kondisi_terakhir" name="jpn_anak2_kode_kondisi_terakhir" value="<?=$ls_jpn_anak2_kode_kondisi_terakhir;?>" size="20" readonly class="disabled">	
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" id="jpn_anak2_tgl_kondisi_terakhir" name="jpn_anak2_tgl_kondisi_terakhir" value="<?=$ld_jpn_anak2_tgl_kondisi_terakhir;?>" size="14" readonly class="disabled">				
					</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td><input type="text" id="jpn_ortu_nama" name="jpn_ortu_nama" value="<?=$ls_jpn_ortu_nama;?>" size="40" maxlength="100" tabindex="15" readonly class="disabled">
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" style="text-align:center;" id="jpn_ortu_nama_kondisi_terakhir" name="jpn_ortu_nama_kondisi_terakhir" value="<?=$ls_jpn_ortu_nama_kondisi_terakhir;?>" size="20" readonly class="disabled">
						<input type="hidden" id="jpn_ortu_kode_kondisi_terakhir" name="jpn_ortu_kode_kondisi_terakhir" value="<?=$ls_jpn_ortu_kode_kondisi_terakhir;?>" size="20" readonly class="disabled">	
					</td>
					<td></td>
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
						<input type="text" id="jpn_ortu_tgl_kondisi_terakhir" name="jpn_ortu_tgl_kondisi_terakhir" value="<?=$ld_jpn_ortu_tgl_kondisi_terakhir;?>" size="14" readonly class="disabled">				
					</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td style="text-align:center;font: 10px Verdana, Arial, Helvetica, sans-serif;">
            <input type="text" id="jpn_tk_tgl_mulai_pensiun" name="jpn_tk_tgl_mulai_pensiun" value="<?=$ld_jpn_tk_tgl_mulai_pensiun;?>" size="12" maxlength="10" onblur="convert_date(jpn_tk_tgl_mulai_pensiun);"  readonly class="disabled">				
					</td>
					<td></td>
					<td></td>
					<td></td>
    ...
    <table id="tblrincianjp2" width="90%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff">
      ...
      <tr>
          ...
          <input type="hidden" name="d_realdtl_showmessage_jp2" style="border-width: 0;text-align:right" readonly size="30">								
					<?
    ...
    <table id="tblrincianjp3" width="90%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff">
      ...
      $sql2 = "select 
							  to_char(min(blth),'mm-yyyy') min_blth, 
								to_char(max(blth),'mm-yyyy') max_blth, 
                count(distinct(blth)) cnt_bln_iur,
                months_between(max(blth),min(blth))+1 cnt_bln_keps,
                case when months_between(max(blth),min(blth))+1 = 0 then
                    0
                else
                    100* count(distinct(blth))/(months_between(max(blth),min(blth))+1)
                end density_rate
              from sijstk.pn_klaim_tkupah 
              where kode_klaim = '$ls_kode_klaim' ";
      $DB->parse($sql2);
      $DB->execute();
      $row = $DB->nextrow();
      $ld_jp_tgl_awal_kepesertaan = $row["MIN_BLTH"];
			$ld_jp_tgl_akhir_kepesertaan = $row["MAX_BLTH"];
      ...
      <tr>
        ...
        <td style="text-align:left; font: 10px Verdana, Arial, Helvetica, sans-serif;" colspan="7"><?=$ld_jp_tgl_awal_kepesertaan;?> s/d <?=$ld_jp_tgl_akhir_kepesertaan;?> (<?=$ln_jp_jml_bln_masa_keps;?> Bulan)</td>								        
      </tr>	
      <tr>
        <td style="text-align:center;" colspan="2"><i>Masa Iur :<i>
        </td>	  									
        <td style="text-align:left; font: 10px Verdana, Arial, Helvetica, sans-serif;" colspan="7"><?=$ln_jp_jml_bln_masa_iur;?> Bulan</td>								        
      </tr>
      <tr>
        <td style="text-align:center;" colspan="2"><i>Density Rate :<i>
        </td>	  									
        <td style="text-align:left; font: 10px Verdana, Arial, Helvetica, sans-serif;" colspan="7"><?=$ln_jp_density_rate;?> %</td>								        
      </tr>																																																		 							
    </table>
	</fieldset>							
</div>
