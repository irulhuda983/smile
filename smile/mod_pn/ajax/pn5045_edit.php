        ...
        <td width="40%" valign="top" align="center" >
          <fieldset style="height:400px;"><legend><b><i><font color="#009999">Informasi Penerima Manfaat Periode Berkala <?=$ld_blth_awal;?> s/d <?=$ld_blth_akhir;?></font></i></b></legend>
            ...
            <label style = "text-align:right;">RT/RW - Kode Pos</label>		 	    				
              ...
              <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5045_lov_pos.php?p=pn5045_edit.php&a=formreg&b=kode_kelurahan&c=nama_kelurahan&d=kode_kecamatan&e=nama_kecamatan&f=kode_kabupaten&g=nama_kabupaten&h=kode_propinsi&j=nama_propinsi&k=kode_pos&l=ket_alamat_lanjutan','',800,500,1)">							
