            ...
            <?echo "<tr bgcolor=#".($i%2 ? "f3f3f3" : "ffffff").">";?>	
              ...
              <td align="center">
                <?
								...
								{
								?>
  								<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5001_uploadlampirandokumen.php?&kode_klaim=<?=$ls_kode_klaim;?>&kode_dokumen=<?=$row["KODE_DOKUMEN"];?>&sender=pn5001.php','upload_tk',550,400,'yes')" href="javascript:void(0);"> 
