...
$pagetitle = "SIJSTK";
$gs_pagetitle = "Daftar Penyakit yang Timbul";
...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 12;
    $url = 'pn5041_lovtapjkk1_penyakittimbul.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode, keterangan from sijstk.ms_lookup a where tipe='KLMPNYKIT' and nvl(aktif,'T')='Y' ".
    			 $filtersearch.
           "order by seq ";
    //echo $sql;
