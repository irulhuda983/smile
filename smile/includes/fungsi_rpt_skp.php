...
function exec_rpt($paramform="no",$ls_namepdf,$ls_nama_rpt,$ls_user_param, $DB=null)
{
  ...
  */ 
	...
	// reconfig_global
	$ip_report = $CONFIG->REPORT_SERVER_IP_DRC;
	$user_db_report = $CONFIG->REPORT_SERVER_USER_DB_14;
	$pass_db_report = $CONFIG->REPORT_SERVER_PASS_DB_14;
	$name_db_report = $CONFIG->REPORT_SERVER_NAME_DB_14;
	// reconfig_global
