  ...
  <div id="actmenu">
  	<div id="actbutton">
        ...
        ?>        
        <div style="float:left;"><div class="icon">
        	<a id="btn_close" href="http://<?=$HTTP_HOST;?>/mod_pn/form/pn5037.php?mid=<?=$mid;?>"><img src="http://<?=$HTTP_HOST;?>/images/file_cancel.gif" align="absmiddle" border="0"> Close</a> 
        </div></div>
        <?PHP
      } 
  		else 
  ...
  {
    //cek kelayakan ----------------------------------------------------------
    $qry = "BEGIN PN.P_PN_PN5037.X_CEK_AGENDA_KELAYAKAN('$ls_kode_klaim','$username',:p_sukses,:p_mess);END;";		
	//echo $qry;
    $proc = $DB->parse($qry);				
