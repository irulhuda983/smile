...
<![endif]-->
    <table class="caption">
      ...
      {
       $filtersearch = "and a.kode_pos like '%".$searchtxt."%' ";
      }				                		 
      else
      {
       $filtersearch = "and (upper(a.nama_kelurahan) like '%".$searchtxt."%' or upper(b.nama_kecamatan) like '%".$searchtxt."%' or upper(c.nama_kabupaten) like '%".$searchtxt."%' or upper(d.nama_propinsi) like '%".$searchtxt."%' or a.kode_pos like '%".$searchtxt."%') ";
      }
		}		
    // query with paging								
    $rows_per_page = 10;
    $url = 'pn5045_lov_pos.php'; // url sama dengan nama file				
    ...
    $sql = "select a.kode_kelurahan, a.nama_kelurahan, a.kode_pos, a.kode_kecamatan, b.nama_kecamatan, ".
           "     b.kode_kabupaten, c.nama_kabupaten, c.kode_propinsi, d.nama_propinsi, ".
					 "		 upper('KELURAHAN '||a.nama_kelurahan||' KECAMATAN '||b.nama_kecamatan||' KABUPATEN '||c.nama_kabupaten||' PROPINSI '||d.nama_propinsi) alamat_lanjutan ".
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				...
				"window.opener.document.".$formname.".".$fieldnamel.".value='".ExtendedFunction::ereg_replace("'","\'",$row["ALAMAT_LANJUTAN"])."'; ".         											
