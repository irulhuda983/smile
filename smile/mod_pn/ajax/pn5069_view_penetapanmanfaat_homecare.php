                ...
                <table id="tblMnf" width="100%" class="table-data2">
                  <thead>								
                    <tr>
                      ...
                      <th style="text-align:center;" colspan="4" class="hr-single-bottom">PENETAPAN NILAI MANFAAT HOMECARE</th>
                      <th style="text-align:center;" colspan="2"></th>
                    </tr>					
                    <tr class="hr-double-bottom">
                      <th style="text-align:center;">No</th>
                      <th style="text-align:center;">Tipe Penerima</th>
            					<th style="text-align:center;">Periode Homecare</th>
                      <th style="text-align:right;">Biaya Diajukan</th>
            					<th style="text-align:right;">Biaya Diverifikasi</th>
		...
		$.ajax({
			...
			success: function(data){
				try {
					...
					if (jdata.ret == 0) 
					{ 
						$("#span_page_title").html('PN5030 - RINCIAN MANFAAT - HOMECARE');
            ...
            { 
              for(var i = 0; i < jdata.data.DATA.length; i++)
              {
                ...
                html_mnf += '<td style="text-align: center;">' + getValue(jdata.data.DATA[i].NAMA_TIPE_PENERIMA) + '</td>';
								html_mnf += '<td style="text-align: center;">' + getValue(jdata.data.DATA[i].HOMECARE_TGL_AWAL) +' s/d '+getValue(jdata.data.DATA[i].HOMECARE_TGL_AKHIR)+ '</td>';
...
<script language="javascript">
	...
	{		
		var c_mid = '<?=$mid;?>';
		showForm('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5069_view_penetapanmanfaat_homecarerinci.php?kode_klaim='+p_kode_klaim+'&kode_manfaat='+p_kode_manfaat+'&no_urut='+p_no_urut+'&mid='+c_mid+'','',980,550,'yes');
	}
</script>
