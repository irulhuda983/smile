...
//if($TYPE!=''){
	...
	$sql .= " rownum <= 500 and a.kode_kantor = '".$ls_kode_kantor."' and a.status = 'PENGAJUAN' and a.sub_status = 'VERIFIKASI_PENGAJUAN' and a.status_verifikasi_pengajuan = 'DISETUJUI' ";
