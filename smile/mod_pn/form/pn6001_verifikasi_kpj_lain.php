...
if(isset($_GET['kd_agenda'])){
    $kd_agenda = $_GET['kd_agenda'];
        ...
        $sql_daftar_kartu_tdk_proses = "SELECT A.* FROM (
                                            SELECT aa.kode_tk,
                                                (SELECT b.kpj
                                                FROM kn.kn_tk b
                                                WHERE b.kode_tk = aa.kode_tk AND ROWNUM = 1)
                                        ...
                                        WHERE aa.kode_agenda = '$kd_agenda') a ORDER BY kpj";
        ...
        $sql_dokumen = "SELECT kode_tk,
                        ...
                        FROM (SELECT a.kode_tk,
                                ...
                                WHERE a.kode_agenda = '$kd_agenda') order by kpj";
                                ...
                                FROM (SELECT aa.kode_tk,
                                            ...
                                            OVER (
                                                PARTITION BY aa.kode_tk,
                                                            ...
                                                            aa.kode_perusahaan,
                                                            aa.kode_divisi
                                                ORDER BY aa.no_mutasi DESC, aa.tgl_na DESC)    urut
                                        FROM kn.vw_kn_tk aa
                                    WHERE     aa.flag_klaim_jht = 'T'
