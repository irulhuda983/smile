<?php
$pagetype = "report";
$gs_pagetitle = "Dashboard Pelayanan - Pembayaran Klaim JHT Nasional Berdasarkan Nominal";
...
$sql_perkanwil = "select 
							 	 	  kolom_01 kd_prg, 
                    kolom_02 kelompok_nominal, 
                    kolom_03 nama_kelompok_nominal, 
                    kolom_04 ket_kelompok_nominal, 
										to_number(kolom_05) jml_kasus, 
                    to_number(kolom_06) nom_pembayaran 
                  from table
                  (
                    PN.P_PN_REPORT.F_PN9002(
                      'DSH_TOTBYRKLAIM_JHT_BYNOMINAL', 
                      '$ls_kode_kantor', 
                      '$ls_kode_segmen', 
...
while ($row = $DB->nextrow()) 
{
  ...
  $ls_graph1_bar_xAxisCategory1_temp .= "'".$row['KET_KELOMPOK_NOMINAL']."',";
  $ls_graph1_bar_val_temp .= $ln_graph1_bar_val.",";
	
	//grafik pie -----------------------------------------------------------------
	$ls_graph_pie_val_x1 = $row["KELOMPOK_NOMINAL"];
  $ls_graph_pie_val_x2 = $row["KET_KELOMPOK_NOMINAL"];
	...
	<div class="content">
		<div class="container">
          ...
          <div class="row">
    				<div class="col-lg-12">
              <div class="card-box">
    						<h4 class="header-title m-t-0 m-b-30"><b>Pembayaran Klaim JHT Berdasarkan Nominal</b></h4>
          ...
          <div class="row">
    				<div class="col-lg-12">
              <div class="card-box">
    						<h4 class="header-title m-t-0 m-b-30"><b>Komposisi Pembayaran Klaim JHT Berdasarkan Nominal</b></h4> 
                <div class="widget-chart text-center">
                  ...
                  <div class="form-group m-b-20">
                    ...
                    <tr>
                      <th colspan="3" style="text-align:center">PEMBAYARAN KLAIM JHT</th>
										...
										<tr>
                      <th style="text-align:center">Range Nominal</th>
