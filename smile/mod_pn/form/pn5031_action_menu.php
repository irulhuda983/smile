...
$(document).ready(function(){
    $('#btn_view').click(function() {
        if(window.dataid != ''){
        window.location='pn5031.php?task=View&kode_faskes='+window.dataid+'&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
    ...
    $('#btn_edit').click(function() {									
        if(window.dataid != ''){
            window.location='pn5031.php?task=Edit&kode_faskes='+window.dataid+'&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
            alert('Silahkan pilih terlebih dahulu data yang akan di proses!');
        } 								
    });        
    $('#btn_new').click(function() {
        window.location='pn5031.php?task=New&dataid='+window.dataid+'&mid=<?=$mid;?>';
    });
});
</script>