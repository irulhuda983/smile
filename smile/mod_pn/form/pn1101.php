<?php
$pagetype = "form";
$gs_pagetitle = "Setup - Klaim";
require_once "../../includes/header_app_nosql.php";	
$mid = $_REQUEST["mid"]; 
$php_file_name="pn1101";
//$gs_kode_segmen = "PU";
/* ============================================================================
...
$task_no=isset($_REQUEST['taskno'])?$_REQUEST['taskno']:'TipeKlaim';
$tab_title = array(
    "TipeKlaim"=>"Tipe Klaim",
    "TipePenerima" => "Tipe Penerima",
    "GroupICD" => "Group ICD",
    "LokasiKecelakaan" => "Lokasi Kecelakaan",
    "KondisiTerakhir" => "Kondisi Terakhir",
    "KuisEvaluasi" => "Kuisioner Evaluasi",
    "JenisKasus" => "Jenis Kasus",
    "Akibat"=>"Akibat Diderita",
    "Diagnosa"=>"Diagnosa",
    "DiagnosaDetil"=>"Diagnosa Detil",
    "Dokumen"=>"Dokumen",
    "SebabKlaim"=>"Sebab Klaim",
    "SebabSegmen"=>"Sebab Segmen",
    "Manfaat"=>"Manfaat"
);
    ...
    $.ajax({
        ...
        success: function(ajaxdata){ 
            ...
            if($.trim(ajaxdata)!="") alert(ajaxdata);
                ...
                window.location='<?=$php_file_name;?>.php?taskno=<?=$task_no;?>&mid=<?=$mid;?>&s='+skey
            }
        },
        error:function(){
