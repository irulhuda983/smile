...
<head>
  ...
  <script type="text/javascript">
    function refreshParent() 
    {
    	...
    	if($ls_sender!='')
			{			
    		if ($ls_sender=='pn5041_penetapan.php')
				{
    ...
    if ($ls_kode_tipe_penerima !="")
    {
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
          ...
          <label style = "text-align:right;">Kode Pos</label> 	    				
            ...
            <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5040_lov_pos.php?p=pn5040_agenda_jpn_manfaatlumpsumpenerima.php&a=fpop&b=kode_kelurahan&c=nama_kelurahan&d=kode_kecamatan&e=nama_kecamatan&f=kode_kabupaten&g=nama_kabupaten&h=kode_propinsi&j=nama_propinsi&k=kode_pos','',800,500,1)">							
