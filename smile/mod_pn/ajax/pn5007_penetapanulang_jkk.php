                ...
                ?>
                  <?echo "<tr bgcolor=#".($i%2 ? "f3f3f3" : "ffffff").">";?>	
                    ...
                    <td align="center">
      								...
      								{
      								?>
                    		<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/<?=$row["URL_PATH"];?>?task=view&kode_klaim=<?=$row["KODE_KLAIM"];?>&kode_manfaat=<?=$row["KODE_MANFAAT"];?>&root_sender=pn5007.php&form_penetapan=../form/pn5007.php&sender_activetab=2&sender_mid=<?=$mid;?>','Rincian Biaya dan Santunan',950,580,'no')"><img src="../../images/indent_right.gif" border="0" alt="Ubah Divisi" align="absmiddle" /><font style="text-align:right; font: 10px Verdana, Arial, Helvetica, sans-serif;">INFO</font></a>
      								<?
      								}else
      								{
      								?>
            ...
            <tbody>
              <tr>
        						...
        						{	
          						?>
              				&nbsp;|&nbsp;
    									<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5007_ubahkondisi_tk.php?sender=../form/pn5007.php&kode_klaim=<?=$ls_kode_klaim;?>&mid=<?=$mid;?>','Ubah Kondisi Terakhir TK',700,420,'no')"><img src="../../images/refreshx.png" border="0" alt="Tambah" align="absmiddle" style="height:18px;"/><b>&nbsp;Ubah Status</b></a>
            					<?						
        						}
									?>									
								</th>							
                  ...
                  <?echo "<tr bgcolor=#".($i%2 ? "f3f3f3" : "ffffff").">";?>	
                    ...
                    <!--<td style="text-align:center; font: 10px Verdana, Arial, Helvetica, sans-serif;"><?=$row['TIPE_PENERIMA_MANFAAT'];?></td>-->
                        ...
                        //- Orthose Protehese		10 --->rumus --> ok
												...
												//{
												?>
                    			<a href="#" onClick="window.location.replace('http://<?=$HTTP_HOST;?>/mod_pn/ajax/<?=$row["URL_PATH"];?>?task=edit&kode_klaim=<?=$row["KODE_KLAIM"];?>&kode_manfaat=<?=$row["KODE_MANFAAT"];?>&root_sender=pn5007.php&form_penetapan=../form/pn5007.php&sender_activetab=2&sender_mid=<?=$mid;?>','Rincian Biaya dan Santunan',950,580,'no')"><img src="../../images/indent_right.gif" border="0" alt="Ubah Divisi" align="absmiddle" /><font style="text-align:right; font: 10px Verdana, Arial, Helvetica, sans-serif;">RINCIAN</font></a>
      									<?
												//}
												?>
											<?
