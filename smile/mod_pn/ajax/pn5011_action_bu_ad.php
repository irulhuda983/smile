...
else if (($TYPE =='DEL') && ($DATAID != ''))
{
  ...
  if($KODE_REPORT == 'JKKTTPVPRS'){
    $ls_nama_rpt = 'PNR500804.rdf';
  }elseif($KODE_REPORT == 'JKKTTPVPK'){
    $ls_nama_rpt = 'PNR500805.rdf';
  }elseif($KODE_REPORT == 'JKKPTPVPRS'){
    $ls_nama_rpt = 'PNR500806.rdf';
  }elseif($KODE_REPORT == 'JKKPTPVPK'){
    $ls_nama_rpt = 'PNR500807.rdf';
  }
