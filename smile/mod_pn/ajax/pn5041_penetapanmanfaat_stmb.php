...
/*--------------------- Form History -----------------------------------------
File: pn5041_penetapanmanfaat_stmb.php
  ...
  <div id="formKiri" style="width:1000px">
    ...
    <table id="mydata2" cellspacing="0" style="text-align:center;width:89%;">
      <tbody>			
        ...
        <tr>
          <th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;" colspan="5">&nbsp;</th>
        ...
        <tr>
          ...
          <th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;width:150px;">Tipe Penerima</th>
					<th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;width:150px;">Periode STMB</th>
          <th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;width:70px;">Jml Hari</th>
					<th style="text-align:center;font: 12px Arial, Helvetica, sans-serif;width:70px;">Jam Kerja</th>
        ...
        {			
          ...
          while ($row = $DB->nextrow())
          {
            ...
            <?echo "<tr bgcolor=#".($i%2 ? "f3f3f3" : "ffffff").">";?>								
              ...
              <td style="text-align:center"><?=number_format((float)$row["STMB_JML_HARI"],0,".",",");?></td> 
							<td style="text-align:center"><?=number_format((float)$row["STMB_JML_JAMKERJA"],0,".",",");?></td>  									
              ...
              <td>
							...
							{
  							?>
                <a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_stmbentry.php?task=view&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php','Entry Rincian Manfaat',850,600,'no')"><img src="../../images/check.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;View </a> |
  							<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_stmbdetil.php?task=edit&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php','Entry Rincian Manfaat',800,350,'no')"><img src="../../images/application_get.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Detil </a>
                <?
							}else
							{
  							?>
                <a href="#" onClick="window.location.replace('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_stmbentry.php?task=edit&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php','Entry Rincian Manfaat',850,600,'no')"><img src="../../images/check.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Edit </a>	|
                <a href="javascript:confirmDelete('?delete_manfaatrinci=DEL&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php')"><img src="../../images/minus.png" alt="Delete" border="0" align="absmiddle" title="Delete">delete</a>										
  							<a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_stmbdetil.php?task=edit&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php','Entry Rincian Manfaat',800,350,'no')"><img src="../../images/application_get.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Detil </a>									
  							<?							
							}
							?>							
      ...
      <tr>
        ...
        <td style="text-align:center"><?=number_format((float)$ln_tot_jml_hari,0,".",",");?></td>
				<td style="text-align:center"><?=number_format((float)$ln_tot_jml_jamkerja,0,".",",");?></td>  									
        <td style="text-align:right"><?=number_format((float)$ln_tot_biaya_disetujui,2,".",",");?></td>				
    			...
    			{
      			?>
               <a href="#" onClick="window.location.replace('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_stmbentry.php?task=new&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_stmb.php','Entry Rincian Manfaat',850,600,'no');" href="javascript:void(0);"><img src="../../images/plus.png" border="0" alt="Tambah" align="absmiddle" />&nbsp;Entry</a>
            <?
    			}
    			?>									
        </td>																					
