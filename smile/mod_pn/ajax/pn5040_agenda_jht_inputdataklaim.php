...
// 05012022, penyesuain untuk kebutuhan syariah JHT
/*
$sql = "select
	...
	*/
$sql = "select
            kode_manfaat, to_char(a.tgl_saldo_awaltahun,'dd/mm/yyyy') tgl_saldo_awaltahun,
            a.nom_saldo_awaltahun,
            to_char(a.tgl_pengembangan_estimasi,'dd/mm/yyyy') tgl_pengembangan_estimasi,
            a.nom_pengembangan_estimasi, a.nom_manfaat_sudahdiambil, a.pengambilan_ke
        from sijstk.pn_klaim_manfaat_detil a
        ...
        and no_urut = (
                        ...
                        (select b.*
                         ...
                         where rownum = 1) = :p_status1 then '1'
                        when 
                        (select b.*
                          from (  select c.status_syariah
                                    from kn.vw_kn_tk c
                                   where     c.kode_tk = :p_kode_tk
                                         ...
                                         and c.kode_divisi = :p_kode_divisi
                                order by c.no_mutasi desc) b
                         where rownum = 1) = :p_status2 then '2'
                        end
                      )"; 
$proc = $DB->parse($sql);
$param_bv = [':p_kode_manfaat' => '18',':p_kode_klaim' => $ls_kode_klaim,':p_kode_tk' => $ls_kode_tk,':p_kode_perusahaan' => $ls_kode_perusahaan,':p_kode_divisi' => $ls_kode_divisi,':p_status1' => 'T',':p_status2' => 'Y'];
...
$sql = "select 
        ...
        and rownum = :p_rownum";
$param_bv = [':p_kode_klaim' => $ls_kode_klaim,':p_kode_manfaat' => $ls_jhtinput_kode_manfaat,':p_rownum' => 1];
$proc = $DB->parse($sql);
foreach ($param_bv as $key => $value) {
 oci_bind_by_name($proc, $key, $param_bv[$key]);
}
...
$ls_jhtinput_kode_bhp							= $row["KODE_BHP"];
?>
<script language="JavaScript">    
  ...
  function fl_js_val_email_jht(v_field_id)
  {
  ...
  function fl_js_val_npwp_jht(v_field_id)
  {
    ...
    {
     	fl_js_val_numeric_jht(v_field_id);	 
    }
  }
  ...
  { 
  	...
  	if (v_kode_tipe_penerima =="AW") //ahli waris ----------------------------
    {
      window.document.getElementById("span_jhtinput_kode_hubungan").style.display = 'block';	
  		...
  		window.document.getElementById("span_jhtinput_hide_bhp1").style.display = 'block';
      ...
      //enabled field ----------------------------------------
      document.getElementById('jhtinput_nama_pemohon').readOnly = false;
      document.getElementById('jhtinput_nama_pemohon').style.backgroundColor='#ffff99';
      document.getElementById('jhtinput_alamat').readOnly = false;
      document.getElementById('jhtinput_alamat').style.backgroundColor='#ffff99';
      document.getElementById('jhtinput_email').readOnly = false;
      document.getElementById('jhtinput_email').style.backgroundColor='#ffffff';
      document.getElementById('jhtinput_telepon_area').readOnly = false;
      document.getElementById('jhtinput_telepon_area').style.backgroundColor='#ffffff';
      document.getElementById('jhtinput_telepon').readOnly = false;
      document.getElementById('jhtinput_telepon').style.backgroundColor='#ffffff';
      document.getElementById('jhtinput_telepon_ext').readOnly = false;
      document.getElementById('jhtinput_telepon_ext').style.backgroundColor='#ffffff';						
    }else
    {
			...
			if (v_kode_tipe_penerima =="BH") //bhp ----------------------------
      {
        ...
        window.document.getElementById("jhtinput_kode_hubungan").value = "";	
  			...
  			window.document.getElementById("jhtinput_no_urut_keluarga").value = "";
				...
				window.document.getElementById("jhtinput_tempat_lahir").value = "";
				window.document.getElementById("jhtinput_tgl_lahir").value = "";
				window.document.getElementById("jhtinput_jenis_kelamin").value = "";
				window.document.getElementById("jhtinput_golongan_darah").value = "";
				window.document.getElementById("jhtinput_rt").value = "";
				window.document.getElementById("jhtinput_rw").value = "";
				window.document.getElementById("jhtinput_kode_pos").value = "";
				window.document.getElementById("jhtinput_nama_kelurahan").value = "";
				window.document.getElementById("jhtinput_kode_kelurahan").value = "";
				window.document.getElementById("jhtinput_nama_kecamatan").value = "";
				window.document.getElementById("jhtinput_kode_kecamatan").value = "";
				window.document.getElementById("jhtinput_nama_kabupaten").value = "";
				window.document.getElementById("jhtinput_kode_kabupaten").value = "";
				window.document.getElementById("jhtinput_kode_propinsi").value = "";
				window.document.getElementById("jhtinput_nama_propinsi").value = "";
				window.document.getElementById("jhtinput_handphone").value = "";
				window.document.getElementById("jhtinput_nomor_identitas").value = "";
				window.document.getElementById("jhtinput_npwp").value = "";

				window.document.getElementById("span_jhtinput_hide_bhp1").style.display = 'none';
				...
				//disabled field ----------------------------------------
				document.getElementById('jhtinput_nama_pemohon').readOnly = true;
        document.getElementById('jhtinput_nama_pemohon').style.backgroundColor='#F5F5F5';
				document.getElementById('jhtinput_alamat').readOnly = true;
        document.getElementById('jhtinput_alamat').style.backgroundColor='#F5F5F5';
				document.getElementById('jhtinput_email').readOnly = true;
        document.getElementById('jhtinput_email').style.backgroundColor='#F5F5F5';
				document.getElementById('jhtinput_telepon_area').readOnly = true;
        document.getElementById('jhtinput_telepon_area').style.backgroundColor='#F5F5F5';
				document.getElementById('jhtinput_telepon').readOnly = true;
        document.getElementById('jhtinput_telepon').style.backgroundColor='#F5F5F5';
				document.getElementById('jhtinput_telepon_ext').readOnly = true;
        document.getElementById('jhtinput_telepon_ext').style.backgroundColor='#F5F5F5';
  ...
  function f_getdata_tipepenerima_bph()
    ...
    var vKodeKlaim = $('#kode_klaim').val();
		var vkode_tipe_penerima = $('#jhtinput_kode_tipe_penerima').val();
		
    if (vKodeKlaim!='' && vkode_tipe_penerima!='' && vkode_tipe_penerima!=curr_jhtinput_kode_tipe_penerima)
    {
      $.ajax(
      {
        type: 'POST',
        ...
        success: function(data)
        {
          ...
          {   
            console.log(data);
						$('#jhtinput_kode_bhp').val(jdata.data['v_kode_bhp']);
						$('#jhtinput_nama_pemohon').val(jdata.data['v_nama_bhp']);
						$('#jhtinput_alamat').val(jdata.data['v_alamat_bhp']);
						$('#jhtinput_email').val(jdata.data['v_email']);
						$('#jhtinput_telepon_area').val(jdata.data['v_telepon_area']);
						$('#jhtinput_telepon').val(jdata.data['v_telepon']);
						
            curr_jhtinput_kode_tipe_penerima = vkode_tipe_penerima;
          }else{
            preload(false);
            console.log(data);
            alert(jdata.msg);
...
<script type="text/javascript">
	...
	var curr_jhtinput_kode_tipe_penerima =<?php echo ($ls_jhtinput_kode_tipe_penerima=='') ? 'false' : "'".$ls_jhtinput_kode_tipe_penerima."'"; ?>;
</script>	
		
<div id="formKiri" style="width:955px;">
	<table aria-describedby="mydesc" width="955px;" border="0">
    <tr><th></th></tr>
		<tr>
			<td width="47%" valign="top"">
				<fieldset style="height:395px;"><legend><b><i><font color="#009999">Saldo JHT :</font></i></b></legend>
					<br></br>
          ...
          <label  style = "text-align:right;">Pengambilan JHT ke- &nbsp;</label>
			...
			<td width="53%" valign="top">
				<fieldset style="min-height:395px;"><legend><b><i><font color="#009999">Penerima Manfaat :</font></i></b></legend>
          <div class="form-row_kiri">
          <label  style = "text-align:right;">Tipe Penerima &nbsp;*</label>
            ...
            ?>
				...
				<input type="hidden" id="jhtinput_kode_bhp" name="jhtinput_kode_bhp" value="<?=$ls_jhtinput_kode_bhp;?>">
      		</div>		    																																				
        	<div class="clear"></div>
          ...
          <span id="span_jhtinput_kode_hubungan" style="display:none;">
            ...
            <label style = "text-align:right;">Ahli Waris *</label>		 	    				
              ...
              $param_bv = [];
        			...
        			{
                $param_bv[':p_status'] = 'Y'; 
                $param_bv[':p_kode_hubungan'] = 'T'; 
                $param_bv[':p_nik'] = $ls_nomor_identitas; 
                $param_bv[':p_kode_tk'] = $ls_kode_tk; 
                $param_bv[':p_rownum'] = 1; 
                $param_bv[':p_kepala_keluarga'] = 'KEPALA KELUARGA'; 
                $param_bv[':p_1'] = 7; 
                $param_bv[':p_2'] = 1; 
                $param_bv[':p_3'] = 'L'; 
                $param_bv[':p_4'] = 'S'; 
                $param_bv[':p_5'] = 'P'; 
                $param_bv[':p_6'] = 'I'; 
                $sql = "select kode_hubungan,nama_hubungan from sijstk.kn_kode_hubungan_tk where nvl(aktif,'T') = :p_status and kode_hubungan <> :p_kode_hubungan ".
      							 	 "and kode_hubungan <> decode((select case
                                                                when JENIS_KELAMIN is null and (select b.status_hub_keluarga from kn.kn_penduduk b where b.nik = :p_nik and rownum = :p_rownum) = :p_kepala_keluarga then
                                                                  case
                                                                      when substr(:p_nik,:p_1,:p_2) > 3 then
                                                                        'P'
                                                                      else
                                                                        'L'
                                                                    end
                                                                else
                                                                  (select jenis_kelamin from kn.vw_kn_tk where kode_tk=:p_kode_tk and rownum= :p_rownum)
                                                          end JENIS_KELAMIN from kn.vw_kn_tk where kode_tk=:p_kode_tk and rownum=:p_rownum),:p_3,:p_4,:p_5,:p_6,'') ".
      								 "order by urutan";			
        			}else
        			{
          ...
          <label style = "text-align:right;">Nama &nbsp;&nbsp;*</label>
      			<input type="text" id="jhtinput_nama_pemohon" name="jhtinput_nama_pemohon" value="<?=$ls_jhtinput_nama_pemohon;?>" tabindex="4" maxlength="100" <?=($ls_status_submit_agenda =="Y")? " style=\"width:270px;\" readonly class=disabled" : " style=\"width:270px;background-color:#ffff99\"";?>>
					...
					<span id="span_jhtinput_hide_bhp1" style="display:block;">
          <div class="form-row_kiri">
          ...
          <label style = "text-align:right;">Email &nbsp;&nbsp;</label>		 	    				
      			<input type="text" id="jhtinput_email" name="jhtinput_email" value="<?=$ls_jhtinput_email;?>" tabindex="12" onblur="fl_js_val_email_jht('jhtinput_email');" maxlength="200" <?=($ls_status_submit_agenda =="Y")? " style=\"width:270px;\" readonly class=disabled" : " style=\"width:270px;\"";?>>
      		</div>
      		<div class="clear"></div>
          ...
          <label style = "text-align:right;">Handphone &nbsp;&nbsp;</label>		 	    				
          	<input type="text" id="jhtinput_handphone" name="jhtinput_handphone" tabindex="16" value="<?=$ls_jhtinput_handphone;?>" onblur="fl_js_val_numeric_jht('jhtinput_handphone');" maxlength="15" <?=($ls_status_submit_agenda =="Y")? " style=\"width:270px;\" readonly class=disabled" : " style=\"width:270px;\"";?>>
      		</div>																																																																																														
          <div class="clear"></div>
          ...
          <label style = "text-align:right;">NPWP &nbsp; </label>
            <input type="text" id="jhtinput_npwp" name="jhtinput_npwp" value="<?=$ls_jhtinput_npwp;?>" onblur="fl_js_val_npwp_jht('jhtinput_npwp');" size="41" maxlength="15" tabindex="18" onblur="fl_js_val_numeric_jht('jhtinput_npwp');" <?=($ls_status_submit_agenda =="Y")? " style=\"width:240px;\" readonly class=disabled" : " style=\"width:240px;\"";?>>
      		</div>																																									
          <div class="clear"></div>
				</span>
          <?
