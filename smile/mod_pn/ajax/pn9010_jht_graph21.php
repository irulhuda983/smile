<?php
$pagetype = "report";
$gs_pagetitle = "Dashboard Pelayanan - Tingkat Pengembangan JHT-JP";
...
//krn tingkat pengembangan saldo dan iuran nilainya sama maka diambil salah satu
$sql3 = "select distinct no_urut, jenis, nama_jenis 
        ...
        (
            ...
            where jenis = 'K'
            and kd_prg = 1
						and to_char(tgl_efektif,'yyyymmdd') >= to_char(add_months(trunc(to_date('$ld_tgl','dd/mm/yyyy'),'yyyy'),-1),'yyyymmdd')
            UNION ALL
            select 
...
while ($row = $DB->nextrow())
{
  ...
  $sql4a = "select
                distinct to_char(tgl_efektif,'yyyymmdd') tgl_efekftif, to_char(tgl_efektif,'Monyy')||'-'||to_char(tgl_akhir,'Monyy') ket_tgl_efektif,
                rate_pengembangan
            from
            (
            ...
            where jenis = '$ls_kode'
            order by to_char(tgl_efektif,'yyyymmdd') ";																
  //echo $sql4a;
  $DB2->parse($sql4a);
  $DB2->execute();
  $i=0; $n=0;      
	...
	<div class="content">
        ...
        <div class="col-5">
          ...
          <h4 class="header-title m-t-0 m-b-30">
            <b>
            Tingkat Pengembangan Bulanan JHT-JP
            </b>
          </h4>
          <div class="widget-chart text-center">
          	<div id='container_graph1_bulanan' style="width:1000px;height:250px;"></div>					
          </div>	 
					</div>
				</div>
			</div>
			...
			<div class="row">	
					<div class="col-lg-12">
						<div class="card-box">		 
						  <h4 class="m-t-0 header-title"><b>Data Tingkat Pengembangan Bulanan JHT-JP</b></h4>
                      ...
                      <th colspan="1" style="text-align:center">JHT (%)</th>
                                ...
                                (
                                    select 
                                        to_char(tgl_efektif,'yyyymmdd') tgl_efektif,
                                        to_char(tgl_efektif,'dd-mm-yyyy')||' s/d '||to_char(tgl_akhir,'dd-mm-yyyy') ket_tgl_efektif,
