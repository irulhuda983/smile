...
<div id="formKiri" style="width:955px;">
  <fieldset><legend>Input Data Klaim JHT/JKM</legend>	
    ...
    <label style = "text-align:right;">Tgl Kematian &nbsp;</label>
      <input type="text" id="jhminput_tgl_kematian" name="jhminput_tgl_kematian" value="<?=$ld_jhminput_tgl_kematian;?>" tabindex="1" style="width:250px;" maxlength="10" onblur="convert_date(jhminput_tgl_kematian);" readonly class="disabled">      	
		</div> 
    <div class="form-row_kanan">
    <label style = "text-align:right;"><i><font color="#009999">Penerima Manfaat :</font></i></label>				
      <input type="text" name="temp1" style="width:269px;" style="border-width: 0;text-align:left" readonly>
    </div>			
		<div class="clear"></div>
		
    <div class="form-row_kiri">
    <label style = "text-align:right;">Keterangan &nbsp;</label>
			<textarea cols="255" rows="1" id="jhminput_ket_tambahan" name="jhminput_ket_tambahan" tabindex="2" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)" <?=($ls_status_submit_agenda =="Y")? " readonly class=disabled style=\"width:250px;height:14px;background-color:#F5F5F5;\"" : " style=\"width:250px;height:14px;background-color:#ffff99\"";?>><?=$ls_jhminput_ket_tambahan;?></textarea>	   							
    </div>
    <div class="form-row_kanan">
    ...
    <span id="span_jhminput_kode_hubungan" style="display:none;">
      ...
      <label style = "text-align:right;">Ket Lain-lain *</label>		
				<input type="text" id="jhminput_ket_hubungan_lainnya" name="jhminput_ket_hubungan_lainnya" value="<?=$ls_jhminput_ket_hubungan_lainnya;?>" tabindex="3" maxlength="300" <?=($ls_status_submit_agenda =="Y")? " style=\"width:250px;background-color:#F5F5F5\"" : " style=\"width:250px;background-color:#ffff99\"";?>>
      </div>																																									
      <div class="clear"></div>			
		</span>
    ...
    <label  style = "text-align:right;">Saldo JHT sdh Diambil</label>
      <input type="text" id="jhminput_nom_manfaat_sudahdiambil" name="jhminput_nom_manfaat_sudahdiambil" value="<?=number_format((float)$ln_jhminput_nom_manfaat_sudahdiambil,2,".",",");?>" maxlength="20" readonly class="disabled" style="width:250px;text-align:right;">                					
    </div>				
    <div class="form-row_kanan">
    ...
    <label  style = "text-align:right;">Pengambilan JHT ke- &nbsp;</label>
      <input type="text" id="jhminput_pengambilan_ke" name="jhminput_pengambilan_ke" value="<?=number_format((float)$ln_jhminput_pengambilan_ke,0,".",",");?>" maxlength="20" readonly class="disabled" style="width:250px;text-align:right;">                					
    </div>		
    <div class="form-row_kanan">
