...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 10;
    $url = 'pn6001_jkm_klaim_keps_aktif_lov_aktivitas.php'; // url sama dengan nama file				
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KETERANGAN"])."';".
         "window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE"])."'; ".          											
