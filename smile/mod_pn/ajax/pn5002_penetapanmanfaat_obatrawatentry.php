...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5001_validasi.php?getClientId=f_ajax_val_hitung_manfaat_obatrawat&c_kode_manfaat='+c_kode_manfaat+'&c_nom_biaya_diajukan='+c_nom_biaya_diajukan+'&c_kode_perlindungan='+c_kode_perlindungan+'&c_kode_segmen='+c_kode_segmen+'&c_kode_klaim='+c_kode_klaim+'&c_no_urut='+c_no_urut;
    ...
    <td align="left"><b><?=$gs_pagetitle;?></b> </td>						 
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
          ...
          <label style = "text-align:right;">Tgl Obat/Rawat</label>
            <input type="text" id="rawat_tgl" name="rawat_tgl" value="<?=$ld_rawat_tgl;?>" size="35" maxlength="10" tabindex="3" onblur="convert_date(rawat_tgl);" style="background-color:#ffff99;">
            <input id="btn_rawat_tgl" type="image" align="top" onclick="return showCalendar('rawat_tgl', 'dd-mm-y');" src="../../images/calendar.gif" />	   							
          </div>																																															
          <div class="clear"></div>																		
          ...
          <label  style = "text-align:right;">Total Disetujui </label>
            <input type="text" id="nom_biaya_disetujui" name="nom_biaya_disetujui" value="<?=number_format((float)$ln_nom_biaya_disetujui,2,".",",");?>" size="30" maxlength="20" style="text-align:left;" onblur="this.value=format_uang(this.value);" >				
          </div>																		
          <div class="clear"></div>																
