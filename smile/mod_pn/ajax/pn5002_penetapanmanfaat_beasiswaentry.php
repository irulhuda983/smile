...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5001_validasi.php?getClientId=f_ajax_val_hitung_manfaat_beasiswa&c_kode_klaim='+c_kode_klaim+'&c_kode_manfaat='+c_kode_manfaat+'&c_beasiswa_jenis='+c_beasiswa_jenis+'&c_beasiswa_jenjang_pendidikan='+c_beasiswa_jenjang_pendidikan+'&c_kd_prg='+c_kd_prg;
    ...
    <td align="left"><b><?=$gs_pagetitle;?></b> </td>						 
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">	
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend >Entry Rincian Manfaat Beasiswa Pendidikan</legend>
          </br>
          ...
          <div class="clear"></div>
            ...
            <label  style = "text-align:right;">Jenjang Pendidikan </label>
              <select size="1" id="beasiswa_jenjang_pendidikan" name="beasiswa_jenjang_pendidikan" value="<?=$ls_beasiswa_jenjang_pendidikan;?>" tabindex="4" class="select_format" style="width:220px;background-color:#ffff99;" onChange="f_ajax_val_beasiswa_jenjang_pendidikan();">
              ...
              ?>
  						...
  						<input type="checkbox" class="cebox" id="beasiswa_flag_masih_sekolah" name="beasiswa_flag_masih_sekolah" value="<?=$row['BEASISWA_FLAG_MASIH_SEKOLAH'];?>" onClick="fl_js_set_beasiswa_flag_masih_sekolah();" <?=$row['BEASISWA_FLAG_MASIH_SEKOLAH']=="Y" || $row['BEASISWA_FLAG_MASIH_SEKOLAH']=="ON" || $row['BEASISWA_FLAG_MASIH_SEKOLAH']=="on" ? "checked" : "";?>> Masih Sekolah          																			 								
            </div>
            <div class="clear"></div>
					</span>
