...
//if($task_no=='Faskes'){
    if($task_code=="View")
    {
        ...
        A.TELEPON_AREA_PIC,A.TELEPON_PIC,A.TELEPON_EXT_PIC,A.KELAS_PERAWATAN,A.BAGIAN_PIC
...
<form>
<fieldset><legend><b>Approval Non Aktif Faskes/ BLK</b></legend>
    <select id="statusapprove" name="statusapprove" style="width:150px;" >
        <option value="Y">Disetujui</option>
        <option value="T">Ditolak</option>              
    </select>
    <input type="button" name="btnapprove" class="btn green" id="btnapprove" value=" APPROVE ">
</fieldset>
</form>
<br />
...
$(document).ready(function(){ 
    ...
    $("#btnapprove").click(function(){
        approve_batal_nonaktif('<?=$dataid;?>',$("#statusapprove").val());
    });
});
<?php if($task_no=="IKS"){?>
var tblcolIKS = [
