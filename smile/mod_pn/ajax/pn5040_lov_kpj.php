...
<form action="<?=$PHP_SELF;?>" method="post" id="lov_inv_porto" name="lov_inv_porto">
    ...
    <table class="caption">
      ...
      }else
      {
		...
		$filtersearch = "and (a.kode_tk = '".$searchtxt."' or a.kpj = '".$searchtxt."' or a.nomor_identitas = '".$searchtxt."') ";
  		...
  		// query with paging								
      $rows_per_page = 8;
      $url = 'pn5040_lov_kpj.php'; // url sama dengan nama file				
      //The unfiltered SELECT
        ...
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
			   ...
			   // update 18062020 menambahkan kode na AS (KOREKSI KODE TK (PISAH SUFFIX)) supaya tidak dimunculkan di LOV JHT
			   "and nvl(kode_na,'XXXXX') <> 'AS' ";
      }elseif (substr($q,0,3)=="JKK")
			{
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
               "     kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
               ...
               ") x ".
               "where rank = 1 ";
      }elseif (substr($q,0,3)=="JKM") //update 04/12/2019 , menambahkan validasi utk sebab klaim SKM09 dan SKM03
			{
        $sql = "select kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
               "     kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
               "     to_char(tgl_aktif,'dd/mm/yyyy') tgl_efektif, to_char(tgl_na,'dd/mm/yyyy') tgl_expired, ".
               ...
               "from ".
               "( ".
               "    select kode_kepesertaan, no_mutasi, kode_segmen, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, kode_kantor, kode_divisi, ". 
               "        (select nama_divisi from kn.kn_divisi where kode_perusahaan = a.kode_perusahaan and kode_divisi = a.kode_divisi) nama_divisi,kode_na, ".
               "        status_valid_identitas, decode(nvl(a.status_valid_identitas,'T'),'Y','VALID','TIDAK VALID') ket_valid_identitas, status_tk, ".
               "  			(case when a.kode_segmen = 'BPU' then tgl_efektif else tgl_aktif end) tgl_aktif, ".
							 "				(case when a.kode_segmen = 'BPU' then tgl_grace else nvl(tgl_na,to_date('31/12/3000','dd/mm/yyyy')) end) tgl_na, ".
			...
			{
        $sql =  "select ". 
                "    kode_kepesertaan, no_mutasi, kode_tk, nama_tk, kpj, nomor_identitas, jenis_identitas, kode_perusahaan, npp, nama_perusahaan, ". 
                "    kode_kantor, kode_divisi, nama_divisi,status_valid_identitas, ket_valid_identitas,status_tk, ". 
    ...
    <table class="paging">
      <tr>	
        ...
        <?$othervar = $othervar."&p=".$p."&a=".$a."&b=".$b."&c=".$c."&d=".$d."&e=".$e."&f=".$f."&g=".$g."&h=".$h."&j=".$j."&k=".$k."&l=".$l."&m=".$m."&n=".$n."&q=".$q."&r=".$r."&s=".$s."&t=".$t."";?>
