      ...
      <tbody>
        ...
        <?echo "<tr bgcolor=#".($i%2 ? "ffffff" : "f3f3f3").">";?>								
          ...
          <td style="text-align:center;">
            <a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5040_agenda_jpn_ahliwarisentry.php?task=edit&kode_tk=<?=$ls_kode_tk;?>&kode_klaim=<?=$ls_kode_klaim;?>&no_urut_keluarga=<?=$row["NO_URUT_KELUARGA"];?>&root_sender=pn5040.php&sender=pn5040.php&sender_activetab=2&sender_mid=<?=$mid;?>','Ubah Data Keluarga',880,620,'no');"><img src="../../images/app_form_edit.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Ubah/Hapus</a>
          </td>
        </tr>
        <?
        //hitung total									    							
