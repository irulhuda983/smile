...
$ls_root_form = "pn5043.php";
$ls_current_form = "pn5043_pembayaran.php";

/*--------------------- Form History -------------------------------------------
File: pn5004_pembayaran.php
...
{
 	$gs_pagetitle = "PN5004 - PEMBAYARAN KLAIM JAMINAN KEMATIAN (JKM)";  	  	 
}else if ($ls_jenis_klaim=="JPN")
{
 	$gs_pagetitle = "PN5004 - PEMBAYARAN KLAIM JAMINAN PENSIUN (JP)";  	  	 
}else if ($ls_jenis_klaim=="JKP")
{
 	$gs_pagetitle = "PN5004 - PEMBAYARAN KLAIM JAMINAN KEHILANGAN PEKERJAAN (JKP)";  	  	 
}

// ------------- end KLAIM PROFILE ---------------------------------------------

include "../ajax/pn5043_js.php";
include "../ajax/pn5043_actionbutton.php";
...
<div id="formframe">
    ...
    if ($ls_jenis_klaim=="JHT")
    {
     	include "../ajax/pn5043_pembayaran_jht.php";	  	 
    }else if ($ls_jenis_klaim=="JHM")
    {
     	include "../ajax/pn5043_pembayaran_jhm.php";  	  	 
    }else if ($ls_jenis_klaim=="JKK")
    {
     	include "../ajax/pn5043_pembayaran_jkk.php";		  	 
    }else if ($ls_jenis_klaim=="JKM")
    {
     	include "../ajax/pn5043_pembayaran_jkm.php";  	  	 
    }else if ($ls_jenis_klaim=="JPN")
    {
     	include "../ajax/pn5043_pembayaran_jpn.php";  	 
    }else if ($ls_jenis_klaim=="JKP")
    {
     	include "../ajax/pn5043_pembayaran_jkp.php";  	 
    }
		?>
