<?php
$pagetype = "form";
$gs_pagetitle = "Setup - Kode Jenis Faskes";
...
<?php /*****ACTION MENU******************************************/  
require_once("pn1027_action_menu.php");  
      /*****end ACTION MENU**************************************/ ?>
<?php /*****TASK CONTENT*****************************************/ 
if($task_code == "New")
{		
    require_once("pn5031_form.php");	 										 			
}else if($task_code == "View")
{      
    require_once("pn5031_form.php");                                            
}else if($task_code == "Daftar")
{      
    require_once("pn5031_form.php");                                            
} else
{
  require_once("pn1027_view.php");
}	   
      /*****end TASK CONTENT*************************************/ ?>
<?php
