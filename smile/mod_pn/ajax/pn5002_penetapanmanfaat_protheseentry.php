...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5001_validasi.php?getClientId=f_ajax_val_kode_manfaat_detil&c_kode_manfaat='+c_kode_manfaat+'&c_kode_manfaat_detil='+c_kode_manfaat_detil;
    ...
    {		 	
			...
			if ((c_alatbantu_jml_item!=curr_alatbantu_jml_item) || (c_nom_biaya_diajukan!=curr_nom_biaya_diajukan))
			{ 
        ajax.requestFile = '../ajax/pn5001_validasi.php?getClientId=f_ajax_val_hitung_manfaat_prothese&c_kode_manfaat='+c_kode_manfaat+'&c_kode_manfaat_detil='+c_kode_manfaat_detil+'&c_alatbantu_jml_item='+c_alatbantu_jml_item+'&c_nom_biaya_diajukan='+c_nom_biaya_diajukan+'&c_kode_perlindungan='+c_kode_perlindungan+'&c_kode_segmen='+c_kode_segmen;
        ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
        ajax.runAJAX();	// Execute AJAX function
        curr_kode_manfaat_detil = c_kode_manfaat_detil;
    ...
    <td align="left"><b><?=$gs_pagetitle;?></b> </td>						 
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend >Entry Rincian Manfaat Biaya Prothese/Orthese</legend>
          </br>
