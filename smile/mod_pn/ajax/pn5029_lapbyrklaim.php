...
function f_ajax_val_kode_kantor()
{
  ...
  if (c_kode_kantor!="" && c_kode_kantor != curr_kode_kantor){	
  	...
  	ajax.requestFile = '../ajax/pn5029_lapbyrklaim_ajax.php?getClientId=f_ajax_val_kode_kantor&c_kode_kantor='+c_kode_kantor+'&c_kd_prg='+c_kd_prg;
...
function f_ajax_val_kd_prg()
{
  ...
  if (c_kd_prg != curr_kd_prg){		
  	document.getElementById('kode_buku').options.length = 0;
		ajax.requestFile = '../ajax/pn5029_lapbyrklaim_ajax.php?getClientId=f_ajax_val_kd_prg&c_kode_kantor='+c_kode_kantor+'&c_kd_prg='+c_kd_prg;
  	ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
  	ajax.runAJAX();	// Execute AJAX function
...
<table class="captionform">
	<tr>
		<td><b><?=$actiontext;?> <?=$gs_pagetitle;?> <?=$ls_subtitle;?> </b></td>
    </tr>
</table>
<?	
//Nilai Default --------------------------------------------------------------
  ...
  <input type="hidden" id="st_errval3" name="st_errval3">	
	...
	<div id="formKiri">
		<fieldset><legend>Parameter Laporan</legend>														
			...
			<label>Kantor *</label>
				<select size="1" id="kode_kantor" name="kode_kantor" value="<?=$ls_kode_kantor;?>" tabindex="1" class="select_format" onchange="f_ajax_val_kd_prg();">
			...
			<div class="form-row_kiri">
			<label>Program</label>
				<select size="1" id="kd_prg" name="kd_prg" value="<?=$ls_kd_prg;?>" tabindex="2" class="select_format" style="width:235px" onchange="f_ajax_val_kd_prg();">
  		...
  		<label>Jenis Laporan</label>
  				<select size="1" id="jenis_laporan" name="jenis_laporan" class="select_format" tabindex="3">
						<? 
        ...
        <select size="1" id="metode_byr" name="metode_byr" value="<?=$ls_metode_byr;?>" class="select_format" tabindex="4">
      ...
      <label>Kode Buku</label>
        <select size="1" id="kode_buku" name="kode_buku" value="<?=$ls_kode_buku;?>" tabindex="5" class="select_format">
        <option value="">-- Pilih --</option>
        <? 
      ...
      <div class="clear"></div>			
          ...
          <label>Tgl Transaksi</label>
					<input type="text" name="tgl1" id="tgl1" size="12" onblur="convert_date(tgl1);"  value="<?=$ld_tgl1;?>" tabindex="6"> 
					<input id="btn_tgl1" type="image" align="top" onclick="return showCalendar('tgl1', 'dd-mm-y');" src="../../images/calendar.gif" />
					&nbsp; s/d &nbsp;
					<input type="text" name="tgl2" id="tgl2" onblur="convert_date(tgl2);" size="12" value="<?=$ld_tgl2;?>" tabindex="5">
					<input id="btn_tgl2" type="image" align="top" onclick="return showCalendar('tgl2', 'dd-mm-y');" src="../../images/calendar.gif" />
		  </div> 			
    	<div class="clear"></div>	

			<div class="form-row_kiri">	
          <label>Posisi Per Tgl</label>
					<input type="text" name="tgllap" id="tgllap" size="12" onblur="convert_date(tgllap);"  value="<?=$ld_tgllap;?>" tabindex="7"> 
