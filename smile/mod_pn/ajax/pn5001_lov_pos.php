...
$pilihsearch2 = $_POST['pilihsearch2'];
$searchtxt 	 = $_POST['searchtxt'];	
$searchtxt2 	 = $_POST['searchtxt2'];	
...
if ($a=="")
{
  ...
  $pilihsearch2 = $_GET['pilihsearch2'];
  $searchtxt 	 = $_GET['searchtxt'];	
  $searchtxt2 	 = $_GET['searchtxt2'];	
}

var_dump($pilihsearch);
...
<script type="text/javascript">
  function pilihsearch2_change(){
    var e = document.getElementById("pilihsearch2");
    var val = e.options[e.selectedIndex].value;
    if (val && val != 'sc_all'){
      document.getElementById("searchtxt2").style.display = "block";
    } else {
      document.getElementById("searchtxt2").style.display = "none";
    }
  }
</script>
</head>
...
<![endif]-->
    <table class="caption">
      <tr> 
        <td align="right" style="width: 100%;">Search By &nbsp
        <select name="pilihsearch">
          ...
          <select id="pilihsearch2" name="pilihsearch2" onchange="pilihsearch2_change()">
            <? 
            switch($pilihsearch2)
            {
          		case 'sc_nama_kelurahan' : $sel1b="selected"; break;
							case 'sc_nama_kecamatan' : $sel2b="selected"; break;
							case 'sc_nama_kabupaten' : $sel3b="selected"; break;
              case 'sc_nama_propinsi' : $sel4b="selected"; break; 		
              case 'sc_kode_pos' : $sel5b="selected"; break; 		
            }
            ?>
        		<option value="sc_all">--Lainnya--</option>
        		<option value="sc_nama_kelurahan" <?=$sel1b;?>>Nama Kelurahan</option>
						<option value="sc_nama_kecamatan" <?=$sel2b;?>>Nama Kecamatan</option>
						<option value="sc_nama_kabupaten" <?=$sel3b;?>>Nama Kabupaten</option>
						<option value="sc_nama_propinsi" <?=$sel4b;?>>Nama Propinsi</option>     
            <option value="sc_kode_pos" <?=$sel5b;?>>Kode Pos</option>     
          </select>
          <input type="text" id="searchtxt2" name="searchtxt2" value="<?=$searchtxt2;?>" size="15" style="background-color: #ccffff; <?=$pilihsearch2 == "sc_all" || $pilihsearch2 == "" ? "display:none": ""?>">
    ...
    if(isset($searchtxt))
      ...
      {
       $filtersearch = "and upper(a.kode_pos) like '%".$searchtxt."%' ";
      }
      else
      {
       $filtersearch = "and (upper(a.kode_pos) like '%".$searchtxt."%' or upper(a.nama_kelurahan) like '%".$searchtxt."%' or upper(b.nama_kecamatan) like '%".$searchtxt."%' or upper(c.nama_kabupaten) like '%".$searchtxt."%' or upper(d.nama_propinsi) like '%".$searchtxt."%') ";
      }
    }		
    
    if(isset($searchtxt2))
		{
      $searchtxt2    = strtoupper($searchtxt2);
      if ($pilihsearch2=="sc_nama_kelurahan")
      {
       $filtersearch2 = "and upper(a.nama_kelurahan) like '%".$searchtxt2."%' ";
      }
      elseif ($pilihsearch2=="sc_nama_kecamatan")
      {
       $filtersearch2 = "and upper(b.nama_kecamatan) like '%".$searchtxt2."%' ";
      }	
      elseif ($pilihsearch2=="sc_nama_kabupaten")
      {
       $filtersearch2 = "and upper(c.nama_kabupaten) like '%".$searchtxt2."%' ";
      }							
      elseif ($pilihsearch2=="sc_nama_propinsi")
      {
       $filtersearch2 = "and upper(d.nama_propinsi) like '%".$searchtxt2."%' ";
      }
      elseif ($pilihsearch2=="sc_kode_pos")
      {
       $filtersearch2 = "and upper(a.kode_pos) like '%".$searchtxt2."%' ";
      }
      else
      {
       $filtersearch2 = "and (upper(a.kode_pos) like '%".$searchtxt2."%' or upper(a.nama_kelurahan) like '%".$searchtxt2."%' or upper(b.nama_kecamatan) like '%".$searchtxt2."%' or upper(c.nama_kabupaten) like '%".$searchtxt2."%' or upper(d.nama_propinsi) like '%".$searchtxt."%') ";
      }
    }		
    
    $filtersearch = $filtersearch . ' ' . $filtersearch2;

    // query with paging								
    $rows_per_page = 10;
    $url = 'pn5001_lov_pos.php'; // url sama dengan nama file				
    ...
    ?>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
        ...
        "window.close();\" >".$row["KODE_KELURAHAN"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_KELURAHAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KECAMATAN"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnamek.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_POS"])."'; ".         											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_KELURAHAN"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_KELURAHAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KECAMATAN"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnamek.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_POS"])."'; ".         											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_KECAMATAN"]."</a>";?></td>	
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_KELURAHAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KECAMATAN"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnamek.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_POS"])."'; ".         											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_KABUPATEN"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_KELURAHAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KECAMATAN"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnamek.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_POS"])."'; ".         											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["NAMA_PROPINSI"]."</a>";?></td>
      <td>
        <?="<a href=\"#\" onclick=\"javascript:window.opener.document.".$formname.".".$fieldnameb.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KELURAHAN"])."';".
				"window.opener.document.".$formname.".".$fieldnamec.".value='".ExtendedFunction::ereg_replace("'","\'",$row["NAMA_KELURAHAN"])."'; ".
				"window.opener.document.".$formname.".".$fieldnamed.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_KECAMATAN"])."'; ".
				...
				"window.opener.document.".$formname.".".$fieldnamek.".value='".ExtendedFunction::ereg_replace("'","\'",$row["KODE_POS"])."'; ".         											
        "window.opener.document.getElementById('".$fieldnameb."').focus(); ".
        "window.close();\" >".$row["KODE_POS"]."</a>";?></td>																																																								
      </tr>
    <? 
    $i++; $nx++;
    }
