...
$pagetitle = "SIJSTK";
$gs_pagetitle = "PN5001 - UPDATE DATA TENAGA KERJA";
...
<body>
	...
	{     
        ...
        $ln_no_urut_keluarga = $row["V_NO"];
               ...
               "    '$ls_tempat_lahir', to_date('$ld_tgl_lahir','dd/mm/yyyy'), '$ls_jenis_kelamin', '$ls_golongan_darah','$ls_status_kawin', '$ls_alamat', '$ls_rt', '$ls_rw', '$ls_kode_kelurahan', '$ls_kode_kecamatan', ". 
               "    '$ls_kode_kabupaten', '$ls_kode_pos', '$ls_telepon_area', '$ls_telepon', '$ls_telepon_ext', '$ls_handphone', '$ls_email', ".
							 "		'$ls_npwp', '$ls_kpj_tertanggung', '$ls_keterangan', ".
							 "		sysdate, '$username' ". 
							 ") ";
        $DB->parse($sql);
        $DB->execute();						
