...
$gs_pagetitle = "PP0206 - PENETAPAN ULANG JP KURANG BAYAR KARENA PERBEDAAN TINGKAT HASIL PENGEMBANGAN";
?> 
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <script language="JavaScript">
            function fl_js_set_st_surat_keterangan_jpn()
            {
                var form = document.adminForm;
                if (form.st_surat_keterangan_jpn.checked)
                {
                    form.st_surat_keterangan_jpn.value = "Y";
                } else
                {
                    form.st_surat_keterangan_jpn.value = "T";
                }
            }
        </script>									
    </head>
    <body>
        ...
        <div id="container-popup">
            ...
            <form name="adminForm" id="adminForm" method="post" >
                ...
                $ls_st_surat_penetapan_koreksi_jpn	= !isset($_GET['st_surat_keterangan_jpn']) ? $_POST['st_surat_keterangan_jpn'] : $_GET['st_surat_keterangan_jpn'];

                if ($ls_st_surat_penetapan_koreksi_jpn=="on" || $ls_st_surat_penetapan_koreksi_jpn=="ON" || $ls_st_surat_penetapan_koreksi_jpn=="Y")
                {
					$ls_st_surat_penetapan_koreksi_jpn = "Y";
                }else
                {
					$ls_st_surat_penetapan_koreksi_jpn = "T";
                }	
		
				if(isset($_POST["butcetak_all"]))
				{
					if ($ls_st_surat_penetapan_koreksi_jpn !="T")
					{
                                        ...
                                        <fieldset style=""><legend style="text-align:left">Parameter</legend>
                                            ...
                                            <br>
                                                ...
                                                <div class="form-row_kiri">
                                                    ...
                                                    <?$ls_st_surat_penetapan_koreksi_jpn = isset($ls_st_surat_penetapan_koreksi_jpn) ? $ls_st_surat_penetapan_koreksi_jpn : "Y";							
                                                    ?>					
                                                    <input type="checkbox" id="st_surat_keterangan_jpn" name="st_surat_keterangan_jpn" class="cebox" onclick="fl_js_set_st_surat_keterangan_jpn();" <?= $ls_st_surat_penetapan_koreksi_jpn == "Y" || $ls_st_surat_penetapan_koreksi_jpn == "ON" || $ls_st_surat_penetapan_koreksi_jpn == "on" ? "checked" : ""; ?>>
                                                        <i><font  color="#009999">Surat Penetapan Ulang JP Kurang Bayar Karena Perbedaan Tingkat Hasil Pengembangan</font></i>	
                                                </div>											
                                                <div class="clear"></div>								
                                        </fieldset>
                                        <br>
