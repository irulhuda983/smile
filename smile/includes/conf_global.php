<?php
  ...
  class ConfigGlobal {
    ...
    // includes/balau.php
    public $REPORT_SERVER_IP = "http://172.28.108.151:9002";
    public $REPORT_SERVER_IP_DRC = "http://172.28.108.151:9002";
    ...
    public $HOST_IP = "http://172.28.108.49:5267"; /*rubah dengan domain smile untuk prod*/

    // includes/conf_global.php
    // SKIP

    // includes/connsql.php
    public $HOST_PATH = "http://172.28.108.49:5267/smile"; /*rubah dengan domain smile untuk prod*/
    public $HOST_PATH_CORE = "http://172.28.108.49:5267/smile"; /*rubah dengan domain smile untuk prod*/
    ...
    public $REPORT_SERVER_HOST_PATH = "http://172.28.108.49:5267/smile/includes/rptBPJS.php?url="; /*rubah dengan domain smile untuk prod*/
    ...
    public $REPORT_SERVER_HOST_DPKP_PATH = "http://172.28.108.49:5267/smile/dpkppkblonline/dpkp/includes/rptBPJS.php?url="; /*prod ganti dengan domain*/
  ...
  $CONFIG_GLOBAL["REPORTCLEARANCE"] = "http://172.28.108.151:9002";
  ...
  $CONFIG_GLOBAL["LOCALHOST"] = "http://172.28.108.49:5267"; /*rubah dengan domain unutk PROD*/
  ...
  $CONFIG_GLOBAL["RPT_PIUTANG"] = "http://172.28.108.151:9002";
  ...
  $CONFIG_GLOBAL["WS_IPSTORAGE"] = "http://api-ceph-ceph-dev.apps.ocp-drc.bpjsketenagakerjaan.go.id";
  $CONFIG_GLOBAL["WS_VOKASI"] = "";
  $CONFIG_GLOBAL["IP_APPS70"] = "http://172.28.108.151:9002";
  ...
  $CONFIG_GLOBAL["WS_CEPHSTORAGE"] = "http://api-ceph-ceph-dev.apps.ocp-drc.bpjsketenagakerjaan.go.id";
  $CONFIG_GLOBAL["WS_REPORT_EC"] = "http://172.28.108.151:9002";
  $CONFIG_GLOBAL["LOCALHOST_PLAIN"] = "http://localhost";
  $CONFIG_GLOBAL["IP_APPS60"] = "http://172.28.108.49:5267";
  $CONFIG_GLOBAL["IP_APPS62"] = "http://172.28.108.49:5267";
...
$wsIpStorage = 'http://api-ceph-ceph-dev.apps.ocp-drc.bpjsketenagakerjaan.go.id';
$wsIpDocument = 'http://api-ceph-ceph-dev.apps.ocp-drc.bpjsketenagakerjaan.go.id';
// $wsIp = 'http://172.28.200.83:2014';
...
$wsEproc='http://172.28.108.251:2200';
...
$ipReportServerDocument='http://172.28.108.151:9002';
...
/*Report DRC*/
$ipReportServerDRC='http://172.28.108.151:9002';
