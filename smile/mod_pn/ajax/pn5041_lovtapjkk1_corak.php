...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 15;
    $url = 'pn5041_lovtapjkk1_corak.php'; // url sama dengan nama file				
    //The unfiltered SELECT
    $sql = "select kode, keterangan from sijstk.ms_lookup a where tipe='KLMCORAK' and nvl(aktif,'T')='Y' ".
    			 $filtersearch.
           "order by seq ";
    //echo $sql;
