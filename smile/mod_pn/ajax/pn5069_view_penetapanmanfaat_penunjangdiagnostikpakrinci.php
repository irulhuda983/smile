<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat penunjang diagnostik pak
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset ><legend>Rincian Manfaat</legend>
            ...
            <label  style = "text-align:right;">Jenis Pelayanan </label>
              <input type="text" id="rehab_jenis_pelayanan" name="rehab_jenis_pelayanan" readonly class="disabled" style="width:270px;"> 				
            </div>																		
            <div class="clear"></div>
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#rehab_jenis_pelayanan').val(getValue(jdata.data.DATA['REHAB_JENIS_PELAYANAN']));
