...
//oracle paging
function f_draw_pager($url = '', $total_pages = 10, $current_page = 1,$othervar = '') {
...
define("WSCOM", $CONFIG->WS_COM_PATH);

// define("WSCOM", "http://172.28.108.201:2024/WSCom/services/Main?wsdl");
...
function toNumberDouble($anyvar){
	return is_double($anyvar)?doubleval($anyvar):doubleval($anyvar);
}
