...
<script language="javascript">
  ...
  function addRowInnerHTML2(tblId)
  {
    ...
    newCell2.innerHTML = '<input type="text" id='+'d_realdtl_nama_tk'+iteration+' name='+'d_realdtl_nama_tk'+iteration+' readonly class=\'disabled\' size="15">&nbsp;<a href="#" onclick="fl_js_val_d_realdtl_kodetk('+iteration+');"><img src="../../images/help.png" alt="Cari Data TK" border="0" align="absmiddle"></a><input type="hidden" id='+'d_realdtl_kode_tk'+iteration+' name='+'d_realdtl_kode_tk'+iteration+'><input type="hidden" id='+'d_realdtl_kpj'+iteration+' name='+'d_realdtl_kpj'+iteration+'><input type="hidden" id='+'d_realdtl_nama_jenis_barang'+iteration+' name='+'d_realdtl_nama_jenis_barang'+iteration+'><input type="hidden" id='+'d_realdtl_kode_jenis_barang'+iteration+' name='+'d_realdtl_kode_jenis_barang'+iteration+'><input type="hidden" id='+'d_realdtl_nama_barang'+iteration+' name='+'d_realdtl_nama_barang'+iteration+'><input type="hidden" id='+'d_realdtl_jml_paket_barang'+iteration+' name='+'d_realdtl_jml_paket_barang'+iteration+'><input type="hidden" id='+'d_realdtl_harga_perpaket_barang'+iteration+' name='+'d_realdtl_harga_perpaket_barang'+iteration+'>';		
		newCell3.innerHTML = '<input type="text" id='+'d_realdtl_nom_pokok'+iteration+' name='+'d_realdtl_nom_pokok'+iteration+' size="12" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_d_realdtl_hitung_nom_diajukan('+iteration+');"><input type="hidden" id='+'d_realdtl_nom_ppn'+iteration+' name='+'d_realdtl_nom_ppn'+iteration+' size="10" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);fl_js_d_realdtl_hitung_nom_diajukan('+iteration+');">';
		newCell4.innerHTML = '<input type="text" readonly class=disabled id='+'d_realdtl_nom_diajukan'+iteration+' name='+'d_realdtl_nom_diajukan'+iteration+' size="12" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);">';
    newCell5.innerHTML = '<input type="text" id='+'d_realdtl_keterangan'+iteration+' name='+'d_realdtl_keterangan'+iteration+' size="10" maxlength="300" style="border-width: 1;text-align:left">'; 
          ...
          ?>											
            ...
            <td>
              ...
              <input type="hidden" id="d_realdtl_kpj<?=$i;?>" name="d_realdtl_kpj<?=$i;?>" value="<?=$row['KPJ'];?>">
            	...
            	<input type="hidden" id="d_realdtl_nom_ppn<?=$i;?>" name="d_realdtl_nom_ppn<?=$i;?>" size="10" maxlength="20" value="<?=number_format((float)$row['NOM_PPN'],2,".",",");?>" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value); fl_js_d_realdtl_hitung_nom_diajukan(<?=$i;?>);">
            </td>											
            <td>
