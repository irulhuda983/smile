...
<head>
  ...
  // 25-04-2024 Penambahan validasi sebelum cari data
    function validateForm()
    {
      var nik = document.getElementById('search_nomor_identitas').value;
      var tgl_lahir = document.getElementById('search_tgl_lahir').value;
      if (nik == "" || tgl_lahir == "") {
        alert("Silakan menginput NIK dan Tanggal Lahir Untuk Pencairan Data TK Kartu Lainnya");
        return false;
      }
      return true;
    }
...
<body>
    ...
    {		 	           												 		        					      
      ...
      if ($ls_d_jp_kode_tk!="" && $ls_d_status_valid == "Y")
      {
               ...
               "values ( ".
               "    :p_kode_klaim, :p_d_jp_kode_tk, :p_d_jp_kpj,:p_d_jp_nik, :p_d_jp_nama_tk, :p_d_jp_tempat_lahir, ". 
               "    to_date(:p_d_jp_tgl_lahir,'dd/mm/yyyy'), null, sysdate, :p_username ". 
							 ") ";
        $proc = $DB->parse($sql);
        $param_bv = array(
          ':p_kode_klaim' => $ls_kode_klaim,
          ':p_d_jp_kode_tk' => $ls_d_jp_kode_tk,
          ':p_d_jp_kpj' => $ls_d_jp_kpj,
          ':p_d_jp_nik' => $ls_d_jp_nik,
          ':p_d_jp_nama_tk' => $ls_d_jp_nama_tk,
          ':p_d_jp_tempat_lahir' => $ls_d_jp_tempat_lahir,
          ':p_d_jp_tgl_lahir' => $ld_d_jp_tgl_lahir,
          ':p_username' => $username,
        );
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>" onsubmit="return validateForm(this)">							
            ...
            <tr>
              ...
              {	
                ...
                if ($ls_search_nomor_identitas!="")
								{
								 	 $ls_filter_nomor_identitas = " and a.nomor_identitas = :P_SEARCH_NOMOR_IDENTITAS "; 	
                   $param_bv[':P_SEARCH_NOMOR_IDENTITAS'] = $ls_search_nomor_identitas; 
								}
                ...
                if ($ls_search_kpj!="")
								{
								 	 $ls_filter_kpj = " and a.kpj = :P_SEARCH_KPJ ";
                   $param_bv[':P_SEARCH_KPJ'] = $ls_search_kpj;
								}
																
                if ($ld_search_tgl_lahir!="")
								{
								 	 $ls_filter_tgl_lahir = " and to_char(a.tgl_lahir,'yyyymmdd') = to_char(to_date(:P_SEARCH_TGL_LAHIR,'dd/mm/yyyy'),'yyyymmdd') "; 	 
                   $param_bv[':P_SEARCH_TGL_LAHIR'] = $ld_search_tgl_lahir;
								}
																																
								$sql = "select b.* from (select  kode_tk, 
                                kpj, 
                                nomor_identitas, 
                                nama_tk, 
                                tempat_lahir, 
                       ...
                       ") ".
											 "and not exists( ".
											 " select null from sijstk.pn_klaim_tkgabung where kode_klaim = :P_KODE_KLAIM and kode_tk = a.kode_tk ".
											 ") ) b group by b.kode_tk, b.kpj, b.nomor_identitas, b.nama_tk, b.tempat_lahir, b.tgl_lahir, b.cek_iur_jp";  
