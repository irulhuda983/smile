...
<div id="formKiri" style="width:800px;">
	<fieldset><legend><b><i><font color="#009999">Entry Antrian Kelayakan Klaim JHT 30%</font></i></b></legend>	
...
<div id="formKanan">	
    ...
    <div class="form-row_kiri">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button id="btn_camera" name="btn_camera" onclick="openNewWindow(event);" <?=($_REQUEST["task"] == "View" || $_REQUEST["task"] == "Edit")? "disabled" : "";?>>Camera</button>
                    ...
                    if (jdata.ret == '0') {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                "kode_jenis_antrian_detil"  : "SA01CKJ01"
                            },
