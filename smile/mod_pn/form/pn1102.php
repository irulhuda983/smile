<?php
$pagetype = "form";
$gs_pagetitle = "Setup - JKK/RTW";
require_once "../../includes/header_app_nosql.php";	
$mid = $_REQUEST["mid"]; 
$php_file_name="pn1102";
//$gs_kode_segmen = "PU";
/* ============================================================================
...
$task_no=isset($_REQUEST['taskno'])?$_REQUEST['taskno']:'APenAwal';
$tab_title = array(
    "APenAwal"=>"Asessment Penilaian Awal",
    "APenLink" => "Asessment Penilaian Linkungan Kerja",
    "ApenTempat" => "Asessment Penilaian Penempatan Kerja",
    "TempatKerja" => "Penempatan Kerja",
    "TipeEvaluasi" => "Tipe Evaluasi",
