...
$ls_jenis_dokumen 	= !isset($_GET['jenis_dokumen']) ? $_POST['jenis_dokumen'] : $_GET['jenis_dokumen'];
          ...
          $ls_file_path_url= $result->path;
            ...
            $sql = "INSERT INTO SMILE.PN_PENERIMA_BEASISWA_DOK ( ".
                   ...
                   "    TGL_REKAM, PETUGAS_REKAM ".
									 ")  ".
                   "VALUES (  ".
  								 "    '$ls_nik_penerima', '$ln_no_urut_dokumen', '',  ".
                   "    '$ls_nama_dokumen', '$ls_jenis_dokumen', '$ls_file_path_url',  ".
...
<?php
    ...
    $isi_teks = 'PENERIMABEASISWA'.'#'.$nik_penerima.'#'.$no_urut;
    $namafile = 'PENERIMABEASISWA'.$nik_penerima.'_'.$no_urut.".png";
...
<form name="fpop" method="post" action="pn5073_uploaddok.php" enctype="multipart/form-data">
    <!-- LOCAL JAVASCRIPTS -->	
                        ...
                        <td>
                            ...
                            <div class="form-row_kiri">
                                ...
                                <input type="hidden" id="nama_dokumen" name="nama_dokumen" value="<?=$ls_nama_dokumen;?>">
																...
																<input type="hidden" id="jenis_dokumen" name="jenis_dokumen" value="<?=$ls_jenis_dokumen;?>">
