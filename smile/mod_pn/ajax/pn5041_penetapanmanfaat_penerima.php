...
if ($ls_kode_klaim!="")
{
  ...
  $ls_mess = $p_mess;	
    ...
    if ($ls_status_rekening_sentral=="Y")
    {
      ...
      echo "window.location.replace('../ajax/pn5041_penetapanmanfaat_penerimasentralisasi.php?mid=$mid&task=Edit&kode_klaim=$ls_kode_klaim&kode_tipe_penerima=$ls_kode_tipe_penerima&root_sender=$ls_root_sender&sender=$ls_sender&sender_activetab=$ls_sender_activetab&sender_mid=$ls_sender_mid');";
      echo "</script>";	 		
    }
	}else
	{
  ...
  <script language="JavaScript">    
    ...
    function fl_js_val_npwp(v_field_id)
    {
      ...
      if(form.kode_tipe_penerima.value==""){
        ...
        form.nama_bank_penerima.focus();
			}else if (form.status_valid_rekening_penerima.value!="Y" && form.kode_tipe_penerima.value!="BH"){
    ...
    { 		
      var v_jenis_identitas = window.document.getElementById('jenis_identitas').value;
			...
			var	v_nomor_identitas_old = window.document.getElementById('nomor_identitas_old').value;
			if (v_nomor_identitas_old=='')
			{
			 	v_nomor_identitas_old = 'X'; 
			}
			curr_nomor_identitas = v_nomor_identitas_old;
			
			//update 18/04/2021, beasiswa pp82, validasi hanya jika ada perubahan inputan nik
    				 ...
    				 if (v_nomor_identitas.length!=16)
  					 {
    					 alert("Untuk KTP, Nomor Identitas harus 16 karakter...!!!"); 
  						 window.document.getElementById('nomor_identitas').value = '';
							 window.document.getElementById('nomor_identitas_old').value = '';				 
  					 ...
  					 {
        			if (v_nomor_identitas_old!=v_nomor_identitas)
        			{		
            		cekValidasiAdminduk();
								window.document.getElementById('nomor_identitas_old').value = v_nomor_identitas;
								curr_nomor_identitas = v_nomor_identitas;
        			}	
  					 }
  				 }
      }		
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
          ...
          <tr><th></th></tr>
					<tr>
      				...
      				<fieldset style="height:420px;"><legend ><b><i><span style="color:#009999;">Detil Informasi Penerima Manfaat</span></i></b></legend>
      					</br>
              			...
              			<input type="text" id="nomor_identitas" name="nomor_identitas" value="<?=$ls_nomor_identitas;?>" maxlength="16" tabindex="3" style="background-color:#ffff99;width:160px;" onblur="fl_js_val_nomor_identitas();">
            				...
            				<input type="checkbox" id="cb_status_valid_identitas" name="cb_status_valid_identitas" disabled class="cebox" <?=$ls_status_valid_identitas=="Y" ||$ls_status_valid_identitas=="ON" ||$ls_status_valid_identitas=="on" ? "checked" : "";?>><i>Valid</i>
      							...
      							<input type="hidden" id="jenis_kelamin" name="jenis_kelamin" value="<?=$ls_jenis_kelamin;?>" maxlength="10">	
										...
										<input type="hidden" id="nomor_identitas_old" name="nomor_identitas_old" value="<?=$ls_nomor_identitas;?>">
                  </div>																																									
                	<div class="clear"></div>
      					</span>
                ...
                <tr><th></th></tr>
                      ...
                      <?
								...
								<tr>
									<td>
										<fieldset style="height:245px;"><legend ><b><i><span style="color:#009999;">Rekening Pembayaran</span></i></b></legend>																					
                      </br>
											<div class="form-row_kiri">
                      <label style = "text-align:right;"><i><span style="color:#009999;">Ditransfer ke :</span></i></label>
                      ...
                      <label style = "text-align:right;">No Rekening *</label>
											 <input type="text" id="no_rekening_penerima" name="no_rekening_penerima" onblur="cekValidasiRekening();" value="<?=$ls_no_rekening_penerima;?>" tabindex="22" maxlength="30" style="width:100px;background-color:#ffff99;">
												...
												<input type="checkbox" id="cb_valid_rekening" name="cb_valid_rekening" class="cebox" onclick="copyNamaRekeningPenerima()" <?=$ls_status_valid_rekening_penerima=="Y" ||$ls_status_valid_rekening_penerima=="ON" ||$ls_status_valid_rekening_penerima=="on" ? "checked" : "";?>><i><span style="color:#009999;">Valid</span></i>	
                      </div>																																																																																															
                      <div class="clear"></div>
                      ...
                      <label style = "text-align:right;">&nbsp;</label>	 	    				
                        <i><span style="color:#009999;">Note : Tickmark Valid jika NO REKENING sudah sesuai. </span></i>
                      ...
                      <div class="form-row_kiri">
                      <label style = "text-align:right;"><i><span style="color:#009999;">Dibayar Melalui :</span></i></label>
            						<input type="text" id="temp3" name="temp3" size="25" style="border-width: 0;text-align:left" readonly>	    				
                      </div>																																																																																															
                      <div class="clear"></div>
                      ...
                      <label style = "text-align:right;">&nbsp;</label>	 	    				
                        <input type="hidden" id="status_rekening_sentral" name="status_rekening_sentral" value="<?=$ls_status_rekening_sentral;?>">
                				...
                				<input type="checkbox" id="cb_status_rekening_sentral" name="cb_status_rekening_sentral" disabled class="cebox" <?=$ls_status_rekening_sentral=="Y" ||$ls_status_rekening_sentral=="ON" ||$ls_status_rekening_sentral=="on" ? "checked" : "";?>><i><span style="color:#009999;">Sentralisasi Rekening</span></i>
        ...
        ?>
          <fieldset>
          <?=$ls_error==1 ? "<font color=#ff0000>Error</font></legend>" : "<legend><font color=#007bb7>Message</font></legend>";?>
...
<script type="text/javascript">
    ...
    function cekValidasiAdminduk(){
        var vNik = $('#nomor_identitas').val();
				var vNik_old = $('#nomor_identitas_old').val();
				if (vNik_old == '')
				{
				 	vNik_old = 'X'; 
				}
                ...
                preload(false);
                  ...
                  $('#tk_foto').attr('src','../../images/nopic.png');
  								$('#nomor_identitas_old').val(vNik);
									...
									//curr_nomor_identitas = '';
  								curr_nomor_identitas = vNik;//tidak valid maka bisa diinput manual
