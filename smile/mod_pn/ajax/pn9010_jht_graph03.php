<?php
$pagetype = "report";
$gs_pagetitle = "Dashboard Pelayanan - Pembayaran Klaim JHT Nasional Berdasarkan Masa Kepesertaan";
...
<?
//1. grafik pembayaran klaim jht berdasarkan masa kepesertaan ------------------
//get data from WS -----------------------------------------------------------
global $wsIp;
$ipDev  = $wsIp."/JSPN9010/GetDataJHTGraph03";
$url    = $ipDev;
$chId   = 'CORE';
...
for($i=0;$i<ExtendedFunction::count($resultArray->JHT_GRAPH03);$i++)
{
  //grafik bar -----------------------------------------------------------------
	$ln_graph1_bar_val = 0;
  $ln_graph1_bar_val = $resultArray->JHT_GRAPH03[$i]->NOM_PEMBAYARAN == "" ? "0" : $resultArray->JHT_GRAPH03[$i]->NOM_PEMBAYARAN;
  $ln_graph1_bar_val_tot = $ln_graph1_bar_val_tot + (float)$ln_graph1_bar_val;
  $ls_graph1_bar_xAxisCategory1_temp .= "'".$resultArray->JHT_GRAPH03[$i]->KET_MASA_KEPESERTAAN."',";
  $ls_graph1_bar_val_temp .= $ln_graph1_bar_val.",";
	
	//grafik pie -----------------------------------------------------------------
	$ls_graph_pie_val_x1 = $resultArray->JHT_GRAPH03[$i]->KODE_MASA_KEPESERTAAN;
  $ls_graph_pie_val_x2 = $resultArray->JHT_GRAPH03[$i]->KET_MASA_KEPESERTAAN;
  $ln_graph_pie_val_x3 = $resultArray->JHT_GRAPH03[$i]->NOM_PEMBAYARAN;
  $ls_graph_pie_val_temp .= "{ name: '{$ls_graph_pie_val_x2}', y: {$ln_graph_pie_val_x3}, url: '{$ls_link_call_page2}kode_segmen={$ls_kode_segmen}&tgl={$ld_tgl}&kode_masa_kepesertaan={$ls_graph_pie_val_x1}' },";
}
	...
	<div class="content">
		<div class="container">
          ...
          <div class="row">
    				<div class="col-lg-12">
              <div class="card-box">
    						<h4 class="header-title m-t-0 m-b-30"><b>Pembayaran Klaim JHT Berdasarkan Masa Kepesertaan</b></h4>
          ...
          <div class="row">
    				<div class="col-lg-12">
              <div class="card-box">
    						<h4 class="header-title m-t-0 m-b-30"><b>Komposisi Pembayaran Klaim JHT Berdasarkan Masa Kepesertaan</b></h4> 
                <div class="widget-chart text-center">
                  ...
                  <div class="form-group m-b-20">
                    ...
                    <tr>
                      <th colspan="3" style="text-align:center">PEMBAYARAN KLAIM JHT</th>
										...
										<tr>
                      <th style="text-align:center">Masa Kepesertaan</th>
                      <th  style="text-align:center">Kasus</th>
                      <th  style="text-align:center">Dibayarkan</th>
                    </tr>
                  </thead>
									<tbody>
										<? //rincian pembayaran jht per masa kepesertaan -----------					              					
                    $i=0;		
										$ln_tot_kasus_jht  =0;
										...
										for($i=0;$i<ExtendedFunction::count($resultArray->JHT_GRAPH03);$i++)				
                    {
                      ?>
											<tr>							
                        <td style="text-align:center"><?=$resultArray->JHT_GRAPH03[$i]->KET_MASA_KEPESERTAAN;?></td>
                        <td style="text-align:right"><?=number_format((float)$resultArray->JHT_GRAPH03[$i]->JML_KASUS,0,".",",");?></td>  									
                        <td style="text-align:right;"><?=number_format((float)$resultArray->JHT_GRAPH03[$i]->NOM_PEMBAYARAN,2,".",",");?></td>						
                      </tr>
                      <?							    							
                      //$i++;//iterasi i
											$ln_tot_kasus_jht  += (float)$resultArray->JHT_GRAPH03[$i]->JML_KASUS;
											$ln_tot_pembayaran_jht += (float)$resultArray->JHT_GRAPH03[$i]->NOM_PEMBAYARAN;
                    }	//end while
