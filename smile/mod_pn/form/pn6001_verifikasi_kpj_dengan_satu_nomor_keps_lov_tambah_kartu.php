...
<body>
    ...
    <?
        ...
        // query with paging                
        $rows_per_page = 10;
        $url = 'pn6001_verifikasi_kpj_dengan_satu_nomor_keps_lov_tambah_kartu.php'; // url sama dengan nama file        
    ...
    <?
        ...
        if($ls_jml_kode_tk > 0){
            while ($row = $DB->nextrow()){
                ...
                echo "<td colspan=10 style='text-align:center'><b>--Data Tidak Ditemukan--</b></td>";
                echo "</tr>";
                $total_rows     = 0;
                $total_pages    = 0;
        }
