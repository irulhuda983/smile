...
if ($ls_kode_klaim!="")
{
  ...
  $data = array(
    ...
    'KODE_KLAIM'=>$ls_kode_klaim,
		...
		'ACT_POPUP'=>"DATA_KELAYAKAN_KLAIM"
  );
  			...
  			<div id="div_container" class="div-container">
  				...
  				<div id="div_body" class="div-body">
                    ...
                    <tr class="hr-single">
                      <th rowspan="2" style="text-align: center;">No</th>
  										...
  										<th rowspan="2" style="text-align: center;">Syarat Terpenuhi</th>
                      <th rowspan="2" style="text-align: center;">Status</th>
                      <th rowspan="2" style="text-align: center;">Pesan(Tidak Layak)</th>
  									<tr class="hr-double">
  									</tr>							
  								</thead>
  								<tbody id="data_list">
                      ...
                      if ($ls_kode_klaim != "")
                      {			
              					for($i=0;$i<ExtendedFunction::count($resultArray->DATA_KELAYAKAN_KLAIM);$i++)
              					{
                          ?>						
                          <tr>
														<td style="text-align:center"><?=$resultArray->DATA_KELAYAKAN_KLAIM[$i]->NO_URUT;?></td>
                            <td style="text-align:left"><?=$resultArray->DATA_KELAYAKAN_KLAIM[$i]->KETERANGAN;?></td>  									
              							<td style="text-align:center"><?=$resultArray->DATA_KELAYAKAN_KLAIM[$i]->STATUS_SYARAT_TERPENUHI;?></td>
              							<td style="text-align:center"><?=$resultArray->DATA_KELAYAKAN_KLAIM[$i]->STATUS_KELAYAKAN;?></td>
                            <td style="text-align:center"><?=$resultArray->DATA_KELAYAKAN_KLAIM[$i]->PESAN_TIDAKLAYAK;?></td>							
                          </tr>
                          <?							    							
                        }
                        $ln_dtl=$i;
  				...
  				<div id="div_footer" class="div-footer">
  					<div style="background: #f2f2f2;padding:10px 20px;border:1px solid #ececec;">
  						...
  						<li style="margin-left:15px;">Data yang ditampilkan adalah hasil cek kelayakan klaim.</li>
  					</div>				
  				</div>	 
  			</div>		
  		</form>	 
