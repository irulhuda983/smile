<?php
$pagetype = "form";
$gs_pagetitle = "PN5018 - ENTRI PIHAK KETIGA PELAKSANA KEGIATAN PROMOTIF/PREVENTIF";
$gs_pagetitle = "PN5018 - ENTRI PIHAK KETIGA PELAKSANA KEGIATAN PROMOTIF/PREVENTIF";
...
/* ============================================================================
Ket : Form ini digunakan sebagai form input Entri Pihak Ketiga Pelaksana Kegiatan Promotif/Preventif
...
<div id="actmenu" >
	<div id="actbutton">
		...
		?>
			...
			<div style="float:left;">
				<div class="icon">
					<a id="btn_close" href="http://<?=$HTTP_HOST;?>/mod_pn/form/pn5018.php?mid=<?=$mid;?>">
    ...
    <div id="formKiri" style="width:1000px">
		<form name="formreg" id="formreg" role="form" method="post">
			<div id="konten">
				...
				<div id="formsplit">
					<fieldset>
						<legend>Data Pihak Ketiga Pelaksana Kegiatan</legend>
						<table>
							<tr>
								<td width="50%" valign="top">
									...
									<div class="form-row_kiri">
										<label>Nama Pihak Ketiga <span style="color:#ff0000;">*</span></label>	
										<input  type="text" name="nama_pihak_ketiga" id="nama_pihak_ketiga" value="<?=$ls_nama_pihak_ketiga;?>" size="35" >
									  </div>
									<div class="clear"></div>	
									<div class="form-row_kiri">
										<label>Alamat Pihak Ketiga <span style="color:#ff0000;">*</span></label>	
										<textarea cols="255" rows="2" id="alamat_pihak_ketiga" name="alamat_pihak_ketiga" value="<?=$ls_alamat_pihak_ketiga;?>" style="width:225px;" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)">
										</textarea>
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>Email Pihak Ketiga <span style="color:#ff0000;">*</span></label>	
										<input  type="text" name="email_pihak_ketiga" id="email_pihak_ketiga" onchange="validateEmail()" value="<?=$ls_email_pihak_ketiga;?>" size="35" >
									  </div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>PIC Pihak Ketiga <span style="color:#ff0000;">*</span></label>	
										<input  type="text" name="pic_pihak_ketiga" id="pic_pihak_ketiga" value="<?=$ls_pic_pihak_ketiga;?>" size="35" >
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>No. Telepon PIC <span style="color:#ff0000;">*</span></label>	
										<input  type="text" name="no_telp_pic_pihak_ketiga" id="no_telp_pic_pihak_ketiga" value="<?=$ls_no_telp_pic_pihak_ketiga;?>" size="35" onkeypress="validateDigit(event)">
									</div>
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>Keterangan Pihak Ketiga </label>	
										<textarea cols="255" rows="2" id="keterangan_pihak_ketiga" name="keterangan_pihak_ketiga" value="<?=$ls_keterangan_pihak_ketiga;?>" style="width:225px;" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)">
										</textarea>
									</div>
									<div class="clear"></div>
							...
							<tr>
								<td width="50%" valign="top">
									...
									<div class="form-row_kiri">
										...
										<input  type="text" name="nama_pihak_ketiga" id="nama_pihak_ketiga" value="<?=$ls_nama_pihak_ketiga;?>" size="35" readonly class="disabled">
									  </div>
									<div class="clear"></div>	
									<div class="form-row_kiri">
										<label>Alamat Pihak Ketiga </label>	
										<textarea cols="255" rows="2" id="alamat_pihak_ketiga" name="alamat_pihak_ketiga" value="<?=$ls_alamat_pihak_ketiga;?>" style="width:225px;" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)" disabled>
										</textarea>
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>PIC Pihak Ketiga </label>	
										<input  type="text" name="pic_pihak_ketiga" id="pic_pihak_ketiga" value="<?=$ls_pic_pihak_ketiga;?>" size="35" readonly class="disabled">
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>No. Telepon PIC </label>	
										<input  type="text" name="no_telp_pic_pihak_ketiga" id="no_telp_pic_pihak_ketiga" value="<?=$ls_no_telp_pic_pihak_ketiga;?>" size="35" onkeypress="validateDigit(event)" readonly class="disabled">
									</div>
									</div>
									<div class="clear"></div>
									<div class="form-row_kiri">
										<label>Keterangan Pihak Ketiga </label>	
										<textarea cols="255" rows="2" id="keterangan_pihak_ketiga" name="keterangan_pihak_ketiga" value="<?=$ls_keterangan_pihak_ketiga;?>" style="width:225px;" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)" disabled>
										</textarea>
									</div>
									<div class="clear"></div>
									<!-- end  pilihan kategori pelaksana, jika pihak ketiga muncul -->
				...
				<div id="formsplit">
					<fieldset>
						<legend>Daftar Pihak Ketiga Pelaksana Kegiatan Promotif/Preventif</legend>	
						<div class="clear"></div>
					...
					<fieldset style="background: #ededed;">
						...
						<div class="form-row_kiri">
							<br>
							<input type="button" style="display:none;" class="btn green" id="btncetakdaftarentripelaksanapihakketiga" name="btncetakdaftarentripelaksanapihakketiga" tabindex="41" value="CETAK DAFTAR PELAKSANA PIHAK KETIGA" title="Klik Untuk Cetak Daftar Pelaksana Pihak Ketiga">		
						</div>
					</fieldset>
				...
				<div id="div_penambahantkpengajuan">
					<div id="formsplit">
						<fieldset style="background: #ededed;">
							<br>
							<div class="form-row_kiri">
								<input type="button" name="btnsubmitdatapihakketiga" id="btnsubmitdatapihakketiga" class="btn green"  value="SUBMIT DATA PIHAK KETIGA" title="Klik untuk submit data pihak ketiga pelaksana kegiatan">
							</div>
						</fieldset>
					<br>
					</div>
							...
							<table class="table responsive-table" id="" cellspacing="0" width="100%">
								...
								?>
									<tr>
										...
										{
											$linkhapus ='pn5018.php?task=Edit&tasktk=Edit&dataid='+window.dataid+'&dataid2='+window.kodeperusahaan+'&mid=<?=$mid;?>';
        ...
        <script type="text/javascript">
			$(document).ready(function(){
				...
				$('#btn_view').click(function() {
					if(window.dataid != ''){
						window.location='pn5018.php?task=View&tasktk=View&dataid='+window.dataid+'&dataid2='+window.kodeperusahaan+'&mid=<?=$mid;?>';
					} else {
				...
				$('#btn_edit').click(function() {	
					if(window.dataid != ''){
						window.location='pn5018.php?task=Edit&tasktk=Edit&dataid='+window.dataid+'&dataid2='+window.kodeperusahaan+'&mid=<?=$mid;?>';
					} else {
						alert('Silahkan pilih terlebih dahulu data yang akan di proses!');
					}
				});
				...
				$("#btncetakdaftarentripelaksanapihakketiga").click(function() {						
				...
				<?PHP
					if($_REQUEST["task"] == "View"){
						...
						$.ajax({
							type: 'POST',
							url: 'http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5018_action.php?'+Math.random(),
							...
							success: function(data) {
								...
								if(jdata.ret == '0'){
									...
									$('#nama_pihak_ketiga').val(jdata.data[0].NAMA_PELAKSANA);
									$('#alamat_pihak_ketiga').val(jdata.data[0].ALAMAT_PELAKSANA);
									$('#email_pihak_ketiga').val(jdata.data[0].EMAIL_PELAKSANA);
									$('#pic_pihak_ketiga').val(jdata.data[0].PIC_PELAKSANA);
									$('#no_telp_pic_pihak_ketiga').val(jdata.data[0].NO_TELP_PIC);
									$('#keterangan_pihak_ketiga').val(jdata.data[0].KETERANGAN_REKAM_PELAKSANA);
				...
				<?PHP
					if($_REQUEST["task"] == "Edit"){
						...
						$.ajax({
							...
							success: function(data) {
								...
								if(jdata.ret == '0'){
									...
									if(jdata.data[0].TGL_SUBMIT_PELAKSANAKETIGA === null)
									{
										$('#btnsubmitdatapihakketiga').removeAttr('disabled');
										$('#btnsubmitdatapihakketiga').removeClass('disabled');
									}
									else
									{
										$('#btnsubmitdatapihakketiga').attr('disabled','disabled');
										$('#btnsubmitdatapihakketiga').addClass('disabled');
										
										$('#nama_pihak_ketiga').attr('disabled','disabled');
										$('#nama_pihak_ketiga').addClass('disabled');
										$('#alamat_pihak_ketiga').attr('disabled','disabled');
										$('#alamat_pihak_ketiga').addClass('disabled');
										$('#email_pihak_ketiga').attr('disabled','disabled');
										$('#email_pihak_ketiga').addClass('disabled');
										$('#pic_pihak_ketiga').attr('disabled','disabled');
										$('#pic_pihak_ketiga').addClass('disabled');
										$('#no_telp_pic_pihak_ketiga').attr('disabled','disabled');
										$('#no_telp_pic_pihak_ketiga').addClass('disabled');
										$('#keterangan_pihak_ketiga').attr('disabled','disabled');
										$('#keterangan_pihak_ketiga').addClass('disabled');
						...
						$('#btn_save').click(function() {
							if($('#nama_pihak_ketiga').val() != '' && $('#alamat_pihak_ketiga').val() != '' && $('#email_pihak_ketiga').val() != ''
							   && $('#pic_pihak_ketiga').val() != '' && $('#no_telp_pic_pihak_ketiga').val() != ''){
							   if(validateEmail())
							   {
									preload(true);
									$.ajax({
								...
								alert('Silahkan mengisi data mandatori pihak ketiga pelaksana kegiatan!');
							}
							
						});
						
						$('#btnsubmitdatapihakketiga').click(function() {
							if($('#nama_pihak_ketiga').val() != '' && $('#alamat_pihak_ketiga').val() != '' && $('#email_pihak_ketiga').val() != ''
							   && $('#pic_pihak_ketiga').val() != '' && $('#no_telp_pic_pihak_ketiga').val() != ''){
								if(validateEmail())
							   {
									submitPihakKetigaPelaksanaKegiatan(window.dataid);
							   }
							}else {
								alert('Silahkan mengisi data mandatori pihak ketiga pelaksana kegiatan!');
							}
			...
			function submitPihakKetigaPelaksanaKegiatan(p_kode_promotif){
				var r = confirm("Apakah anda yakin?");
				if (r == true) {
					$.ajax({
						type: 'POST',
						url: 'http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5018_action.php?'+Math.random(),
						data: { TYPE:'SUBMIT', DATAID:p_kode_promotif, NAMAPIHAKKETIGASUBMIT:$('#nama_pihak_ketiga').val(), ALAMATPIHAKKETIGASUBMIT:$('#alamat_pihak_ketiga').val(),
								EMAILPIHAKKETIGASUBMIT:$('#email_pihak_ketiga').val(), PICPIHAKKETIGASUBMIT:$('#pic_pihak_ketiga').val(), 
								NOTELPICPIHAKKETIGASUBMIT:$('#no_telp_pic_pihak_ketiga').val(), KETERANGANPIHAKKETIGASUBMIT:$('#keterangan_pihak_ketiga').val()},
						success: function(data) {
							preload(false);
							jdata = JSON.parse(data);
							if(jdata.ret == '0'){
			...
			function loadData(){
				...
				$.ajax({
					type: 'POST',
					url: 'http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5018_query.php?'+Math.random(),
			...
			function validateEmail()  {  
				var vEmail = document.getElementById("email_pihak_ketiga")
				...
				{  
					alert("Silahkan memasukkan alamat email dengan benar!"); 
					vEmail.focus();  
					return false;  
				}  
			}  
