...
$ls_nama_rekening_penerima	= str_replace("'"," ", $_POST['nama_rekening_penerima']); 
...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">				
    <?
    echo "<script language=\"JavaScript\" type=\"text/javascript\">";						
    echo "alert('kode klaim'+$ls_kode_klaim);";
    echo "</script>";	
    if ($ls_kode_klaim !="" && $ls_kode_penerima_berkala !="")
    {
      ...
      <div id="formKiri" style="width:1100px;">
          ...
          <tr>
            ...
            <table width="550px" border="0">
                      ...
                      <?
								...
								<tr>
									<td>
										<fieldset style="height:60px;"><legend><i><font color="#009999">Ditransfer dari :</font></i></legend>
                      <div class="form-row_kiri">
                      <label style = "text-align:right;">Bank *</label>	 	    				
                      ...
                      <div class="clear"></div>																
								...
								<tr>
									<td>
										<fieldset style="height:160px;"><legend><i><font color="#009999">Ditransfer ke :</font></i>	 	    				
              						<? 
        ...
        ?>			 	
          ...
          <?if ($ls_task == "edit" || $ls_task == "Edit" || $ls_task == "PENETAPAN" || $ls_task == "PERSETUJUAN" || $ls_task == "PEMBAYARAN")
					{
  					?>
