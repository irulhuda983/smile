...
<form action="<?=$PHP_SELF;?>" method="post" id="lov_inv_porto" name="lov_inv_porto">
    ...
    <table class="caption">
      <tr> 
        <td colspan="2">
      		Tekan Control F untuk pencarian Nama Bank			
        </td>
        <td align="right">
					<!--
					Search By &nbsp
          <select name="pilihsearch">
            ...
            ?>
        		<option value="sc_nama_bank" <?=$sel1;?>>Nama Bank</option>    
					...
					-->
					<input type="hidden" name="pilihsearch" value="<?=$pilihsearch;?>" size="25" style="background-color: #ccffff;">
          <input type="hidden" name="searchtxt" value="<?=$searchtxt;?>" size="25" style="background-color: #ccffff;">
      ...
      // query with paging								
      $rows_per_page = 300;
      $lov_url = 'pn5063_lov_bankpenerima.php'; // url sama dengan nama file		
