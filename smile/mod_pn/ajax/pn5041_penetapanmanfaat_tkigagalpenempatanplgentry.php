...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    function f_ajax_val_hitung_manfaat()
    {
      ...
      ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_pemulangangagalpenempatan&c_biaya_darat='+c_biaya_darat+'&c_biaya_laut='+c_biaya_laut+'&c_biaya_udara='+c_biaya_udara+'&c_biaya_udara='+c_biaya_udara+'&c_kode_klaim='+c_kode_klaim+'&c_no_urut='+c_no_urut;
    ...
    <table class="captionfoxrm">
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend><b><i><font color="#009999">Entry Rincian Manfaat Biaya Transportasi</font></i></b></legend>
          </br>
