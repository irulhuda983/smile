...
$sql = "select ".
       ...
       "           and b.tipe_rekening = '32' ".  //spo kapu
       "           and nvl(a.aktif,'T')='Y' ". 
       "           and rownum = 1 ".
       "     ) default_kode_buku ". 			  
       "from ". 
       ...
       "     and nvl(c.kode_pointer_asal,'XXX') = 'SPO' ".
			 "		 and b.kode_bank_pembayar in (select kode from sijstk.ms_lookup where tipe='SPOKAPU' and nvl(aktif,'T')='Y') ".
...
<fieldset style="background: #F2F2F2;"><legend style="background: #FF0; border: 1px solid #CCC;">Keterangan:</legend>
  ...
  <li style="margin-left:15px;">Pembayaran melalui <font color="#ff0000"> SPO KAPU</font> adalah semua klaim melalui SPO dari bank yang saat ini <font color="#ff0000">sudah tersentralisasi</font> seperti BTN dan BJB. </br>Jika <font color="#ff0000">REKENING SPO KAPU TIDAK TAMPIL </font>pada pilihan "Pembayaran Melalui" maka hubungi Administrator untuk melakukan <font color="#ff0000">SETUP REKENING DENGAN KODE TIPE REKENING 32 PADA MENU SETUP BANK</font></li>
</fieldset>
