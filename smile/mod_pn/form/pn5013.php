...
$pagetype = "form";
$gs_pagetitle = "PN5013 - PENCETAKAN SURAT PEMBERITAHUAN KEGIATAN PROMOTIF/PREVENTIF";
require_once "../../includes/header_app_nosql.php";	
$mid = $_REQUEST["mid"];
$gs_kode_segmen = "PU";

/* ============================================================================
Ket : Form ini digunakan sebagai form input Pencetakan Surat Pemberitahuan Kegiatan Promotif/Preventif
...
<div id="actmenu" >
	<div id="actbutton">
		...
		?>
			...
			<div style="float:left;">
				<div class="icon">
					<a id="btn_close" href="http://<?=$HTTP_HOST;?>/mod_pn/form/pn5013.php?mid=<?=$mid;?>">
    ...
    <div id="formKiri" style="width:1000px">
		<form name="formreg" id="formreg" role="form" method="post">
			<div id="konten">
				...
				<div id="formsplit">
					<fieldset>
						<legend>Data Surat Pemberitahuan</legend>
				...
				<div id="formsplit">
					<fieldset>
						<legend>Detail Surat Pemberitahuan</legend>	
						<div class="form-row_kiri">
							<label>Kode Promotif</label>	
				...
				<div id="formsplit">
					<fieldset>
						<legend>Daftar Surat Pemberitahuan</legend>	
						<div class="clear"></div>
						<table class="table responsive-table" id="mydata" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th scope="col" width="10%">Tanggal Verifikasi KBL</th>
									<th scope="col" width="8%">Surat Pemberitahuan</th>
					...
					<fieldset style="background: #ededed;">
						...
						<div class="form-row_kiri">
							<br>
							<input type="button" style="display:none" class="btn green" id="btncetakdaftarpemberitahuan" name="btncetakdaftarpemberitahuan" tabindex="41" value="CETAK DAFTAR SURAT PEMBERITAHUAN" title="Klik Untuk Cetak Daftar Pemberitahuan">	
							&nbsp;
				...
				<div id="formsplit">
					<fieldset style="background: #ededed;">
						<br>
						<input type="button" name="btncetaksuratpemberitahuan" id="btncetaksuratpemberitahuan" class="btn green"  value="CETAK SURAT PEMBERITAHUAN" title="Klik untuk cetak surat pemberitahuan">
						&nbsp;
						<input type="button" name="btnkonfirmasicetaksuratpemberitahuan" id="btnkonfirmasicetaksuratpemberitahuan" class="btn green"  value="KONFIRMASI CETAK SURAT PEMBERITAHUAN" title="Klik untuk konfirmasi surat pemberitahuan">																																																	
					</fieldset>
					<br>
					<div class="clear"></div>
				</div>
        ...
        <script type="text/javascript">
			$(document).ready(function(){
				...
				$('#btn_view').click(function() {
					if(window.dataid != ''){
						window.location='pn5013.php?task=View&tasktk=View&dataid='+window.dataid+'&dataid2='+window.kodeperusahaan+'&mid=<?=$mid;?>';
					} else {
				...
				$('#btn_edit').click(function() {	
					if(window.dataid != ''){
						window.location='pn5013.php?task=Edit&tasktk=Edit&dataid='+window.dataid+'&dataid2='+window.kodeperusahaan+'&mid=<?=$mid;?>';
					} else {
						alert('Silahkan pilih terlebih dahulu data yang akan di proses!');
					}
				});
				...
				$("#btncetakdaftarpemberitahuan").click(function() {						
					cetakDaftarDokumenPdf("PNR500814","<?php echo $ls_kode_kantor; ?>")
				});
				...
				<?PHP
					if($_REQUEST["task"] == "View"){
						...
						$.ajax({
							type: 'POST',
							url: 'http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5013_action.php?'+Math.random(),
						...
						$('#btncetaksuratpemberitahuan').click(function() {
							cetakDokumenPdf("PNR500801",window.dataid);
						});
						
						$('#btnkonfirmasicetaksuratpemberitahuan').click(function() {
			...
			function loadData(){
				...
				$.ajax({
					type: 'POST',
					url: 'http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5013_query.php?'+Math.random(),
						...
						if(jdata.ret == 0){
							for (i = 0; i < jdata.data.length; i++) { 
								...
								window.table.row.add( [
									...
									jdata.data[i].TGL_APPROVAL_VERIFIKASI,
									'<div style="text-align:center !important"><input type="button" class="btn green" onclick=cetakDokumenPdf("PNR500801","'+jdata.data[i].KODE_PROMOTIF+'") '+ $ls_cetak_surat_pemberitahuan+ ' KODE_PROMOTIF="'+jdata.data[i].KODE_PROMOTIF+'" id="BTNCETAK_'+i+'" urut="'+i+'" name="BTNCETAK['+i+']" value="&nbsp;&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;&nbsp;" title="Klik Untuk Mencetak Surat Pemberitahuan"></div>',
									'<div style="text-align:center !important"><input type="button" class="btn green" onclick=konfirmasiCetakSurat("'+jdata.data[i].KODE_PROMOTIF+'") '+ $ls_cetak_surat_pemberitahuan+ ' KODE_PROMOTIF="'+jdata.data[i].KODE_PROMOTIF+'" id="BTNKONFIRMASI_'+i+'" urut="'+i+'" name="BTNKONFIRMASI['+i+']" value="Konfirmasi" title="Klik Untuk Mengkonfirmasi Cetak Surat Pemberitahuan"></div>'
