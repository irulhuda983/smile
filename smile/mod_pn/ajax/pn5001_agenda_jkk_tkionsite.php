...
{		 	
	bkwindow("../ajax/pn5002_lovtapjkk1_diagnosa.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_dtldiag_kode_diagnosa_detil"+i+"&c=jkk_dtldiag_nama_diagnosa_detil"+i+"","",800,500,1);		 
}	
...
{		 	
	bkwindow("../ajax/pn5002_lovtapjkk1_aktivitaslap.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_dtlaktvpelap_nama_aktivitas"+i+"","",800,450,1);		 
}

function fl_js_lov_status_aktivitas_pelaporan(i)
{		 	
	bkwindow("../ajax/pn5001_lov_statusaktivlap.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_dtlaktvpelap_status"+i+"","",800,450,1);		 
}
...
<div id="formKiri" style="width:870px;">
  <fieldset><legend>Informasi Kecelakaan</legend>
    ...
    <label style = "text-align:right;">Jam Kecelakaan &nbsp; *</label>		 	    				
      ...
      <? 
  			...
  			{
					$sql = "select kode, keterangan from sijstk.ms_lookup where tipe='KLMJAMKERJ' and kode='$ls_jkk_kode_jam_kecelakaan' order by seq";
        }else
  			{
    ...
    <label style = "text-align:right;">Jenis Kasus &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *</label>		 	    				
      ...
      <?
  			if ($ls_status_submit_agenda =="Y")
  			{
					$sql = "select kode_jenis_kasus, nama_jenis_kasus from sijstk.pn_kode_jenis_kasus where kode_jenis_kasus='$ls_jkk_kode_jenis_kasus'";
        }else
  			{
      ...
      <label style = "text-align:right;">Lokasi Kecelakaan &nbsp; *</label>		 	    				
        ...
        <? 
    			if ($ls_status_submit_agenda =="Y")
    			{
						$sql = "select kode_lokasi_kecelakaan, nama_lokasi_kecelakaan from sijstk.pn_kode_lokasi_kecelakaan where kode_lokasi_kecelakaan='$ls_jkk_kode_lokasi_kecelakaan'";
          }else
    			{
	...
	<span id="jkk_span_kecelakaan_kerja" style="display:none;">
      ...
      <label style = "text-align:right;">Corak &nbsp;</label>
        ...
        <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_corak.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_corak&c=jkk_nama_corak','',800,500,1)">
      ...
      <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_sumbercedera.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_sumber_cedera&c=jkk_nama_sumber_cedera','',800,500,1)">
      ...
      <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_bagiansakit.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_bagian_sakit&c=jkk_nama_bagian_sakit','',800,500,1)">
      ...
      <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_akibatdiderita.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_akibat_diderita&c=jkk_nama_akibat_diderita','',800,500,1)">
	...
	<span id="jkk_span_penyakit_akibat_kerja" style="display:none;">
      ...
      <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_penyakittimbul.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_penyakit_timbul&c=jkk_nama_penyakit_timbul','',800,500,1)">
      <img src="../../images/help.png" alt="LOV Bagian yang Sakit" border="0" align="absmiddle"></a>													
      </div>																																										
      <div class="clear"></div>			
		</fieldset>			
  ...
  <fieldset><legend>Tempat Tenaga Kerja Dirawat</legend>
    ...
    <label  style = "text-align:right;">Fasilitas Kesehatan</label>
      ...
      <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_faskes.php?p=pn5001_tabdataklaim_jkktkionsite.php&a=formreg&b=jkk_kode_ppk&c=jkk_nama_ppk','',800,500,1)">
  ...
  <fieldset><legend>Kondisi Terakhir TK</legend>
    ...
    <label style = "text-align:right;">Kondisi Terakhir &nbsp;</label>		 	    				
      ...
      <? 
				if ($ls_status_submit_agenda =="Y")  	
  			{
				  $sql = "select kode_kondisi_terakhir, nama_kondisi_terakhir from sijstk.pn_kode_kondisi_terakhir where kode_kondisi_terakhir = '$ls_jkk_kode_kondisi_terakhir'"; 			
				}else
				{
