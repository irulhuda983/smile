...
<head>
  ...
  <script language="JavaScript">    
    function fl_js_val_numeric(v_field_id)
    {
      ...
      }else if(form.rehab_jenis_pelayanan.value==""){
        alert('Jenis Pelayanan tidak boleh kosong...!!!');
        form.rehab_jenis_pelayanan.focus();
      }else
  		{
...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_penunjangdiagnostikpak&c_kode_manfaat='+c_kode_manfaat+'&c_nom_biaya_diverifikasi='+c_nom_biaya_diverifikasi+'&c_kode_klaim='+c_kode_klaim+'&c_no_urut='+c_no_urut;
    ...
    function showClientData()
    {
      ...
      if (st_errorval1 == 1)
      {  
        window.document.getElementById("dispError1").innerHTML = "(* Setup Tarif Rehabilitasi Medis tidak valid, harap cek data setup..!!!";
    ...
    <table class="captionfoxrm">
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend><b><i><font color="#009999">Entry Rincian Manfaat Biaya Rehabilitasi Medis</font></i></b></legend>
					</br>				
          ...
          <label  style = "text-align:right;">Jenis Pelayanan </label>
            <input type="text" id="rehab_jenis_pelayanan" name="rehab_jenis_pelayanan" value="<?=$ls_rehab_jenis_pelayanan;?>" size="43" maxlength="100" tabindex="2" style="background-color:#ffff99;"> 				
          </div>																		
          <div class="clear"></div>	
          ...
          <label  style = "text-align:right;">Total Diajukan </label>
            <input type="text" id="nom_biaya_diajukan" name="nom_biaya_diajukan" value="<?=number_format((float)$ln_nom_biaya_diajukan,2,".",",");?>" tabindex="6" size="37" maxlength="20" style="text-align:left;" onblur="this.value=format_uang(this.value); f_ajax_val_nom_biaya_diajukan();">				
          </div>																		
          <div class="clear"></div>

          <div class="form-row_kiri">
          <label  style = "text-align:right;">Total Diverifikasi </label>
            <input type="text" id="nom_biaya_diverifikasi" name="nom_biaya_diverifikasi" value="<?=number_format((float)$ln_nom_biaya_diverifikasi,2,".",",");?>" tabindex="6" size="37" maxlength="20" style="text-align:left;" onblur="this.value=format_uang(this.value); f_ajax_val_hitung_manfaat();">				
          </div>																		
          <div class="clear"></div>
