...
<div style="display: none;" id="tab1" class="tab_konten">
  ...
  include "../ajax/pn5001_view_tabadministrasi.php";
  ?>											
  </div>
</div>
  ...
  <div id="konten">
		<div id="formKiri" style="width:1100px;">
            ...
            <fieldset style="height:210px;"><legend><b><i><font color="#009999">Informasi Pengajuan Klaim JKK Tahap I &nbsp;<?=$ls_nama_tk;?></font></i></b></legend>
              ...
              <span id="span_kecelakaan_kerja" style="display:none;">						
                ...
                <label style = "text-align:right;">Tindakan Bahaya &nbsp;</label>		 	    				
                  <select size="1" id="tapjkk1_kode_tindakan_bahaya" name="tapjkk1_kode_tindakan_bahaya" value="<?=$ls_tapjkk1_kode_tindakan_bahaya;?>" tabindex="1" class="select_format" style="width:330px;" >
                ...
                <label style = "text-align:right;">Kondisi Bahaya &nbsp;</label>		 	    				
                  <select size="1" id="tapjkk1_kode_kondisi_bahaya" name="tapjkk1_kode_kondisi_bahaya" value="<?=$ls_tapjkk1_kode_kondisi_bahaya;?>" tabindex="2" class="select_format" style="width:330px;" >
                  <option value="">-- pilih --</option>
                  <? 
                ...
                <label style = "text-align:right;">Corak &nbsp;</label>
                  <input type="text" id="tapjkk1_kode_corak" name="tapjkk1_kode_corak" value="<?=$ls_tapjkk1_kode_corak;?>" tabindex="3" style="width:40px;" maxlength="10" readonly>
                  ...
                  <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_corak.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_corak&c=tapjkk1_nama_corak','',800,500,1)">
                ...
                <label style = "text-align:right;">Sumber Cedera &nbsp;</label>
                  <input type="text" id="tapjkk1_kode_sumber_cedera" name="tapjkk1_kode_sumber_cedera" value="<?=$ls_tapjkk1_kode_sumber_cedera;?>" tabindex="4" style="width:40px;" maxlength="10" readonly>
                  ...
                  <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_sumbercedera.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_sumber_cedera&c=tapjkk1_nama_sumber_cedera','',800,500,1)">
                ...
                <label style = "text-align:right;">Bagian yang Sakit &nbsp;</label>
                  <input type="text" id="tapjkk1_kode_bagian_sakit" name="tapjkk1_kode_bagian_sakit" value="<?=$ls_tapjkk1_kode_bagian_sakit;?>" tabindex="5" style="width:40px;" maxlength="10" readonly>
                  ...
                  <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_bagiansakit.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_bagian_sakit&c=tapjkk1_nama_bagian_sakit','',800,500,1)">
                ...
                <label style = "text-align:right;">Akibat yg Diderita *</label>
                  ...
                  <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_akibatdiderita.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_akibat_diderita&c=tapjkk1_nama_akibat_diderita','',800,500,1)">
              ...
              <span id="span_penyakit_akibat_kerja" style="display:none;">
                ...
                <label style = "text-align:right;">Lama Bekerja (Thn) &nbsp;</label>		 	    				
                  <select size="1" id="tapjkk1_kode_lama_bekerja" name="tapjkk1_kode_lama_bekerja" value="<?=$ls_tapjkk1_kode_lama_bekerja;?>" tabindex="7" class="select_format" style="width:330px;" >
                  <option value="">-- pilih --</option>
                  <? 
                ...
                <label style = "text-align:right;">Penyakit yg Timbul &nbsp;</label>
                  <input type="text" id="tapjkk1_kode_penyakit_timbul" name="tapjkk1_kode_penyakit_timbul" value="<?=$ls_tapjkk1_kode_penyakit_timbul;?>" tabindex="8" style="width:40px;" maxlength="10" readonly>
                  ...
                  <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_penyakittimbul.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_penyakit_timbul&c=tapjkk1_nama_penyakit_timbul','',800,500,1)">
                  <img src="../../images/help.png" alt="LOV Bagian yang Sakit" border="0" align="absmiddle"></a>													
                </div>																																										
                <div class="clear"></div>										
              </span>
                  ...
                  <fieldset style="height:100px;" ><legend><b><i><font color="#009999">Tempat Tenaga Kerja Dirawat</font></i></b></legend>
                    ...
                    <span id="span_faskes" style="display:none;">
                      ...
                      <label  style = "text-align:right;">Fasilitas Kesehatan</label>
                        ...
                        <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_faskes.php?p=pn5002.php&a=adminForm&b=tapjkk1_kode_ppk&c=tapjkk1_nama_ppk','',800,500,1)">
                  ...
                  <span id="tapjkk1_span_upah_tk" style="display:none;">
                    <fieldset style="height:80px;"><legend><b><i><font color="#009999">Upah yang Diterima oleh Tenaga Kerja</font></i></b></legend>								 										 
                      ...
                      <label style = "text-align:right;">Upah Terakhir&nbsp; *</label>		 	    				
                        ...
                        <a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5002_lovtapjkk1_upahterakhir.php?p=pn5002_penetapanjkk1.php&a=adminForm&b=tapjkk1_nom_upah_terakhir&c='+adminForm.kode_perusahaan.value+'&d='+adminForm.kode_segmen.value+'&e='+adminForm.kode_divisi.value+'&f='+adminForm.kode_tk.value+'&g='+adminForm.tgl_kejadian.value+'','',800,500,1)">
                        <img src="../../images/help.png" alt="Cari Faskes" border="0" align="absmiddle"></a>		
                      </div>																																											
                      <div class="clear"></div>
          ...
          <td valign="top" colspan="2">
              ...
              {		 	
              	bkwindow("../ajax/pn5002_lovtapjkk1_diagnosa.php?p=pn5002.php&a=adminForm&b=tapjkk1_dtldiag_kode_diagnosa_detil"+i+"&c=tapjkk1_dtldiag_nama_diagnosa_detil"+i+"","",1000,500,1);		 
              }	
...
<div style="display: none;" id="tab3" class="tab_konten">
  <div id="konten">
        <script language="javascript">
          ...
          {		 	
          	bkwindow("../ajax/pn5002_lovtapjkk1_aktivitaslap.php?p=pn5002.php&a=adminForm&b=tapjkk1_dtlaktvpelap_nama_aktivitas"+i+"","",800,450,1);		 
          }
          
          function fl_js_lov_status_aktivitas_pelaporan(i)
          {		 	
          	bkwindow("../ajax/pn5001_lov_statusaktivlap.php?p=pn5002.php&a=adminForm&b=tapjkk1_dtlaktvpelap_status"+i+"","",800,450,1);		 
          }
