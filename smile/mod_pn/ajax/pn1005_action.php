...
if($ls_type=="new"){
	...
	if($DB->execute()){ 
		...
		{
		    $data['ACTION'] = '<input type="checkbox" class="btn green" id="CHECK_'.$data['KODE_TIPE_PENERIMA'].'" name="CHECK_'.$data['KODE_TIPE_PENERIMA'].'" KODE_TIPE_PENERIMA="'.$data['KODE_TIPE_PENERIMA'].'"  title="Pilih untuk pengaturan data">
		';
