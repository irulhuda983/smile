...
if($TYPE=='INSERT_KARTU'){
  if($SUBTYPE=='PP0301' || $SUBTYPE=='PP0302'){
    ...
    $sql =  "BEGIN
                PN.P_PN_PN60010210.X_SUBMIT_TINDAK_LANJUT ('$kode_agenda',
                                            '$kode_user',
                                            '$tb_keterangan',
                                            :P_KODE_AGENDA_ADJ,
                                            :P_MESS,
    ...
    $sql =  "BEGIN
                PN.P_PN_PN60010210.X_BATAL_TINDAK_LANJUT ('$kode_agenda',
                                            '$kode_user',
                                            '$keterangan',
                                            :P_KODE_AGENDA_ADJ,
                                            :P_MESS,
    ...
    $tb_kode_perihal_detil  = $_POST['tb_kode_perihal_detil'];
        ...
        $sql =  "BEGIN
                PN.P_PN_PN60010210.X_APPROVE_TINDAK_LANJUT ('$kode_agenda',
