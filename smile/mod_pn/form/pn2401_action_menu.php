<div id="actmenu">
  <div id="actbutton">
    ...
    ?>
      ...
      ?>
      <div style="float:left;"><div class="icon">
        <a id="btn_close" href="pn2401.php?mid=<?=$mid;?>"><img src="http://<?=$HTTP_HOST;?>/images/file_cancel.gif" align="absmiddle" border="0"> Close</a> 
      </div></div>
    <?php
    } 
    else 
...
$(document).ready(function(){
    $('#btn_view').click(function() {
        if(window.dataid != ''){
        window.location='pn2401.php?task=View&kode_faskes='+window.dataid+'&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
    ...
    $('#btn_edit').click(function() {									
        if(window.dataid != ''){
            window.location='pn2401.php?task=Edit&kode_faskes='+window.dataid+'&dataid='+window.dataid+'&mid=<?=$mid;?>';
        } else {
            alert('Silahkan pilih terlebih dahulu data yang akan di proses!');
        } 								
    });
    ...
    $('#btn_new').click(function() {
        window.location='pn2401.php?task=New&dataid='+window.dataid+'&mid=<?=$mid;?>';
    });
});
</script>