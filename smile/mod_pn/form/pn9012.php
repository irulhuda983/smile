<?php
$pagetype = "report";
$gs_pagetitle = "PN9012 - LAPORAN KLAIM JKP";
...
$sql2 = " select a.rowid, a.kode_report, b.nama_jenis_report_detil, a.parameter_report
          ...
          and b.kode_jenis_report = 'PN9012'
...
if (isset($jenis_report) && (isset($iscetak) || isset($iscetak_excel))) {	
	...
	if ($ls_error=="1") {
		...
		if($ls_nama_rpt=='PNR9113.rdf' || $ls_nama_rpt=='PNR9114.rdf')	{
		exec_rpt_enc_new_ec_drc(1, $ls_modul, $ls_nama_rpt, $ls_user_param, $tipe);	
		}else{
		exec_rpt_enc_new_ec(1, $ls_modul, $ls_nama_rpt, $ls_user_param, $tipe);
		}
	}
}
?>
