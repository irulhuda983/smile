  ...
  ?>	
    ...
    <td align="left"><b><?=$gs_pagetitle;?></b></td>					 
      ...
      <div id="formKiri" style="width:1150px">	 
        <fieldset><legend><b>DATA PEMBAYARAN KLAIM</b></legend>  	
          ...
          <div class="form-row_kanan">
            ...
            <input type="button" name="btncari" class="btn green" id="btncari" value=" TAMPILKAN DATA ">
						<input type="button" name="btncetaklapbyr" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5029_lapbyrklaim.php?&sender=pn5029.php&sender_mid=<?=$mid;?>','cetak_lap_pembayaran',970,570,'yes');" href="javascript:void(0);" class="btn green" id="btndaftar" value="    CETAK PEMBAYARAN KLAIM   ">
          ...
          <div id="formsplit">
            <div class="clear"></div>
                  ...
                  <th scope="col" style="width:10%;">Tipe</th>
									...
									<!--<th scope="col" style="width:5%;">Melalui</th>-->
									<th scope="col" style="width:5%;">Prg</th>
									<!--<th scope="col" style="width:5%;">Sentral</th>
									<th scope="col" style="width:5%;">Btl</th>-->
      					</tr>
      				</thead>
      			</table>								
            <div class="clear"></div>
  		...
  		function loadData()
  		{
    	    ...
    	    scrollX				: true,
    	  	"processing"		: true,
    			...
    			"destroy"		: true,
    	        "ajax"				: {
    	        	"url"	: "http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5029_query.php",
    	        	"type": "POST",							
    	        	"data" : function(e) { 
//					console.log(e);
    	        		e.TYPE = $('#type').val();
    	        ...
    	        "columns": [
    	          ...
    	          { "data": "NAMA_PENERIMA" },
								...
								//{ "data": "NAMA_BANK" },
								{ "data": "NM_PRG" },
								//{ "data": "FLAG_SENTRALISASI" },
								//{ "data": "STATUS_BATAL" },
    	        ],
    	        'aoColumnDefs': [
    				//{"className": "dt-center", "targets": [0,1,2,3,5,6,7,8,9,11,12]},
