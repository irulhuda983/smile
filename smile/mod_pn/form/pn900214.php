<?
$pagetype = "report";
$gs_pagetitle = "PN900214 - REKAP PEMBAYARAN JHT 30% NASIONAL (PNR1018)";
	...
	<div id="formKiri">
		<fieldset><legend><?=$gs_pagetitle?></legend>
			<div class="form-row_kiri">
				<label>User *</label>
				<input type="text" id="username" name="username" value="<?=$username;?>" size="10" style="width: 120px;" required>
			</div>
	    	<div class="clear"></div>
		</fieldset>
		</br>
