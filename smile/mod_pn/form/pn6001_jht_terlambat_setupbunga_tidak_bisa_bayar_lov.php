<?php
$pagetype = "form";
$gs_pagetitle1 = "PN6001- DAFTAR JHT KURANG BAYAR KARENA PERBEDAAN TINGKAT HASIL PENGEMBANGAN";
...
function loadData()
{
    window.table = $('#mydata_grid').DataTable({
        ...
        "destroy"		: true,
        "ajax"				: {
            "url"	: "http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn6001_jht_terlambat_setupbunga_tidak_bisa_bayar_query.php",
            "type": "POST",
            "data" : function(e) {
                e.TYPE = "l";
