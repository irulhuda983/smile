  ...
  ?> 
	<div id="actmenu">
  	<div id="actbutton">
        ...
        <a id="btn_close" href="http://<?=$HTTP_HOST;?>/mod_pn/form/pn5049.php?mid=<?=$mid;?>&tglawaldisplay=<?=$ld_tglawaldisplay;?>&tglakhirdisplay=<?=$ld_tglakhirdisplay;?>&rg_kategori=<?=$ls_rg_kategori;?>"><img src="http://<?=$HTTP_HOST;?>/images/file_cancel.gif" align="absmiddle" border="0"> Close</a> 
        </div></div>
  		</div>	
  	</div>
  </div>		
