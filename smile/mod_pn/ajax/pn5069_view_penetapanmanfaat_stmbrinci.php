<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat stmb
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset ><legend>Rincian Manfaat</legend>
            ...
            <label style = "text-align:right;">Tipe Penerima *</label>
              <input type="text" id="mnf_nama_tipe_penerima" name="mnf_nama_tipe_penerima" readonly class="disabled" style="width:290px;">	
            ...
            <label style = "text-align:right;">Periode</label>
              <input type="text" id="mnf_stmb_tgl_awal" name="mnf_stmb_tgl_awal" style="width:128px;" readonly class="disabled">
              &nbsp;s/d&nbsp;
  						<input type="text" id="mnf_stmb_tgl_akhir" name="mnf_stmb_tgl_akhir" style="width:128px;" readonly class="disabled">
            </div>																																															
            <div class="clear"></div>
  
            <div class="form-row_kiri">
            <label  style = "text-align:right;">Jml Hari </label>
              <input type="text" id="mnf_stmb_jml_hari" name="mnf_stmb_jml_hari" readonly class="disabled" style="width:290px;">				
            </div>																		
            <div class="clear"></div>
  									
            <div class="form-row_kiri">
            <label  style = "text-align:right;">Jml Jam Kerja </label>
              <input type="text" id="mnf_stmb_jml_jamkerja" name="mnf_stmb_jml_jamkerja" readonly class="disabled" style="width:290px;">		
            </div>																		
            <div class="clear"></div>
            ...
            <label style = "text-align:right;">Catatan &nbsp;</label>
            	<textarea cols="255" rows="1" style="width:290px;height:15px;background-color:#f5f5f5;" id="mnf_keterangan" name="mnf_keterangan" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)"></textarea>   					
            </div>								
            <div class="clear"></div>
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#mnf_stmb_tgl_awal').val(getValue(jdata.data.DATA['STMB_TGL_AWAL']));
						$('#mnf_stmb_tgl_akhir').val(getValue(jdata.data.DATA['STMB_TGL_AKHIR']));
						
						$('#mnf_stmb_jml_hari').val(getValue(jdata.data.DATA['STMB_JML_HARI']));
						$('#mnf_stmb_jml_jamkerja').val(getValue(jdata.data.DATA['STMB_JML_JAMKERJA']));
