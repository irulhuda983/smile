...
children: [{
        ...
        children:[{
                ...
                children:[{
                        text:'Penerimaan Iuran BPU',
                        id:'102010100000000',
                        fungsi:'1',
                        leaf:true,
                        iconCls: 'menu-form'
                    },{
                        text:'Penerimaan Iuran JAKONS',
                        id:'102010200000000',
                        fungsi:'1',
                        leaf:true,
                        iconCls: 'menu-form'
        ...
        children:[{
                ...
                children:[{
                        ...
                        text:'Pengeluaran Non Kas',
                        id:'103020400000000',
                        expanded: false,
                        iconCls: 'menu-folder',
                        children:[{
                                text:'Entry Pengeluaran Non Kas',
                                id:'103020401000000',
                                fungsi:'1',
                                leaf:true,
                                iconCls: 'menu-form'
                            },{
                                text:'Approval Pengeluaran Non Kas',
                                id:'103020402000000',
                                fungsi:'1',
                                leaf:true,
                                iconCls: 'menu-form'
                ...
                children:[{
                        ...
                        text:'Pemindahan Dana dan Fee',
                        id:'103040300000000',
                        expanded: false,
                        iconCls: 'menu-folder',
                        children:[{
                                text:'Pindah Dana Iuran dan Fee',
                                id:'103040301000000',
                                fungsi:'1',
                                leaf:true,
                                iconCls: 'menu-form'
                            },{
                                text:'Pindah Dana Jakons',
                                id:'103040302000000',
                                fungsi:'1',
                                leaf:true,
                                iconCls: 'menu-form'
