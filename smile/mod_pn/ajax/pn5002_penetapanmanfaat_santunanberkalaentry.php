...
<body>
  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
			...
			{ 
        ajax.requestFile = '../ajax/pn5001_validasi.php?getClientId=f_ajax_val_hitung_manfaat_santunanberkala&c_kode_manfaat='+c_kode_manfaat+'&c_kode_perlindungan='+c_kode_perlindungan+'&c_kode_segmen='+c_kode_segmen;
    ...
    <td align="left"><b><?=$gs_pagetitle;?></b> </td>						 
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend >Entry Rincian Manfaat Santunan Berkala</legend>
          </br>
