...
Deskripsi:
-----------
File ini dipergunakan untuk rincian manfaat bantuan pemulangan gagal penempatan tki
...
<script language="javascript">
	...
	{		console.log('okkkk');
		var c_mid = '<?=$mid;?>';
		showForm('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5069_view_penetapanmanfaat_tkibantuanpemulangankarenaditempatkantidaksesuaipkentry.php?task=view&kode_klaim='+p_kode_klaim+'&kode_manfaat='+p_kode_manfaat+'&no_urut='+p_no_urut+'&form_penetapan='+p_form_penetapan+'&sender=pn5069_view_penetapanmanfaat_tkibantuanpemulangankarenaditempatkantidaksesuaipk.php'+'','',980,550,'yes');
	}
</script>
<?
