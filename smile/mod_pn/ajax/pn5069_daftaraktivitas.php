...
if ($ls_kode_klaim!="")
{
  ...
  $data = array(
    ...
    'KODE_KLAIM'=>$ls_kode_klaim,
		...
		'ACT_POPUP'=>"DATA_AKTIVITAS_KLAIM"
  );
  			...
  			<div id="div_container" class="div-container">
  				...
  				<div id="div_body" class="div-body">
                    ...
                    <tr class="hr-single">
                      ...
                      <th rowspan="2" style="text-align: center;">Tgl Selesai</th>
                      ...
                      if ($ls_kode_klaim != "")
                      {			
              					for($i=0;$i<ExtendedFunction::count($resultArray->DATA_AKTIVITAS_KLAIM);$i++)
              					{
                          ?>						
                          <tr>
              							<td style="text-align:center;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->NO_URUT;?></td>
                            <td style="text-align:left; white-space:pre-wrap; word-wrap:break-word;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->KETERANGAN;?></td>  									
              							<td style="text-align:center;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->TGL_MULAI;?></td>
              							<td style="text-align:center;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->TGL_AKHIR;?></td>
                            <td style="text-align:center;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->STATUS_AKTIVITAS;?></td>
              							<td style="text-align:center;"><?=$resultArray->DATA_AKTIVITAS_KLAIM[$i]->PETUGAS_REKAM;?></td>							
                          </tr>
                          <?							    							
                        }
                        $ln_dtl=$i;
  				...
  				<div id="div_footer" class="div-footer">
  					<div style="background: #f2f2f2;padding:10px 20px;border:1px solid #ececec;">
  						...
  						<li style="margin-left:15px;">Data yang ditampilkan adalah keseluruhan aktivitas yang dilakukan sejak entry agenda sampai dengan klaim dibayarkan.</li>
  					</div>				
  				</div>	 
  			</div>		
  		</form>	 
