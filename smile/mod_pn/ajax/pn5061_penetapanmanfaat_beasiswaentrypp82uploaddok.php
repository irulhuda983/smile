        ...
        if($status_tipe==1 && $status_size==0)
          ...
          $ls_file_path_url= $result->path;
            ...
            $sql = "INSERT INTO SMILE.PN_PENERIMA_BEASISWA_DOK ( ".
                   ...
                   "    '$ls_nama_dokumen', 'PENETAPAN_BEASISWA_PERUBAHANKONDISIAKHIR', '$ls_file_path_url',  ".
            ...
            $DB->parse($sql); 
              ...
              $sql_update = "UPDATE SMILE.PN_PENERIMA_BEASISWA_DOK SET ".
                     ...
                     "    NAMA_DOKUMEN = '$ls_nama_dokumen', ".
  									 "		KETERANGAN = 'PENETAPAN_BEASISWA_PERUBAHANKONDISIAKHIR', ".
...
<form name="fpop" method="post" action="pn5061_penetapanmanfaat_beasiswaentrypp82uploaddok.php" enctype="multipart/form-data">
    <!-- LOCAL JAVASCRIPTS -->	
