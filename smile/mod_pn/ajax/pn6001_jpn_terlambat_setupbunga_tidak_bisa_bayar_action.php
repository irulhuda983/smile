...
if ($TYPE == "New") {
  ...
  $qry_agenda = "UPDATE  PN.PN_AGENDA_KOREKSI
   ...
   $sql = "
    ...
    $DB->parse($sql);
    if($DB->execute()){
      $sql = "BEGIN PN.P_PN_PN60010208.X_INSERT_KOREKSI_KLAIM_JPN
                    (   '$ls_kode_agenda',
              '$ls_kode_klaim',
        ...
        if($DB->execute()){
            ...
            echo '{"ret":-1,"msg":"Gagal, Gagal Eksekusi Prosedur PN.P_PN_PN60010208.X_INSERT_KOREKSI_KLAIM_JPN!"}';
        }         
    }
   ...
   // if($DB->execute()){
    ...
    if ($recordsTotal <= 0) {
        ...
        $sql = "BEGIN PN.P_PN_PN60010208.X_SUBMIT_TDL_KLAIM_JPN
				(
					'$ls_kode_agenda',
                    '$ls_kode_bank',
		...
		if($DB->execute()){
            ...
            echo '{"ret":-1,"msg":"Gagal, Gagal Eksekusi Prosedur PN.P_PN_PN60010208.X_SUBMIT_KOREKSI_KLAIM_JPN!"}';
        }
    }
}
    ...
    if ($recordsTotal <= 0) {
        ...
        $sql = "BEGIN PN.P_PN_PN60010208.x_approve_tdl_klaim_jpn
				(
					'$ls_kode_agenda',
                    '$KD_KANTOR',
					'$USER',
		...
		if($DB->execute()){
            ...
            echo '{"ret":-1,"msg":"Gagal, Gagal Eksekusi Prosedur PN.P_PN_PN60010208.X_APPROVE_KOREKSI_KLAIM_JPN!"}';
        }
    }
}
   ...
   // cetak penetapan koreksi
    ...
    if ($recordsTotal <= 0) {
		...
		$sql = "BEGIN PN.P_PN_PN60010208.X_BATAL_TDL_KLAIM_JPN
				(
					'$ls_kode_agenda',
					'$USER',
					:p_sukses,
		...
		if($DB->execute()){
            ...
            echo '{"ret":-1,"msg":"Gagal, Gagal Eksekusi Prosedur PN.P_PN_PN60010208.X_BATAL_KOREKSI_KLAIM_JPN!"}';
        }
    }
}
