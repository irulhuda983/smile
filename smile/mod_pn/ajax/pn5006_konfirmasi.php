...
<body>
    ...
    {			
      ...
      //post update ---------------------------------------------------------- 
			$qry = "BEGIN SIJSTK.P_PN_PN5001.X_POST_KONFIRMASI_BERKALA('$ls_kode_klaim','$ln_no_konfirmasi', '$username',:p_sukses,:p_mess);END;";											 	
      $proc = $DB->parse($qry);				
                  ...
                  <tr>
                  	<td colspan="2"><hr style="border:0; border-top:3px double #8c8c8c;"/></td>	
      						...
      						<tr>
      							<td>Kondisi Akhir</td>			 	
          					<td style="text-align:left;">	 	    				
                      <select size="1" id="kode_kondisi_terakhir_induk" name="kode_kondisi_terakhir_induk" value="<?=$ls_kode_kondisi_terakhir_induk;?>" tabindex="1" class="select_format" style="width:250px;" >
                      <option value="">-- Tidak ada perubahan kondisi akhir --</option>
                      <?
                      ...
                      ?>
      						...
      						<tr>
      							<td>Tgl Kondisi Akhir</td>			 	
          					<td style="text-align:left;">
          						<input type="text" id="tgl_kondisi_terakhir_induk" name="tgl_kondisi_terakhir_induk" value="<?=$ld_tgl_kondisi_terakhir_induk;?>" size="38" maxlength="10" tabindex="2" onblur="convert_date(tgl_kondisi_terakhir_induk);">
