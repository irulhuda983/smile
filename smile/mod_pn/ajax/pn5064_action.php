...
if($ls_type == "MainDataGrid")
{
  ...
  for($i=0;$i<ExtendedFunction::count($resultArray->DATA);$i++){																				
		$resultArray->DATA[$i]->ACTION = '<a href="#" onClick="doGridTask(\''.$resultArray->DATA[$i]->KODE_KLAIM.'\',\''.$ls_mode_transaksi.'\',\''.$ls_kategori.'\',\''.$ld_tgl_awal.'\',\''.$ld_tgl_akhir.'\');"><font color="#009999">PEMBATALAN</font></a>';
	}
