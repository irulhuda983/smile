...
/*--------------------- Form History -----------------------------------------
File: pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaan.php

Deskripsi:
-----------
File ini dipergunakan untuk entry manfaat bantuan akibat pemerkosaan TKI
...
<div id="formframe">
  <div id="formKiri" style="width:880px">
    ...
    <table id="mydata2" cellspacing="0" style="text-align:center;width:85%;" aria-describedby="mydata2desc">
      <tbody>
				<tr>
        	<th scope="col" colspan="6"><hr style="border:0; height:1px; background-image: linear-gradient( to right, rgba(0,0,0,0), rgba(0,0,0,0.80), rgba(0,0,0,0));"/></th>	
        </tr>	

        <tr>
          <th scope="col" style="text-align:center;font: 12px Arial, Helvetica, sans-serif;" colspan="3">&nbsp;</th>
        ...
        <tr>
          ...
          <th scope="col" style="text-align:center;font: 12px Arial, Helvetica, sans-serif;width:150px;">Tgl Pemerkosaan</th>
        ...
        <tr>
        <th scope="col" colspan="6"><hr style="border:0; border-top:3px double #8c8c8c;"/></th>	
        </tr>
        ...
        {			
          $sql = "select 
                      ...
                      a.nom_pph, a.nom_pembulatan, a.nom_manfaat_netto, a.keterangan, to_char(a.tgl_pemerkosaan,'DD/MM/YYYY') tgl_pemerkosaan
          ...
          while ($row = $DB->nextrow())
          {
            ...
            <?echo "<tr bgcolor=#".($i%2 ? "f3f3f3" : "ffffff").">";?>								
              ...
              <td style="text-align:center"><?=$row["TGL_PEMERKOSAAN"];?></td>  									
              ...
              <td>
							...
							{
							?>
              <a href="#" onClick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaanentry.php?task=view&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaan.php','Entry Rincian Manfaat',850,600,'no')"><img src="../../images/check.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;View </a>
              <?
							}else
							{
							?>
              <a href="#" onClick="window.location.replace('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaanentry.php?task=edit&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaan.php','Entry Rincian Manfaat',850,600,'no')"><img src="../../images/check.png" border="0" alt="Ubah Divisi" align="absmiddle" />&nbsp;Edit </a>	|
              <a href="javascript:confirmDelete('?delete_manfaatrinci=DEL&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&no_urut=<?=$row["NO_URUT"];?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaanentry.php')"><img src="../../images/minus.png" alt="Delete" border="0" align="absmiddle" title="Delete">delete</a>									
							<?							
							}
							?>								
              </td>								
          ...
          if ($i == 0) {
            ...
            echo '<td colspan="6" style="text-align:center">-- Belum Ada Rincian Manfaat --</td>';
            echo '</tr>';
          }					
        }						
        ?>									             																
      ...
      <tr>
      	<th scope="col" colspan="6"><hr style="border:0; height:1px; background-image: linear-gradient( to right, rgba(0,0,0,0), rgba(0,0,0,0.20), rgba(0,0,0,0));"/></th>	
      </tr>
						
      <tr>
        <td style="text-align:right;" colspan="3"><em><strong>Total</strong></em>
        ...
        <td style="text-align:right"><?=number_format((float)$ln_tot_biaya_disetujui,2,".",",");?></td>				
    			...
    			{
      			?>
               <a href="#" onClick="window.location.replace('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaanentry.php?task=new&kode_klaim=<?=$ls_kode_klaim;?>&kode_manfaat=<?=$ls_kode_manfaat;?>&form_penetapan=<?=$ls_form_penetapan;?>&sender=pn5041_penetapanmanfaat_tkisantunanakibatpemerkosaan.php','Entry Rincian Manfaat',850,600,'no');" href="javascript:void(0);"><img src="../../images/plus.png" border="0" alt="Tambah" align="absmiddle" />&nbsp;Entry</a>	
            <?
    			}
    			?>								
        </td>																					
