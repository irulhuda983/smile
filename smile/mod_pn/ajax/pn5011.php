...
<form name="formreg" id="formreg" role="form" method="post">
  ...
  <script language="javascript">
      ...
      if(parseFloat(navigator.appVersion) >= 4){win.window.focus();}
		...
		{		 	
  		...
  		var v_kode_promotif_header 		= document.getElementById('kode_promotif').value;
			...
			bkwindow("../ajax/pn5011_lov_dtlkodepromotif.php?p=pn5011.php&a=formreg&b=d_realdtl_kode_promotif"+i+"&c=d_realdtl_kode_perusahaan"+i+"&d=d_realdtl_nama_perusahaan"+i+"&e="+v_kode_promotif_header+"&f="+v_kode_kegiatan_header+"&g=d_realdtl_bentuk_kegiatan"+i+"","",800,500,1);		 
		}

		function fl_js_lov_d_realdtl_jenisrealisasi(i)
		{		 	
			var d_realdtl_bentuk_kegiatan = 'd_realdtl_bentuk_kegiatan'+i;
			var v_realdtl_bentuk_kegiatan = document.getElementById(d_realdtl_bentuk_kegiatan).value;
			
			bkwindow("../ajax/pn5011_lov_dtljenisrealisasi.php?p=pn5011.php&a=formreg&b=d_realdtl_bentuk_kegiatan"+i+"","",800,500,1);		 
		}

    function fl_js_val_d_realdtl_bentukkegiatan(i) 
    { 
			var d_realdtl_bentuk_kegiatan	= 'd_realdtl_bentuk_kegiatan'+i;
			var d_realdtl_kpj 						= 'd_realdtl_kpj'+i;
			var d_realdtl_nama_tk 				= 'd_realdtl_nama_tk'+i;
			var d_realdtl_nama_barang 		= 'd_realdtl_nama_barang'+i;
			var v_realdtl_bentuk_kegiatan = document.getElementById(d_realdtl_bentuk_kegiatan).value;
			var v_realdtl_nama_tk 				= document.getElementById(d_realdtl_nama_tk).value;	
			var v_realdtl_nama_barang			= document.getElementById(d_realdtl_nama_barang).value;	
			
			if (v_realdtl_bentuk_kegiatan =="JASA") //jasa --------------------------
      {
        window.document.getElementById('d_realdtl_nama_barang'+i).value = "";				
				window.document.getElementById('d_realdtl_nama_barang'+i).readOnly = true;
  			window.document.getElementById('d_realdtl_nama_barang'+i).style.backgroundColor='#F2F2F2';	
  			window.document.getElementById('d_realdtl_nama_tk'+i).style.backgroundColor='#ffff99';	
				window.document.getElementById('d_realdtl_nama_tk'+i).focus();						
      }else //barang ----------------------------------------------------------
      {
        window.document.getElementById('d_realdtl_nama_tk'+i).value = "";
				window.document.getElementById('d_realdtl_kpj'+i).value = "";
  			window.document.getElementById('d_realdtl_nama_tk'+i).style.backgroundColor='#F2F2F2';	
				window.document.getElementById('d_realdtl_nama_barang'+i).readOnly = false;
  			window.document.getElementById('d_realdtl_nama_barang'+i).style.backgroundColor='#ffff99';
				window.document.getElementById('d_realdtl_nama_barang'+i).focus();				
      } 	
    }
    ...
    function addRowInnerHTML2(tblId)
    {
      ...
      newCell1.innerHTML = '<input type="text" id='+'d_realdtl_nama_perusahaan'+iteration+' name='+'d_realdtl_nama_perusahaan'+iteration+' readonly class=\'disabled\' size="15" onblur="fl_js_val_d_realdtl_bentukkegiatan('+iteration+');"><input type="hidden" id='+'d_realdtl_kode_promotif'+iteration+' name='+'d_realdtl_kode_promotif'+iteration+'><input type="hidden" id='+'d_realdtl_kode_perusahaan'+iteration+' name='+'d_realdtl_kode_perusahaan'+iteration+'>&nbsp;<a href="#" onclick="fl_js_lov_d_realdtl_promotif('+iteration+');"><img src="../../images/help.png" alt="Cari Data Perusahaan" border="0" align="absmiddle"></a><input type="hidden" readonly id='+'d_realdtl_bentuk_kegiatan'+iteration+' name='+'d_realdtl_bentuk_kegiatan'+iteration+' size="7" style="border-width: 1;text-align:left;" maxlength="30" onblur="fl_js_val_d_realdtl_bentukkegiatan('+iteration+');">';
			newCell2.innerHTML = '<input type="text" id='+'d_realdtl_nama_tk'+iteration+' name='+'d_realdtl_nama_tk'+iteration+' readonly class=\'disabled\' size="25">&nbsp;<a href="#" onclick="fl_js_val_d_realdtl_kodetk('+iteration+');"><input type="hidden" id='+'d_realdtl_kode_tk'+iteration+' name='+'d_realdtl_kode_tk'+iteration+'><input type="hidden" id='+'d_realdtl_kpj'+iteration+' name='+'d_realdtl_kpj'+iteration+'><img src="../../images/help.png" alt="Cari Data TK" border="0" align="absmiddle"></a>';
      newCell3.innerHTML = '<input type="text" id='+'d_realdtl_nama_barang'+iteration+' name='+'d_realdtl_nama_barang'+iteration+' size="15" maxlength="100" style="border-width: 1;text-align:left">';
			newCell4.innerHTML = '<input type="text" id='+'d_realdtl_nom_diajukan'+iteration+' name='+'d_realdtl_nom_diajukan'+iteration+' size="15" maxlength="20" style="border-width: 1;text-align:right" onblur="this.value=format_uang(this.value);">';
			newCell5.innerHTML = '<input type="text" id='+'d_realdtl_keterangan'+iteration+' name='+'d_realdtl_keterangan'+iteration+' size="8" maxlength="300" style="border-width: 1;text-align:left">'; 
      newCell6.innerHTML = '<a href="#" onclick="removeperbrs2(this.parentNode.parentNode.rowIndex)" id="link_delete"><img src="../../images/file_cancel.gif" border="0" align="absmiddle"> Delete</a>';		
    }
  ...
  <script language="javascript">
    ...
    { 
    	var form = document.formreg;
			var	v_kategori_pelaksana = form.kategori_pelaksana.value;
			var	v_status_klaim 			 = form.status_klaim.value;
  ...
  }else
  {
    ...
    $sql = "select 
              ...
              a.kategori_pelaksana, a.nama_pelaksana, a.alamat_pelaksana, 
          ...
          <input type="hidden" id="st_errval10" name="st_errval10">
              ...
              <div id="formKiri" style="width:820px;">
                  ...
                  <label  style = "text-align:right;">Tema Kegiatan &nbsp;&nbsp;*</label>
                    <input type="text" id="kode_sub_kegiatan" name="kode_sub_kegiatan" value="<?=$ls_kode_sub_kegiatan;?>" tabindex="7" size="5" maxlength="10" <?=($ls_status_klaim !="AGENDA")? " readonly class=disabled" : " style=\"background-color:#ffff99\"";?>>
                    <input type="text" id="nama_sub_kegiatan" name="nama_sub_kegiatan" value="<?=$ls_nama_sub_kegiatan;?>" size="25" readonly class="disabled">
										<a href="#" onclick="NewWindow('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5011_lov_subkegiatan.php?p=pn5011.php&a=formreg&b=kode_sub_kegiatan&c=nama_sub_kegiatan&d='+formreg.kode_kegiatan.value+'&e='+formreg.tgl_kegiatan.value+'','',800,500,1)">							      																	
                  ...
                  <label style = "text-align:right;">Keterangan &nbsp;</label>
                  	<textarea cols="250" rows="1" id="keterangan" name="keterangan" tabindex="9" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)" <?=($ls_status_klaim !="AGENDA")? " readonly class=disabled style=\"width:270px;background-color:#F5F5F5\"" : " style=\"width:270px;\"";?>><?=$ls_keterangan;?></textarea>   					
                  </div>																																																													
                  <div class="clear"></div>	
              ...
              <div id="formKanan">
                	...
                	if ($ls_kode_realisasi!="")
                		...
                		<fieldset>   				              									
              					<br />
												<input type="button" class="rightbutton btn green" id="btncetak" name="btncetak" value=" CETAK " onClick="NewWindow4('http://<?=$HTTP_HOST;?>/mod_pn/ajax/pn5011_cetak.php?&kode_realisasi=<?=$ls_kode_realisasi;?>&kode_klaim=<?=$ls_kode_klaim;?>&jenis_klaim=JKK&mid=<?=$mid;?>','Cetak Agenda Klaim',600,550,'no')"><br />
