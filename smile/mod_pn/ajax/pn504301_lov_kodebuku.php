...
<![endif]-->
    ...
    // query with paging								
    $rows_per_page = 20;
    $url = 'pn504301_lov_kodebuku.php'; // url sama dengan nama file				
    //The unfiltered SELECT
        ...
        $sql = "select a.kode_kantor, a.kode_buku, a.kode_bank, c.nama_bank||' ('||a.kode_rekening||')' keterangan ".
               ...
               "and b.tipe_rekening like decode('$f', 1,'13',2,'14',3, '15', 4, '16','%') ". 
               "and a.kode_kantor = '$e' ".
               "and a.kd_prg = '$f' ".
  						 "and a.kode_buku in ('T0191','T0150') ".
							 "and a.kode_bank in (select kode_bank from sijstk.monitor_klaim_jspo where no_agenda = '$h') ".
    					 "and nvl(a.aktif,'T')='Y' ".
        			 $filtersearch.
