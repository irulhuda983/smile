<?php
//------------------------------------------------------------------------------
// Menu untuk display data dokumen pada saat penetapan klaim jp berkala
            ...
            <div style="padding-top:6px;width:99%;">
  						<div class="div-footer-content">
  							<div style="padding-bottom: 8px;"><b>Keterangan:</b></div>
								<li style="margin-left:15px;"><font color="#ff0000"> <b>Dokumen Administrasi</b></font> adalah dokumen kelengkapan yang diserahkan pada saat penetapan klaim JP Berkala. Untuk melihat dokumen lainnya dapat melalui data histori Konfirmasi JP Berkala.</li>
		...
		$.ajax({
			...
			success: function(data){
				try {
					...
					if (jdata.ret == 0) 
					{ 
						$("#span_page_title").html('PN5006 - KELENGKAPAN DOKUMEN ADMINISTRASI PADA SAAT PENETAPAN KLAIM JP BERKALA');
						$("#span_page_title_right").html('KODE KLAIM : '+v_kode_klaim);
						
						//set layout kelengkapan dokumen -----------------------------------
						$('#formtab').load('../ajax/pn5069_view_tabadministrasi.php', {DATA_DOKUMEN : getValueArr(jdata.data.DATA_DOKUMEN)});
