  ...
  <form name="fpop" method="post" action="<?=$PHP_SELF;?>">
    ...
    {		 	
      ...
      c_kode_klaim 	 = window.document.getElementById('kode_klaim').value;
			...
			{
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_phk_tgl_kontrak&c_tgl_awal='+c_tgl_awal+'&c_tgl_akhir='+c_tgl_akhir+'&c_kode_klaim='+c_kode_klaim;
    ...
    {		 	
			...
			{
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_phk_tgl_phk&c_kode_klaim='+c_kode_klaim+'&c_tgl_phk='+c_tgl_phk+'&c_tgl_awal='+c_tgl_awal+'&c_tgl_akhir='+c_tgl_akhir;
        ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found
        ajax.runAJAX();	// Execute AJAX function		
    ...
    {		 	
			...
			{						
        ajax.requestFile = '../ajax/pn5040_validasi.php?getClientId=f_ajax_val_hitung_manfaat_tkiphk&c_kode_klaim='+c_kode_klaim+'&c_kode_manfaat='+c_kode_manfaat+'&c_kd_prg='+c_kd_prg+'&c_no_urut='+c_no_urut+'&c_tgl_phk='+c_tgl_phk+'&c_tgl_awal='+c_tgl_awal+'&c_tgl_akhir='+c_tgl_akhir;
        ajax.onCompletion = showClientData; // Specify function that will be executed after file has been found	
        ajax.runAJAX();	// Execute AJAX function	
			}								      		
    }
    ...
    <table class="captionfoxrm" aria-describedby="captionfoxrmdesc">
      ...
      <input type="hidden" id="sender_mid" name="sender_mid" value="<?=$ls_sender_mid;?>">		
			...
			<div id="formKiri" style="width:900px;">
				<fieldset style="width:750px;"><legend><strong><em><span style="color:#009999">Entry Rincian Manfaat Gagal Keberangkatan PMI</span></em></strong></legend>
          </br>
          ...
          <label style = "text-align:right;">Tgl PHK *</label>
            ...
            <input id="btn_phk_tgl" type="image" align="top" onclick="return showCalendar('phk_tgl', 'dd-mm-y');" src="../../images/calendar.gif" alt="Tgl PHK" />	   							
          </div>																																															
          <div class="clear"></div>
