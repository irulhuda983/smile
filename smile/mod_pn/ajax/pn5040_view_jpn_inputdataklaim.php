  ...
  <fieldset><legend>Input Data Klaim Manfaat Pensiun</legend>
        ...
        <tr>
          ...
          <th style="text-align:center;font: 12px Verdana, Arial, Helvetica, sans-serif;width:110px;">Tgl Kejadian</th>					
            ...
            <option value="">-- Pilih --</option>
              ...
              if ($ls_status_submit_agenda =="Y")
              {
               	$sql = "select kode_kondisi_terakhir, nama_kondisi_terakhir from sijstk.pn_kode_kondisi_terakhir where kode_kondisi_terakhir=:kode_kondisi_terakhir";
				$param_bv[':kode_kondisi_terakhir'] = $ls_jpn_tk_kode_kondisi_terakhir;
              }else
              {
    ...
    <table id="tblrincianjp3" width="90%" cellspacing="0" border="0" align="center" bordercolor="#C0C0C0" background-color= "#ffffff">
      ...
      <tr>
        ...
        <td style="text-align:left; font: 10px Verdana, Arial, Helvetica, sans-serif;" colspan="8"><?=$p_cnt_bln_iur;?> Bulan</td>								        
      </tr>
      <tr>
