<?php
//------------------------------------------------------------------------------
// Menu untuk display rincian manfaat pmi phk
		...
		<form name="formreg" id="formreg" role="form" method="post" enctype="multipart/form-data">
          ...
          <fieldset style="width:97%;"><legend>Rincian Manfaat</legend>
            ...
            <label style = "text-align:right;">Periode Kontrak</label>
              <input type="text" id="phk_tgl_pk_awal" name="phk_tgl_pk_awal" readonly class="disabled" style="width:130px;">
              s/d
  						<input type="text" id="phk_tgl_pk_akhir" name="phk_tgl_pk_akhir" readonly class="disabled" style="width:130px;">
            </div>																																															
            <div class="clear"></div>
  
            <div class="form-row_kiri">
            <label style = "text-align:right;">Tgl PHK</label>
              <input type="text" id="phk_tgl" name="phk_tgl" readonly class="disabled" style="width:270px;">
            </div>																																															
            <div class="clear"></div>
            ...
            <label  style = "text-align:right;">Masa Kerja</label>
  						<textarea cols="255" rows="1" style="width:290px;background-color:#F5F5F5;" readonly id="ket_phk_kode_blnphk" name="ket_phk_kode_blnphk" onkeypress="return canAddCharacter(this, 300)" onchange="trimLength(this, 300)"></textarea> 			
            ...
            <div style="padding-top:6px;width:99%;">
  						<div class="div-footer-content">
							...
							<ul>
  							<li style="margin-left:15px;">Klik tombol <span style="color:#ff0000"> <strong>X</strong> </span> pada pojok kanan atas untuk menutup form dan kembali ke menu utama.</li>
							</ul>
  						</div>
            </div>
			...
			success: function(data){
				try {
					...
					{ 
						...
						$('#phk_tgl_pk_awal').val(getValue(jdata.data.DATA['PHK_TGL_PK_AWAL']));
						$('#phk_tgl_pk_akhir').val(getValue(jdata.data.DATA['PHK_TGL_PK_AKHIR']));
						$('#phk_tgl').val(getValue(jdata.data.DATA['PHK_TGL']));
						$('#ket_phk_kode_blnphk').val(getValue(jdata.data.DATA['KET_PHK_KODE_BLNPHK']));
						$('#phk_kode_blnphk').val(getValue(jdata.data.DATA['PHK_KODE_BLNPHK']));
